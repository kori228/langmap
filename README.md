...
- **[Word Map](wordmap.html)** — interactive world map showing 20 key words in 310 languages (incl. Russian Far East / Siberian indigenous, Sinitic varieties, Indo-Aryan & Tibeto-Burman, Bantu & West African, Mesoamerican & Andean indigenous, Caucasian, Pacific & Australian Aboriginal, Indonesian & Philippine regional) with IPA, 2D/3D globe toggle, language info panel, full i18n
...
langmap/
  ...
  wordmap.html       — Word Map page (20 words × 310 languages on a world map)
...
langmap/
  ...
  wordmap.html       — 単語マップページ（20語 × 310言語の世界地図）
