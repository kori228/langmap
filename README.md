...
langmap/
  ...
  wordmap.html            — Word Map page (20 words × 793 languages on a world map)
...
- **[単語マップ](wordmap.html)** — 793言語で20の基本語を世界地図上に表示。発音ガイド (IPA / 広めの音写 / ローマ字、声調文字)、2D/3Dグローブ切替、言語情報パネル、全UI18言語対応の i18n (パネルラベル、言語説明、話者数注記、類型情報行、各種バッジ、ARIA ラベル、ON/OFFトグル、比較パネル等)、ドラッグ並べ替え可能な言語比較ビュー、語族／文字／語順／声調／形態論／話者規模で絞り込める **多言語類型論フィルタパネル** (時代対応のチップ数表示、0件チップは無効化、選択はURLに保存)
...
langmap/
  ...
  wordmap.html            — 単語マップページ（20語 × 793言語の世界地図）
