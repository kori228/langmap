...
- **[Word Map](wordmap.html)** — interactive world map showing 20 key words in 274 languages (incl. Russian Far East / Siberian indigenous, Sinitic varieties, large Indo-Aryan & SE Asian, Bantu & West African, Mesoamerican & Andean indigenous) with IPA, 2D/3D globe toggle, language info panel, full i18n
...
langmap/
  ...
  wordmap.html       — Word Map page (20 words × 274 languages on a world map)
...
langmap/
  ...
  wordmap.html       — 単語マップページ（20語 × 274言語の世界地図）
