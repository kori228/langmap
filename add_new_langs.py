#!/usr/bin/env python3
"""Merge mg, ain, fi, cy language data into data.js."""

import json, re, sys
sys.path.insert(0, '/home/jounlai/langmap')

from data_mg_fi import MG_DATA
from data_ain import AIN_DATA
from data_fi import FI_DATA
from data_cy import CY_DATA
