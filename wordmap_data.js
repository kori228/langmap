...
const WORD_LIST = [
  ...
  { id: 'fire', definition: { en: 'Fire / flame as a phenomenon; not "match" or "campfire".', ja: '燃焼現象としての火・炎。「マッチ」や「焚き火」のような特定の対象ではない。', ko: '연소 현상으로서의 불·불꽃. "성냥"이나 "모닥불" 같은 구체적 대상이 아니다.', zh: '作为燃烧现象的火、火焰；不是"火柴"或"营火"等具体对象。' }, label: { en: 'Fire', ja: '火', ko: '불', zh: '火', yue: '火', vi: 'Lửa', th: 'ไฟ', id: 'Api', hi: 'आग', de: 'Feuer', fr: 'Feu', it: 'Fuoco', es: 'Fuego', es_eu: 'Fuego', es_mx: 'Fuego', pt: 'Fogo', pt_eu: 'Fogo', pt_br: 'Fogo', ru: 'Огонь', uk: 'Вогонь', ar: 'نار', he: 'אש', sw: 'Moto' } },
  ...
  { id: 'moon', definition: { en: "Earth's natural satellite; not the calendar month.", ja: '地球の衛星としての月。暦の「月」ではない。', ko: '지구의 위성으로서의 달. 달력의 "월"이 아니다.', zh: '地球的天然卫星；不是日历上的"月"。' }, label: { en: 'Moon', ja: '月', ko: '달', zh: '月亮', yue: '月亮', vi: 'Mặt trăng', th: 'ดวงจันทร์', id: 'Bulan', hi: 'चाँद', de: 'Mond', fr: 'Lune', it: 'Luna', es: 'Luna', es_eu: 'Luna', es_mx: 'Luna', pt: 'Lua', pt_eu: 'Lua', pt_br: 'Lua', ru: 'Луна', uk: 'Місяць', ar: 'قمر', he: 'ירח', sw: 'Mwezi' } },
  { id: 'mother', definition: { en: 'Female parent — neutral/citation form. Register varies by language.', ja: '女親（母）の中立的・辞書形。フォーマル/カジュアルの区別は言語による。', ko: '여성 부모(어머니)의 중립적/사전형. 격식 차이는 언어마다 다르다.', zh: '女性家长（母亲）的中性/词典形式。语体级别因语言而异。' }, label: { en: 'Mother', ja: '母', ko: '어머니', zh: '母亲', yue: '母親', vi: 'Mẹ', th: 'แม่', id: 'Ibu', hi: 'माँ', de: 'Mutter', fr: 'Mère', it: 'Madre', es: 'Madre', es_eu: 'Madre', es_mx: 'Madre', pt: 'Mãe', pt_eu: 'Mãe', pt_br: 'Mãe', ru: 'Мать', uk: 'Мати', ar: 'أم', he: 'אמא', sw: 'Mama' } },
  { id: 'father', definition: { en: 'Male parent — neutral/citation form. Same register convention as mother.', ja: '男親（父）の中立的・辞書形。母と同じ語法ポリシー。', ko: '남성 부모(아버지)의 중립적/사전형. 어머니와 동일한 어법 정책.', zh: '男性家长（父亲）的中性/词典形式。语体规范同"母亲"。' }, label: { en: 'Father', ja: '父', ko: '아버지', zh: '父亲', yue: '父親', vi: 'Bố', th: 'พ่อ', id: 'Ayah', hi: 'पिता', de: 'Vater', fr: 'Père', it: 'Padre', es: 'Padre', es_eu: 'Padre', es_mx: 'Padre', pt: 'Pai', pt_eu: 'Pai', pt_br: 'Pai', ru: 'Отец', uk: 'Батько', ar: 'أب', he: 'אבא', sw: 'Baba' } },
  { id: 'eat', definition: { en: 'Verb "to eat" — use the language\'s normal dictionary/citation convention; document exceptions with wordEvidence.note.', ja: '動詞「食べる」。各言語の通常の辞書形・引用形を用いる。例外は wordEvidence.note で記録。', ko: '동사 "먹다". 각 언어의 통상적 사전형·인용형을 사용. 예외는 wordEvidence.note에 기록.', zh: '动词"吃"。使用各语言通常的词典/引用形式。例外通过 wordEvidence.note 记录。' }, label: { en: 'Eat', ja: '食べる', ko: '먹다', zh: '吃', yue: '食', vi: 'Ăn', th: 'กิน', id: 'Makan', hi: 'खाना', de: 'Essen', fr: 'Manger', it: 'Mangiare', es: 'Comer', es_eu: 'Comer', es_mx: 'Comer', pt: 'Comer', pt_eu: 'Comer', pt_br: 'Comer', ru: 'Есть', uk: 'Їсти', ar: 'أكل', he: 'לאכול', sw: 'Kula' } },
  ...
  { id: 'heart', definition: { en: 'Default: the basic emotional/cognitive heart/mind term. Use anatomical heart only where it is the normal basic word; document the choice with wordEvidence.note.', ja: '既定: 感情・思考の中心としての「心」を表す基本語。解剖学的「心臓」は、それがその言語の基本語である場合のみ採用 (wordEvidence.note に記録)。', ko: '기본값: 감정·인지의 중심으로서의 "마음"을 나타내는 기본어. 해부학적 "심장"은 그것이 해당 언어의 기본 어휘인 경우에 한함 (wordEvidence.note에 기록).', zh: '默认：表示情感·认知中心的"心"的基本词。仅当解剖学"心脏"是该语言的基础词时使用，并在 wordEvidence.note 注明。' }, label: { en: 'Heart', ja: '心', ko: '마음', zh: '心', yue: '心', vi: 'Tim', th: 'ใจ', id: 'Hati', hi: 'दिल', de: 'Herz', fr: 'Cœur', it: 'Cuore', es: 'Corazón', es_eu: 'Corazón', es_mx: 'Corazón', pt: 'Coração', pt_eu: 'Coração', pt_br: 'Coração', ru: 'Сердце', uk: 'Серце', ar: 'قلب', he: 'לב', sw: 'Moyo' } },
  { id: 'tree', definition: { en: 'Tree (woody plant); not specifically a tree species or "wood".', ja: '木（木本植物）。特定の樹種や「木材」ではない。', ko: '나무 (목본 식물). 특정 수종이나 "목재"가 아니다.', zh: '树（木本植物）；不特指树种或"木材"。' }, label: { en: 'Tree', ja: '木', ko: '나무', zh: '树', yue: '樹', vi: 'Cây', th: 'ต้นไม้', id: 'Pohon', hi: 'पेड़', de: 'Baum', fr: 'Arbre', it: 'Albero', es: 'Árbol', es_eu: 'Árbol', es_mx: 'Árbol', pt: 'Árvore', pt_eu: 'Árvore', pt_br: 'Árvore', ru: 'Дерево', uk: 'Дерево', ar: 'شجرة', he: 'עץ', sw: 'Mti' } },
  ...
  { id: 'eye', definition: { en: 'Eye (organ of sight); singular form preferred.', ja: '目（視覚器官）。単数形を優先。', ko: '눈 (시각 기관). 단수형을 우선.', zh: '眼（视觉器官）；优先使用单数形式。' }, label: { en: 'Eye', ja: '目', ko: '눈', zh: '眼睛', yue: '眼', vi: 'Mắt', th: 'ตา', id: 'Mata', hi: 'आँख', de: 'Auge', fr: 'Œil', it: 'Occhio', es: 'Ojo', es_eu: 'Ojo', es_mx: 'Ojo', pt: 'Olho', pt_eu: 'Olho', pt_br: 'Olho', ru: 'Глаз', uk: 'Око', ar: 'عين', he: 'עין', sw: 'Jicho' } },
  ...
  { id: 'one', definition: { en: 'Cardinal numeral 1; masculine/default citation form where languages distinguish gender (e.g. ar واحد, he אחד, fr un, es uno).', ja: '基数 1。性別区別がある言語では男性形・既定形 (例: ar واحد, he אחד, fr un, es uno)。', ko: '기수 1. 성을 구분하는 언어에서는 남성형/기본형 (예: ar واحد, he אחד, fr un, es uno).', zh: '基数 1。区分性别的语言中使用阳性/默认形式 (如 ar واحد, he אחד, fr un, es uno)。' }, label: { en: 'One', ja: '一', ko: '하나', zh: '一', yue: '一', vi: 'Một', th: 'หนึ่ง', id: 'Satu', hi: 'एक', de: 'Eins', fr: 'Un', it: 'Uno', es: 'Uno', es_eu: 'Uno', es_mx: 'Uno', pt: 'Um', pt_eu: 'Um', pt_br: 'Um', ru: 'Один', uk: 'Один', ar: 'واحد', he: 'אחד', sw: 'Moja' } },
...
const LANG_DATA = {
  ...
  eo: { name: 'Esperanto', native: 'Esperanto', lat: 53.13, lng: 23.16, // Białystok (L. L. Zamenhof's birthplace)
