...
const WORD_LIST = [
  { id: 'water', definition: 'Drinkable water (H₂O); the basic substance, not a body of water.', label: { en: 'Water', ja: '水', ko: '물', zh: '水', yue: '水', vi: 'Nước', th: 'น้ำ', id: 'Air', hi: 'पानी', de: 'Wasser', fr: 'Eau', it: 'Acqua', es: 'Agua', pt: 'Água', ru: 'Вода', uk: 'Вода', ar: 'ماء', he: 'מים', sw: 'Maji' } },
  { id: 'fire', definition: 'Fire / flame as a phenomenon; not "match" or "campfire".', label: { en: 'Fire', ja: '火', ko: '불', zh: '火', yue: '火', vi: 'Lửa', th: 'ไฟ', id: 'Api', hi: 'आग', de: 'Feuer', fr: 'Feu', it: 'Fuoco', es: 'Fuego', pt: 'Fogo', ru: 'Огонь', uk: 'Вогонь', ar: 'نار', he: 'אש', sw: 'Moto' } },
  { id: 'sun', definition: 'The star Sol seen from Earth; "the sun in the sky".', label: { en: 'Sun', ja: '日', ko: '해', zh: '太阳', yue: '日頭', vi: 'Mặt trời', th: 'ดวงอาทิตย์', id: 'Matahari', hi: 'सूरज', de: 'Sonne', fr: 'Soleil', it: 'Sole', es: 'Sol', pt: 'Sol', ru: 'Солнце', uk: 'Сонце', ar: 'شمس', he: 'שמש', sw: 'Jua' } },
  { id: 'moon', definition: "Earth's natural satellite; not the calendar month.", label: { en: 'Moon', ja: '月', ko: '달', zh: '月亮', yue: '月亮', vi: 'Mặt trăng', th: 'ดวงจันทร์', id: 'Bulan', hi: 'चाँद', de: 'Mond', fr: 'Lune', it: 'Luna', es: 'Luna', pt: 'Lua', ru: 'Луна', uk: 'Місяць', ar: 'قمر', he: 'ירח', sw: 'Mwezi' } },
  { id: 'mother', definition: 'Female parent — neutral/citation form; not specifically formal "mother" vs informal "mom" unless the language only has one register.', label: { en: 'Mother', ja: '母', ko: '어머니', zh: '母亲', yue: '母親', vi: 'Mẹ', th: 'แม่', id: 'Ibu', hi: 'माँ', de: 'Mutter', fr: 'Mère', it: 'Madre', es: 'Madre', pt: 'Mãe', ru: 'Мать', uk: 'Мати', ar: 'أم', he: 'אמא', sw: 'Mama' } },
  { id: 'father', definition: 'Male parent — neutral/citation form; same register convention as mother.', label: { en: 'Father', ja: '父', ko: '아버지', zh: '父亲', yue: '父親', vi: 'Bố', th: 'พ่อ', id: 'Ayah', hi: 'पिता', de: 'Vater', fr: 'Père', it: 'Padre', es: 'Padre', pt: 'Pai', ru: 'Отец', uk: 'Батько', ar: 'أب', he: 'אבא', sw: 'Baba' } },
  { id: 'eat', definition: 'Verb "to eat" — citation/dictionary form preferred (infinitive where the language has one; perfective 3ms for Semitic; bare stem for SE Asian).', label: { en: 'Eat', ja: '食べる', ko: '먹다', zh: '吃', yue: '食', vi: 'Ăn', th: 'กิน', id: 'Makan', hi: 'खाना', de: 'Essen', fr: 'Manger', it: 'Mangiare', es: 'Comer', pt: 'Comer', ru: 'Есть', uk: 'Їсти', ar: 'أكل', he: 'לאכול', sw: 'Kula' } },
  { id: 'drink', definition: 'Verb "to drink" — same form policy as eat. May overlap with eat in Iranian/Old Thai (lexical-overlap noted via wordEvidence).', label: { en: 'Drink', ja: '飲む', ko: '마시다', zh: '喝', yue: '飲', vi: 'Uống', th: 'ดื่ม', id: 'Minum', hi: 'पीना', de: 'Trinken', fr: 'Boire', it: 'Bere', es: 'Beber', pt: 'Beber', ru: 'Пить', uk: 'Пити', ar: 'شرب', he: 'לשתות', sw: 'Kunywa' } },
  { id: 'love', definition: 'Noun "love" (affection); not the verb. Emotional/romantic sense in most languages.', label: { en: 'Love', ja: '愛', ko: '사랑', zh: '爱', yue: '愛', vi: 'Yêu', th: 'รัก', id: 'Cinta', hi: 'प्रेम', de: 'Liebe', fr: 'Amour', it: 'Amore', es: 'Amor', pt: 'Amor', ru: 'Любовь', uk: 'Любов', ar: 'حب', he: 'אהבה', sw: 'Upendo' } },
  { id: 'heart', definition: 'Heart — anatomical OR mind/soul, depending on language. Many East/SE Asian languages (心/마음/ใจ/hati) primarily mean "mind/feeling"; languages with separate anatomical terms (心臓/심장/หัวใจ/jantung) use those for the organ. Cell shows the most basic-vocabulary cognitive/emotional sense unless the language only has one term.', label: { en: 'Heart', ja: '心', ko: '마음', zh: '心', yue: '心', vi: 'Tim', th: 'ใจ', id: 'Hati', hi: 'दिल', de: 'Herz', fr: 'Cœur', it: 'Cuore', es: 'Corazón', pt: 'Coração', ru: 'Сердце', uk: 'Серце', ar: 'قلب', he: 'לב', sw: 'Moyo' } },
  { id: 'tree', definition: 'Tree (woody plant); not specifically a tree species or "wood".', label: { en: 'Tree', ja: '木', ko: '나무', zh: '树', yue: '樹', vi: 'Cây', th: 'ต้นไม้', id: 'Pohon', hi: 'पेड़', de: 'Baum', fr: 'Arbre', it: 'Albero', es: 'Árbol', pt: 'Árvore', ru: 'Дерево', uk: 'Дерево', ar: 'شجرة', he: 'עץ', sw: 'Mti' } },
  { id: 'house', definition: 'House / dwelling — generic residence; not "home" as abstract concept or "building".', label: { en: 'House', ja: '家', ko: '집', zh: '房子', yue: '屋', vi: 'Nhà', th: 'บ้าน', id: 'Rumah', hi: 'घर', de: 'Haus', fr: 'Maison', it: 'Casa', es: 'Casa', pt: 'Casa', ru: 'Дом', uk: 'Дім', ar: 'بيت', he: 'בית', sw: 'Nyumba' } },
  { id: 'dog', definition: 'Domestic dog (Canis familiaris); generic, not a breed or sex-specific.', label: { en: 'Dog', ja: '犬', ko: '개', zh: '狗', yue: '狗', vi: 'Chó', th: 'หมา', id: 'Anjing', hi: 'कुत्ता', de: 'Hund', fr: 'Chien', it: 'Cane', es: 'Perro', pt: 'Cão', ru: 'Собака', uk: 'Собака', ar: 'كلب', he: 'כלב', sw: 'Mbwa' } },
  { id: 'cat', definition: 'Domestic cat (Felis catus); generic/sex-neutral preferred where the language distinguishes (e.g. ru кошка / uk кішка) — but male-default citation form may appear in some languages.', label: { en: 'Cat', ja: '猫', ko: '고양이', zh: '猫', yue: '貓', vi: 'Mèo', th: 'แมว', id: 'Kucing', hi: 'बिल्ली', de: 'Katze', fr: 'Chat', it: 'Gatto', es: 'Gato', pt: 'Gato', ru: 'Кошка', uk: 'Кішка', ar: 'قطة', he: 'חתול', sw: 'Paka' } },
  { id: 'hand', definition: 'Hand (distal upper limb); not "arm". Some languages do not distinguish hand vs arm.', label: { en: 'Hand', ja: '手', ko: '손', zh: '手', yue: '手', vi: 'Tay', th: 'มือ', id: 'Tangan', hi: 'हाथ', de: 'Hand', fr: 'Main', it: 'Mano', es: 'Mano', pt: 'Mão', ru: 'Рука', uk: 'Рука', ar: 'يد', he: 'יד', sw: 'Mkono' } },
  { id: 'eye', definition: 'Eye (organ of sight); singular form preferred.', label: { en: 'Eye', ja: '目', ko: '눈', zh: '眼睛', yue: '眼', vi: 'Mắt', th: 'ตา', id: 'Mata', hi: 'आँख', de: 'Auge', fr: 'Œil', it: 'Occhio', es: 'Ojo', pt: 'Olho', ru: 'Глаз', uk: 'Око', ar: 'عين', he: 'עין', sw: 'Jicho' } },
  { id: 'hello', definition: 'Standard greeting — most common neutral "hello"; not time-of-day specific (good morning/evening) unless the language only has those.', label: { en: 'Hello', ja: 'こんにちは', ko: '안녕', zh: '你好', yue: '你好', vi: 'Xin chào', th: 'สวัสดี', id: 'Halo', hi: 'नमस्ते', de: 'Hallo', fr: 'Bonjour', it: 'Ciao', es: 'Hola', pt: 'Olá', ru: 'Привет', uk: 'Привіт', ar: 'مرحبا', he: 'שלום', sw: 'Habari' } },
  { id: 'thanks', definition: 'Expression of gratitude — interjection/formula form, not the noun "gratitude" unless the language only has the noun.', label: { en: 'Thank you', ja: 'ありがとう', ko: '감사', zh: '谢谢', yue: '多謝', vi: 'Cảm ơn', th: 'ขอบคุณ', id: 'Terima kasih', hi: 'धन्यवाद', de: 'Danke', fr: 'Merci', it: 'Grazie', es: 'Gracias', pt: 'Obrigado', ru: 'Спасибо', uk: 'Дякую', ar: 'شكرا', he: 'תודה', sw: 'Asante' } },
  { id: 'one', definition: 'Cardinal numeral 1; masculine/default citation form where languages distinguish gender (e.g. ar واحد, he אחד, fr un, es uno).', label: { en: 'One', ja: '一', ko: '하나', zh: '一', yue: '一', vi: 'Một', th: 'หนึ่ง', id: 'Satu', hi: 'एक', de: 'Eins', fr: 'Un', it: 'Uno', es: 'Uno', pt: 'Um', ru: 'Один', uk: 'Один', ar: 'واحد', he: 'אחד', sw: 'Moja' } },
  { id: 'good', definition: 'Adjective "good" (positive quality); preferably attributive citation form, not adverb "well" (avoid ru хорошо / uk добре adverbs).', label: { en: 'Good', ja: '良い', ko: '좋은', zh: '好', yue: '好', vi: 'Tốt', th: 'ดี', id: 'Baik', hi: 'अच्छा', de: 'Gut', fr: 'Bon', it: 'Buono', es: 'Bueno', pt: 'Bom', ru: 'Хороший', uk: 'Добрий', ar: 'جيد', he: 'טוב', sw: 'Nzuri' } },
];
...
const LANG_DATA = {
  ...
  ja_osa: { name: 'Japanese (Osaka)', native: '日本語(大阪)', lat: 34.69, lng: 135.50,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['日','hi'], moon:['月','tsɯki'], mother:['おかん','okaɴ'], father:['おとん','otoɴ'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['毎度','maido'], thanks:['おおきに','oːkini'], one:['一','itɕi'], good:['良え','eː'] }},
  ...
  ja_hak: { name: 'Japanese (Hakata)', native: '日本語(博多)', lat: 33.59, lng: 130.40,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['日','hi'], moon:['月','tsɯki'], mother:['おかん','okaɴ'], father:['おとん','otoɴ'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['良かねー','jokaneː'], thanks:['ありがとう','aɾiɡatoː'], one:['一','itɕi'], good:['良か','joka'] }},
  ja_kyo: { name: 'Japanese (Kyoto)', native: '日本語(京都)', lat: 35.01, lng: 135.77,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['日','hi'], moon:['月','tsɯki'], mother:['お母さん','okaːsaɴ'], father:['お父さん','otoːsaɴ'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['おいでやす','oidejasɯ'], thanks:['おおきに','oːkini'], one:['一','itɕi'], good:['宜し','joɾoɕi'] }},
  ...
  yue: { name: 'Cantonese', native: '廣東話', lat: 22.28, lng: 114.16, // Hong Kong
    words: { water:['水','sɵy˧˥'], fire:['火','fɔː˧˥'], sun:['日頭','jɐt˨ tʰɐu˨˩'], moon:['月光','jyːt˨ kʷɔːŋ˥'], mother:['媽媽','maː˥maː˥'], father:['爸爸','paː˨˩paː˥'], eat:['食','sɪk˨'], drink:['飲','jɐm˧˥'], love:['愛','ɔːi˧'], heart:['心','sɐm˥'], tree:['樹','syː˨'], house:['屋','ʊk˥'], dog:['狗','kɐu˧˥'], cat:['貓','maːu˥'], hand:['手','sɐu˧˥'], eye:['眼','ŋaːn˧˩'], hello:['你好','neːi˧˩hɔːu˧˥'], thanks:['多謝','tɔː˥tɕɛː˨'], one:['一','jɐt˥'], good:['好','hɔːu˧˥'] }},
  nan: { name: 'Taiwanese', native: '台語', lat: 25.03, lng: 121.57, // Taipei
    words: { water:['水','tsui˧˥'], fire:['火','hue˧˥'], sun:['日頭','lit˦˧tʰau˧˥'], moon:['月娘','ɡueʔ˦niu˧˥'], mother:['媽媽','ma˥ma'], father:['爸爸','pa˥pa'], eat:['食','tsiaʔ˦'], drink:['啉','lim˥'], love:['愛','ai˧'], heart:['心','sim˥'], tree:['樹','tsʰiu˧'], house:['厝','tsʰu˧'], dog:['狗','kau˧˥'], cat:['貓','niau˥'], hand:['手','tsʰiu˧˥'], eye:['目','bak˦'], hello:['你好','li˧˥ho˧˥'], thanks:['多謝','to˥sia˧'], one:['一','it˦'], good:['好','ho˧˥'] }},
  ...
  it: { name: 'Italian', native: 'Italiano', lat: 41.90, lng: 12.50, // Rome
    words: { water:['acqua','ˈakkwa'], fire:['fuoco','ˈfwɔːko'], sun:['sole','ˈsoːle'], moon:['luna','ˈluːna'], mother:['madre','ˈmaːdre'], father:['padre','ˈpaːdre'], eat:['mangiare','manˈdʒaːre'], drink:['bere','ˈbeːre'], love:['amore','aˈmoːre'], heart:['cuore','ˈkwɔːre'], tree:['albero','ˈalbero'], house:['casa','ˈkaːza'], dog:['cane','ˈkaːne'], cat:['gatto','ˈɡatto'], hand:['mano','ˈmaːno'], eye:['occhio','ˈɔkkjo'], hello:['ciao','ˈtʃaːo'], thanks:['grazie','ˈɡrattsje'], one:['uno','ˈuːno'], good:['buono','ˈbwɔːno'] }},
  ...
  he: { name: 'Hebrew', native: 'עברית', lat: 32.07, lng: 34.78, // Tel Aviv
    words: { water:['מים','majim'], fire:['אש','eʃ'], sun:['שמש','ʃemeʃ'], moon:['ירח','jaɾeaχ'], mother:['אמא','ima'], father:['אבא','aba'], eat:['לאכול','leeχol'], drink:['לשתות','liʃtot'], love:['אהבה','ahava'], heart:['לב','lev'], tree:['עץ','ets'], house:['בית','bajit'], dog:['כלב','kelev'], cat:['חתול','χatul'], hand:['יד','jad'], eye:['עין','ajin'], hello:['שלום','ʃalom'], thanks:['תודה','toda'], one:['אחד','eχad'], good:['טוב','tov'] }},
  ...
  ja_kg: { name: 'Japanese (Kagoshima)', native: '日本語(鹿児島)', lat: 31.59, lng: 130.55, // Kagoshima
    words: { water:['水','mid̥zɯ̥'], fire:['火っ','çiʔ'], sun:['お日さん','ohisaɴ'], moon:['月','tsɯki'], mother:['かか','kaka'], father:['とと','toto'], eat:['食ぼっか','tabokːa'], drink:['飲んで','nondeː'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','eː'], dog:['犬','iɴ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['おやっとさあ','ojattosaː'], thanks:['ありがとさげもす','aɾiɡatosaɡemosɯ'], one:['一つ','çitotsɯ'], good:['良か','joka'] }},
  ja_sd: { name: 'Japanese (Sendai)', native: '日本語(仙台)', lat: 38.27, lng: 140.87, // Sendai
    words: { water:['水','midzɯ'], fire:['火','hi'], sun:['お日さま','ohisama'], moon:['月','tsɯki'], mother:['おっかさん','okːasaɴ'], father:['おっとさん','otːosaɴ'], eat:['食う','kuː'], drink:['飲む','nomɯ'], love:['めごい','meɡoi'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['おばんでがす','obandeɡasɯ'], thanks:['ありがとがんす','aɾiɡatoɡansɯ'], one:['一っつ','hitottsɯ'], good:['良いでがす','iːdeɡasɯ'] }},
  ...
  wuu_nb: { name: 'Ningbo Wu', native: '宁波话', lat: 29.87, lng: 121.55, // Ningbo
    words: { water:['水','sɿ˨˩˦'], fire:['火','hu˨˩˦'], sun:['日头','ɲiʔ˩˨dɤu'], moon:['月亮','ɲyəʔ˩˨liaŋ'], mother:['阿妈','aʔ˦˦ma'], father:['阿爸','aʔ˦˦pa'], eat:['吃','tɕʰiʔ˩˨'], drink:['喝','hoʔ˩˨'], love:['爱','ai˥˧'], heart:['心','siɴ˦˦'], tree:['树','zɿ˨˧'], house:['屋里','oʔ˥˥li'], dog:['狗','kəu˨˩˦'], cat:['猫','mɔ˦˦'], hand:['手','sɤu˨˩˦'], eye:['眼睛','ŋɛ˨˧tɕiɴ˦˦'], hello:['侬好','noŋ˦˦hɔ˨˩˦'], thanks:['谢谢','ɕia˨˧ɕia'], one:['一','iʔ˩˨'], good:['好','hɔ˨˩˦'] }},
  ...
  tji: { name: 'Tujia', native: 'Bizisa', lat: 29.31, lng: 109.49, // Zhangjiajie/Enshi
    words: { water:['zi','tsɨ˥˧'], fire:['mi','mi˥˧'], sun:['ni','ni˧˥'], moon:['nie','nie˧˥'], mother:['a-mie','a˧mie˧'], father:['a-pa','a˧pa˧'], eat:['za','tsa˨˩'], drink:['da','ta˧'], love:['aci','a˧˥tsi˥'], heart:['xin','ɕin˧'], tree:['si','sɨ˧˥'], house:['li','li˧˥'], dog:['kvʼ','kʰə˨˩'], cat:['mau','mau˧'], hand:['lo','lo˨˩'], eye:['mie','mie˨˩'], hello:['shu shu','ʃu˧ʃu˧'], thanks:['angzai','aŋ˧˥tsai˥'], one:['lao','lao˧˥'], good:['ngaq','ŋaʔ˧˥'] }},
