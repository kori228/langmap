...
const WORD_LIST = [
  { id: 'water', en: 'Water', ja: '水', ko: '물', zh: '水', yue: '水', vi: 'Nước', th: 'น้ำ', ind: 'Air', hi: 'पानी', de: 'Wasser', fr: 'Eau', it: 'Acqua', es: 'Agua', pt: 'Água', ru: 'Вода', uk: 'Вода', ar: 'ماء', he: 'מים', sw: 'Maji' },
  { id: 'fire', en: 'Fire', ja: '火', ko: '불', zh: '火', yue: '火', vi: 'Lửa', th: 'ไฟ', ind: 'Api', hi: 'आग', de: 'Feuer', fr: 'Feu', it: 'Fuoco', es: 'Fuego', pt: 'Fogo', ru: 'Огонь', uk: 'Вогонь', ar: 'نار', he: 'אש', sw: 'Moto' },
  { id: 'sun', en: 'Sun', ja: '太陽', ko: '태양', zh: '太阳', yue: '太陽', vi: 'Mặt trời', th: 'ดวงอาทิตย์', ind: 'Matahari', hi: 'सूरज', de: 'Sonne', fr: 'Soleil', it: 'Sole', es: 'Sol', pt: 'Sol', ru: 'Солнце', uk: 'Сонце', ar: 'شمس', he: 'שמש', sw: 'Jua' },
  { id: 'moon', en: 'Moon', ja: '月', ko: '달', zh: '月亮', yue: '月亮', vi: 'Mặt trăng', th: 'ดวงจันทร์', ind: 'Bulan', hi: 'चाँद', de: 'Mond', fr: 'Lune', it: 'Luna', es: 'Luna', pt: 'Lua', ru: 'Луна', uk: 'Місяць', ar: 'قمر', he: 'ירח', sw: 'Mwezi' },
  { id: 'mother', en: 'Mother', ja: '母', ko: '어머니', zh: '母亲', yue: '母親', vi: 'Mẹ', th: 'แม่', ind: 'Ibu', hi: 'माँ', de: 'Mutter', fr: 'Mère', it: 'Madre', es: 'Madre', pt: 'Mãe', ru: 'Мать', uk: 'Мати', ar: 'أم', he: 'אמא', sw: 'Mama' },
  { id: 'father', en: 'Father', ja: '父', ko: '아버지', zh: '父亲', yue: '父親', vi: 'Bố', th: 'พ่อ', ind: 'Ayah', hi: 'पिता', de: 'Vater', fr: 'Père', it: 'Padre', es: 'Padre', pt: 'Pai', ru: 'Отец', uk: 'Батько', ar: 'أب', he: 'אבא', sw: 'Baba' },
  { id: 'eat', en: 'Eat', ja: '食べる', ko: '먹다', zh: '吃', yue: '食', vi: 'Ăn', th: 'กิน', ind: 'Makan', hi: 'खाना', de: 'Essen', fr: 'Manger', it: 'Mangiare', es: 'Comer', pt: 'Comer', ru: 'Есть', uk: 'Їсти', ar: 'أكل', he: 'לאכול', sw: 'Kula' },
  { id: 'drink', en: 'Drink', ja: '飲む', ko: '마시다', zh: '喝', yue: '飲', vi: 'Uống', th: 'ดื่ม', ind: 'Minum', hi: 'पीना', de: 'Trinken', fr: 'Boire', it: 'Bere', es: 'Beber', pt: 'Beber', ru: 'Пить', uk: 'Пити', ar: 'شرب', he: 'לשתות', sw: 'Kunywa' },
  { id: 'love', en: 'Love', ja: '愛', ko: '사랑', zh: '爱', yue: '愛', vi: 'Yêu', th: 'รัก', ind: 'Cinta', hi: 'प्रेम', de: 'Liebe', fr: 'Amour', it: 'Amore', es: 'Amor', pt: 'Amor', ru: 'Любовь', uk: 'Любов', ar: 'حب', he: 'אהבה', sw: 'Upendo' },
  { id: 'heart', en: 'Heart', ja: '心', ko: '마음', zh: '心', yue: '心', vi: 'Tim', th: 'ใจ', ind: 'Hati', hi: 'दिल', de: 'Herz', fr: 'Cœur', it: 'Cuore', es: 'Corazón', pt: 'Coração', ru: 'Сердце', uk: 'Серце', ar: 'قلب', he: 'לב', sw: 'Moyo' },
  { id: 'tree', en: 'Tree', ja: '木', ko: '나무', zh: '树', yue: '樹', vi: 'Cây', th: 'ต้นไม้', ind: 'Pohon', hi: 'पेड़', de: 'Baum', fr: 'Arbre', it: 'Albero', es: 'Árbol', pt: 'Árvore', ru: 'Дерево', uk: 'Дерево', ar: 'شجرة', he: 'עץ', sw: 'Mti' },
  { id: 'house', en: 'House', ja: '家', ko: '집', zh: '房子', yue: '屋', vi: 'Nhà', th: 'บ้าน', ind: 'Rumah', hi: 'घर', de: 'Haus', fr: 'Maison', it: 'Casa', es: 'Casa', pt: 'Casa', ru: 'Дом', uk: 'Дім', ar: 'بيت', he: 'בית', sw: 'Nyumba' },
  { id: 'dog', en: 'Dog', ja: '犬', ko: '개', zh: '狗', yue: '狗', vi: 'Chó', th: 'หมา', ind: 'Anjing', hi: 'कुत्ता', de: 'Hund', fr: 'Chien', it: 'Cane', es: 'Perro', pt: 'Cão', ru: 'Собака', uk: 'Собака', ar: 'كلب', he: 'כלב', sw: 'Mbwa' },
  { id: 'cat', en: 'Cat', ja: '猫', ko: '고양이', zh: '猫', yue: '貓', vi: 'Mèo', th: 'แมว', ind: 'Kucing', hi: 'बिल्ली', de: 'Katze', fr: 'Chat', it: 'Gatto', es: 'Gato', pt: 'Gato', ru: 'Кошка', uk: 'Кіт', ar: 'قطة', he: 'חתול', sw: 'Paka' },
  { id: 'hand', en: 'Hand', ja: '手', ko: '손', zh: '手', yue: '手', vi: 'Tay', th: 'มือ', ind: 'Tangan', hi: 'हाथ', de: 'Hand', fr: 'Main', it: 'Mano', es: 'Mano', pt: 'Mão', ru: 'Рука', uk: 'Рука', ar: 'يد', he: 'יד', sw: 'Mkono' },
  { id: 'eye', en: 'Eye', ja: '目', ko: '눈', zh: '眼睛', yue: '眼', vi: 'Mắt', th: 'ตา', ind: 'Mata', hi: 'आँख', de: 'Auge', fr: 'Œil', it: 'Occhio', es: 'Ojo', pt: 'Olho', ru: 'Глаз', uk: 'Око', ar: 'عين', he: 'עין', sw: 'Jicho' },
  { id: 'hello', en: 'Hello', ja: 'こんにちは', ko: '안녕', zh: '你好', yue: '你好', vi: 'Xin chào', th: 'สวัสดี', ind: 'Halo', hi: 'नमस्ते', de: 'Hallo', fr: 'Bonjour', it: 'Ciao', es: 'Hola', pt: 'Olá', ru: 'Привет', uk: 'Привіт', ar: 'مرحبا', he: 'שלום', sw: 'Habari' },
  { id: 'thanks', en: 'Thank you', ja: 'ありがとう', ko: '감사', zh: '谢谢', yue: '多謝', vi: 'Cảm ơn', th: 'ขอบคุณ', ind: 'Terima kasih', hi: 'धन्यवाद', de: 'Danke', fr: 'Merci', it: 'Grazie', es: 'Gracias', pt: 'Obrigado', ru: 'Спасибо', uk: 'Дякую', ar: 'شكرا', he: 'תודה', sw: 'Asante' },
  { id: 'one', en: 'One', ja: '一', ko: '하나', zh: '一', yue: '一', vi: 'Một', th: 'หนึ่ง', ind: 'Satu', hi: 'एक', de: 'Eins', fr: 'Un', it: 'Uno', es: 'Uno', pt: 'Um', ru: 'Один', uk: 'Один', ar: 'واحد', he: 'אחד', sw: 'Moja' },
  { id: 'good', en: 'Good', ja: '良い', ko: '좋은', zh: '好', yue: '好', vi: 'Tốt', th: 'ดี', ind: 'Baik', hi: 'अच्छा', de: 'Gut', fr: 'Bon', it: 'Buono', es: 'Bueno', pt: 'Bom', ru: 'Хороший', uk: 'Добрий', ar: 'جيد', he: 'טוב', sw: 'Nzuri' },
];
...
const LANG_DATA = {
  ...
  ja: { name: 'Japanese', native: '日本語', lat: 35.68, lng: 139.69, // Tokyo
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['太陽','taijoː'], moon:['月','tsɯki'], mother:['母','haha'], father:['父','tɕitɕi'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['こんにちは','konnitɕiwa'], thanks:['ありがとう','aɾiɡatoː'], one:['一','itɕi'], good:['良い','joi'] }},
  ja_osa: { name: 'Japanese (Osaka)', native: '日本語(大阪)', lat: 34.69, lng: 135.50,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['太陽','taijoː'], moon:['月','tsɯki'], mother:['おかん','okaN'], father:['おとん','otoN'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['まいど','maido'], thanks:['おおきに','oːkini'], one:['一','itɕi'], good:['ええ','eː'] }},
  ja_aom: { name: 'Japanese (Aomori)', native: '日本語(青森)', lat: 40.82, lng: 140.74,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['太陽','taijoː'], moon:['月','tsɯki'], mother:['かっちゃ','kattɕa'], father:['とっちゃ','tottɕa'], eat:['食う','kɯː'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['どうも','doːmo'], thanks:['ありがどー','aɾiɡadoː'], one:['一','itɕi'], good:['いい','iː'] }},
  ja_oki: { name: 'Japanese (Okinawa)', native: '日本語(沖縄)', lat: 26.33, lng: 127.80,
    words: { water:['水','midʑi'], fire:['火','hi'], sun:['てぃだ','tida'], moon:['月','tɕitɕi'], mother:['あんまー','ammaː'], father:['すー','suː'], eat:['かむん','kamun'], drink:['ぬむん','numun'], love:['愛','ai'], heart:['心','kukuɾu'], tree:['木','kiː'], house:['やー','jaː'], dog:['犬','inɯ'], cat:['まやー','majaː'], hand:['てぃー','tiː'], eye:['みー','miː'], hello:['はいさい','haisai'], thanks:['にふぇーでーびる','niɸeːdeːbiɾu'], one:['一','tʰiːtɕi'], good:['まし','maɕi'] }},
  ja_hak: { name: 'Japanese (Hakata)', native: '日本語(博多)', lat: 33.59, lng: 130.40,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['太陽','taijoː'], moon:['月','tsɯki'], mother:['おかん','okaN'], father:['おとん','otoN'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['よかねー','jokaneː'], thanks:['ありがとう','aɾiɡatoː'], one:['一','itɕi'], good:['よか','joka'] }},
  ja_kyo: { name: 'Japanese (Kyoto)', native: '日本語(京都)', lat: 35.01, lng: 135.77,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['太陽','taijoː'], moon:['月','tsɯki'], mother:['おかあさん','okaːsaN'], father:['おとうさん','otoːsaN'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['おいでやす','oidejasɯ'], thanks:['おおきに','oːkini'], one:['一','itɕi'], good:['よろし','joɾoɕi'] }},
  ja_hir: { name: 'Japanese (Hiroshima)', native: '日本語(広島)', lat: 34.39, lng: 132.46,
    words: { water:['水','mizɯ'], fire:['火','hi'], sun:['太陽','taijoː'], moon:['月','tsɯki'], mother:['おふくろ','ohɯkɯɾo'], father:['おやじ','ojadʑi'], eat:['食べる','tabeɾɯ'], drink:['飲む','nomɯ'], love:['愛','ai'], heart:['心','kokoɾo'], tree:['木','ki'], house:['家','ie'], dog:['犬','inɯ'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['やあ','jaː'], thanks:['ありがとう','aɾiɡatoː'], one:['一','itɕi'], good:['ええ','eː'] }},
  ja_mvi: { name: 'Miyako', native: '宮古語', lat: 24.79, lng: 125.28,
    words: { water:['みず','midzu'], fire:['ぴー','piː'], sun:['てぃだ','tida'], moon:['つき','tsɨkɨ'], mother:['あんま','amma'], father:['うや','uja'], eat:['かむ','kamu'], drink:['ぬむ','numu'], love:['愛','ai'], heart:['きむ','kimu'], tree:['きー','kiː'], house:['やー','jaː'], dog:['いん','in'], cat:['まやー','majaː'], hand:['てぃー','tiː'], eye:['みー','miː'], hello:['んみゃーち','mjaːtɕi'], thanks:['たんでぃがーたんでぃ','tandiɡaːtandi'], one:['ぷーつ','puːts'], good:['まし','maɕi'] }},
  ja_rys: { name: 'Yaeyama', native: '八重山語', lat: 24.34, lng: 124.16,
    words: { water:['みずぃ','midzɨ'], fire:['ぴー','piː'], sun:['てぃだ','tida'], moon:['つぃきぃ','tsɨkɨ'], mother:['あんま','amma'], father:['うや','uja'], eat:['かむん','kamun'], drink:['ぬむん','numun'], love:['愛','ai'], heart:['きむ','kimu'], tree:['きー','kiː'], house:['やー','jaː'], dog:['いん','in'], cat:['まやー','majaː'], hand:['てぃー','tiː'], eye:['みー','miː'], hello:['おーりとーり','oːɾitoːɾi'], thanks:['みーふぁいゆー','miːɸaijuː'], one:['ぷーつぃ','puːtsɨ'], good:['まし','maɕi'] }},
  ko: { name: 'Korean', native: '한국어', lat: 37.57, lng: 126.98, // Seoul
    words: { water:['물','mul'], fire:['불','pul'], sun:['해','hɛ'], moon:['달','tal'], mother:['어머니','ʌmʌni'], father:['아버지','abʌdʑi'], eat:['먹다','mʌk̚t͈a'], drink:['마시다','maɕida'], love:['사랑','saɾaŋ'], heart:['마음','maɯm'], tree:['나무','namu'], house:['집','tɕip̚'], dog:['개','kɛ'], cat:['고양이','kojaŋi'], hand:['손','son'], eye:['눈','nun'], hello:['안녕하세요','annjʌŋhasejo'], thanks:['감사합니다','kamsahamnida'], one:['하나','hana'], good:['좋다','tɕot̚t͈a'] }},
  ko_kp: { name: 'Korean (DPRK)', native: '조선말', lat: 39.02, lng: 125.75, // Pyongyang
    words: { water:['물','mul'], fire:['불','pul'], sun:['해','hɛ'], moon:['달','tal'], mother:['어머니','ʌmʌni'], father:['아버지','abʌdʑi'], eat:['먹다','mʌk̚t͈a'], drink:['마시다','maɕida'], love:['사랑','saɾaŋ'], heart:['마음','maɯm'], tree:['나무','namu'], house:['집','tɕip̚'], dog:['개','kɛ'], cat:['고양이','kojaŋi'], hand:['손','son'], eye:['눈','nun'], hello:['안녕하십니까','annjʌŋhaɕimnikka'], thanks:['감사합니다','kamsahamnida'], one:['하나','hana'], good:['좋다','tɕot̚t͈a'] }},
  ...
  ko_yb: { name: 'Yanbian Korean', native: '연변조선어', lat: 42.90, lng: 129.51,
    words: { water:['물','mul'], fire:['불','pul'], sun:['해','hɛ'], moon:['달','tal'], mother:['어무이','ʌmui'], father:['아부지','abudʑi'], eat:['먹다','mʌk̚t͈a'], drink:['마시다','maɕida'], love:['사랑','saɾaŋ'], heart:['마음','maɯm'], tree:['나무','namu'], house:['집','tɕip̚'], dog:['개','kɛ'], cat:['고양이','kojaŋi'], hand:['손','son'], eye:['눈','nun'], hello:['안녕하십니까','annjʌŋhaɕimnikka'], thanks:['감사합니다','kamsahamnida'], one:['하나','hana'], good:['좋다','tɕot̚t͈a'] }},
  ...
  yue: { name: 'Cantonese', native: '廣東話', lat: 22.28, lng: 114.16, // Hong Kong
    words: { water:['水','sɵy˧˥'], fire:['火','fɔː˧˥'], sun:['太陽','tʰaːi˧ jœːŋ˨˩'], moon:['月亮','jyːt˨ lœːŋ˨'], mother:['媽媽','maː˥maː˥'], father:['爸爸','paː˨˩paː˥'], eat:['食','sɪk˨'], drink:['飲','jɐm˧˥'], love:['愛','ɔːi˧'], heart:['心','sɐm˥'], tree:['樹','syː˨'], house:['屋','ʊk˥'], dog:['狗','kɐu˧˥'], cat:['貓','maːu˥'], hand:['手','sɐu˧˥'], eye:['眼','ŋaːn˧˩'], hello:['你好','neːi˧˩hɔːu˧˥'], thanks:['多謝','tɔː˥tɕɛː˨'], one:['一','jɐt˥'], good:['好','hɔːu˧˥'] }},
  ...
  wuu: { name: 'Shanghainese', native: '上海话', lat: 31.23, lng: 121.47,
  ...
  hak_cn: { name: 'Hakka', native: '客家話', lat: 24.30, lng: 116.12, // Meizhou
    words: { water:['水','sui˧˩'], fire:['火','fo˧˩'], sun:['日頭','ŋit˧tʰeu˧˥'], moon:['月光','ŋiat˧koŋ˥'], mother:['阿姆','a˥me˧'], father:['阿爸','a˥pa˥'], eat:['食','sɨt˧'], drink:['飲','iam˧˩'], love:['愛','oi˧'], heart:['心','sim˥'], tree:['樹','su˧'], house:['屋','vuk˧'], dog:['狗','kieu˧˩'], cat:['貓','miau˥'], hand:['手','su˧˩'], eye:['目','muk˧'], hello:['你好','ngi˧˥ho˧˩'], thanks:['多謝','to˥tsia˧'], one:['一','it˧'], good:['好','ho˧˩'] }},
  ...
  sa: { name: 'Sanskrit', native: 'संस्कृतम्', lat: 27.18, lng: 78.02, // Agra (historical center)
    words: { water:['जलम्','dʒalam'], fire:['अग्निः','aɡniː'], sun:['सूर्यः','suːɾjaː'], moon:['चन्द्रः','tɕandɾaː'], mother:['माता','maːtaː'], father:['पिता','pitaː'], eat:['खादति','kʰaːdati'], drink:['पिबति','pibati'], love:['प्रेम','preːma'], heart:['हृदयम्','hɾɨdajam'], tree:['वृक्षः','vɾɨkʂaː'], house:['गृहम्','ɡɾɨham'], dog:['श्वा','ɕvaː'], cat:['मार्जारः','maːɾdʒaːɾaː'], hand:['हस्तः','hastaː'], eye:['नेत्रम्','neːtɾam'], hello:['नमस्ते','namasteː'], thanks:['धन्यवादः','dʰanjaʋaːdaː'], one:['एकम्','eːkam'], good:['उत्तमम्','uttamam'] }},
  ...
  my: { name: 'Burmese', native: 'မြန်မာ', lat: 16.87, lng: 96.20, // Yangon
    words: { water:['ရေ','je'], fire:['မီး','mi'], sun:['နေ','ne'], moon:['လ','la'], mother:['အမေ','ʔəme'], father:['အဖေ','ʔəpʰe'], eat:['စား','sa'], drink:['သောက်','θauʔ'], love:['အချစ်','ʔətɕʰiʔ'], heart:['နှလုံး','n̥əlóuN'], tree:['သစ်ပင်','θiʔpìN'], house:['အိမ်','ʔèiN'], dog:['ခွေး','kʰwé'], cat:['ကြောင်','tɕàuN'], hand:['လက်','lɛʔ'], eye:['မျက်စိ','mjɛʔsì'], hello:['မင်္ဂလာပါ','mìNɡəlà pà'], thanks:['ကျေးဇူးတင်ပါတယ်','tɕézú tìN pà dɛ̀'], one:['တစ်','tiʔ'], good:['ကောင်း','káuN'] }},
  ...
  // === African ===
  yo: { name: 'Yoruba', native: 'Yorùbá', lat: 6.45, lng: 3.40, // Lagos
  ...
  hy: { name: 'Armenian', native: 'Հայերեն', lat: 40.18, lng: 44.51, // Yerevan
    words: { water:['ջուր','dʒuɾ'], fire:['կրակ','kɾɑk'], sun:['արdelays','aɾev'], moon:['լուսin','lusin'], mother:['մայր','majɾ'], father:['հայр','hajɾ'], eat:['ուdelays','utel'], drink:['խմel','xmel'], love:['սdelays','seɾ'], heart:['սirt','siɾt'], tree:['ծar','tsaɾ'], house:['tun','tun'], dog:['շun','ʃun'], cat:['katou','kɑtu'], hand:['dzerrk','dzeɾkʰ'], eye:['atchk','ɑtʃkʰ'], hello:['barev','bɑɾev'], thanks:['shnorhakalutyun','ʃnoɾhɑkɑlutʰjun'], one:['meg','meɡ'], good:['lav','lɑv'] }},
  nv: { name: 'Navajo', native: 'Diné bizaad', lat: 36.17, lng: -109.51, // Window Rock
    words: { water:['tó','tʰóː'], fire:['kǫʼ','kʰõːʔ'], sun:['jóhonaaʼéí','dʒóhonɑːʔéːí'], moon:['tłéhonaaʼéí','tɬʼéhonɑːʔéːí'], mother:['shimá','ʃimáː'], father:['shizhéʼé','ʃiʒéːʔéː'], eat:['yishą́','jiʃã́ː'], drink:['yishą́','jiʃã́ː'], love:['ayóóʼánóshní','ɑjóːʔɑ́nóʃníː'], heart:['ajéí','ɑdʒéːí'], tree:['tsin','t͡sin'], house:['hooghan','hoːɣɑn'], dog:['łééchąąʼí','ɬéːtʃãːʔí'], cat:['mósí','mósí'], hand:['la','lɑ'], eye:['naá','nɑ́ː'], hello:['yáʼátʼééh','jɑ́ːʔɑ́tʰéːh'], thanks:['ahéheeʼ','ɑhéːheːʔ'], one:['tʼááłáʼí','tʼɑ́ːɬɑ́ːʔí'], good:['yáʼátʼééh','jɑ́ːʔɑ́tʰéːh'] }},
  ...
  cdo: { name: 'Min Dong', native: '閩東語', lat: 26.07, lng: 119.30,
    words: { water:['水','tsui˧˧'], fire:['火','huoi˧˧'], sun:['日頭','nit˧tʰau˧˧'], moon:['月光','ŋuoʔ˨˦kuoŋ˥'], mother:['依媽','i˥ma˧˧'], father:['依爸','i˥pa˥'], eat:['食','sieʔ˨˦'], drink:['啜','tsoʔ˨˦'], love:['愛','ai˧'], heart:['心','siŋ˥'], tree:['樹','tshiu˧'], house:['厝','tsʰuo˧'], dog:['犬','kʰyøŋ˧˧'], cat:['貓','ma˥'], hand:['手','tsʰiu˧˧'], eye:['目','muʔ˨˦'], hello:['汝好','ny˧˧ho˧˧'], thanks:['謝謝','sia˧sia'], one:['一','suoʔ˨˦'], good:['好','ho˧˧'] }},
  ...
  za: { name: 'Zhuang', native: 'Vahcuengh', lat: 22.82, lng: 108.32,
  ...
  pau: { name: 'Palauan', native: 'A tekoi er a Belau', lat: 7.50, lng: 134.62,
    words: { water:['ralm','ɾalm'], fire:['ngau','ŋau'], sun:['sils','sils'], moon:['buil','buil'], mother:['delak','ðɛlak'], father:['demak','ðɛmak'], eat:['mengang','mɛŋaŋ'], drink:['melim','mɛlim'], love:['klou el reng','klou ɛl ɾɛŋ'], heart:['reng','ɾɛŋ'], tree:['kerrekar','kɛrːɛkar'], house:['blai','blai'], dog:['katuu','katuː'], cat:['katuu','katuː'], hand:['chim','tʃim'], eye:['mad','mað'], hello:['alii','aliː'], thanks:['sulang','sulaŋ'], one:['tang','taŋ'], good:['klou','klou'] }},
  ...
  ig: { name: 'Igbo', native: 'Igbo', lat: 6.45, lng: 3.40,
  ...
  om: { name: 'Oromo', native: 'Afaan Oromoo', lat: 9.02, lng: 38.75,
  ...
  xh: { name: 'Xhosa', native: 'isiXhosa', lat: -33.93, lng: 18.42,
  ...
  sk: { name: 'Slovak', native: 'Slovenčina', lat: 48.15, lng: 17.11,
    words: { water:['voda','voda'], fire:['oheň','oɦeɲ'], sun:['slnko','slnko'], moon:['mesiac','mɛsɪats'], mother:['matka','matka'], father:['otec','otɛts'], eat:['jesť','jɛscc'], drink:['piť','pɪcc'], love:['láska','laːska'], heart:['srdce','srtsɛ'], tree:['strom','strom'], house:['dom','dom'], dog:['pes','pɛs'], cat:['mačka','matʃka'], hand:['ruka','ruka'], eye:['oko','oko'], hello:['ahoj','aɦoj'], thanks:['ďakujem','ɟakujɛm'], one:['jeden','jɛdɛn'], good:['dobrý','dobriː'] }},
  ...
  pcm: { name: 'Nigerian Pidgin', native: 'Naijá', lat: 6.45, lng: 3.40,
  ...
  myn: { name: 'Classical Maya', native: 'Maaya Tzij', lat: 14.63, lng: -90.51,
    words: { water:['ha\'','haʔ'], fire:['k\'ahk\'','kʼahkʼ'], sun:['k\'in','kʼin'], moon:['uh','uh'], mother:['na\'','naʔ'], father:['yuum','juːm'], eat:['wi\'ij','wiʔiχ'], drink:['uk\'','ukʼ'], love:['yaah','jaːh'], heart:['pixan','piʃan'], tree:['che\'','tʃeʔ'], house:['otoch','otoːtʃ'], dog:['peek\'','peːkʼ'], cat:['miis','miːs'], hand:['k\'ab','kʼab'], eye:['ich','itʃ'], hello:['bix a beel','biʃ a beːl'], thanks:['nib\'oolal','nibʼoːlal'], one:['jun','χun'], good:['utz','uts'] }},
  ...
  ja_edo: { name: 'Japanese (Edo)', native: '江戸言葉', lat: 35.68, lng: 139.69,
    words: { water:['水','midzu'], fire:['火','hi'], sun:['日','hi'], moon:['月','tsuki'], mother:['おっかさん','okkasaN'], father:['おとっつぁん','otottsaɴ'], eat:['食う','kuː'], drink:['飲む','nomu'], love:['恋','kohi'], heart:['心','kokoro'], tree:['木','ki'], house:['家','ie'], dog:['犬','inu'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['ごきげんよう','ɡokiɡeɴjoː'], thanks:['かたじけない','katadʑikenai'], one:['一','hitotsu'], good:['よい','joi'] }},
  ja_heian: { name: 'Japanese (Heian)', native: '平安京言葉', lat: 35.01, lng: 135.77,
    words: { water:['水','midu'], fire:['火','ɸi'], sun:['日','ɸi'], moon:['月','tukï'], mother:['母','ɸaɸa'], father:['父','titï'], eat:['食ふ','kaɸu'], drink:['飲む','nomu'], love:['恋','koɸi'], heart:['心','kokoro'], tree:['木','ki'], house:['家','iɸe'], dog:['犬','inu'], cat:['猫','neko'], hand:['手','te'], eye:['目','me'], hello:['あなかしこ','anakasiko'], thanks:['かたじけなし','katadikenaɕi'], one:['一つ','ɸitotu'], good:['よし','joɕi'] }},
  ...
  vi_nom: { name: 'Vietnamese Chữ Nôm', native: 'Tiếng Việt (Chữ Nôm)', lat: 21.03, lng: 105.85,
    words: { water:['渃','nɨək'], fire:['𤏬','lɨə'], sun:['𣎏𡗶','mət tɤj'], moon:['𣎏𢁑','mət taŋ'], mother:['𡞕','mɛ'], father:['𤙗','ɓo'], eat:['𫗒 ăn','an'], drink:['㗂','uəŋ'], love:['𢞅','iəw'], heart:['𢣐𢞂','tɤj tim'], tree:['𣘃','kəj'], house:['茹','ɲaː'], dog:['𤝞','tɕɔ'], cat:['猫','mɛw'], hand:['𡬶','taj'], eye:['𥄫','mak'], hello:['吀嘲','sin tɕaːw'], thanks:['感恩','kaːm əːn'], one:['𠬠','mot'], good:['卒','tot'] }},
  ...
  ts: { name: 'Tsonga', native: 'Xitsonga', lat: -23.90, lng: 29.45, // Polokwane area
  ...
  // Mayan
  quc: { name: 'K\'iche\'', native: 'K\'iche\'', lat: 14.83, lng: -91.51, // Quetzaltenango
    words: { water:['ja\'','xaʔ'], fire:['q\'aq\'','qʼaqʼ'], sun:['q\'ij','qʼih'], moon:['ik\'','ikʼ'], mother:['nan','nan'], father:['tat','tat'], eat:['tijow','tihow'], drink:['uk\'aaj','ukʼaːh'], love:['loq\'oj','loqʼoh'], heart:['anima\'','animaʔ'], tree:['che\'','tʃeʔ'], house:['ja','xa'], dog:['tz\'i\'','tsʼiʔ'], cat:['me\'s','meʔs'], hand:['q\'ab\'','qʼaɓ'], eye:['b\'aq\'wach','ɓaqʼwatʃ'], hello:['saqarik','saqaɾik'], thanks:['maltyox','maltjoʃ'], one:['jun','xun'], good:['utz','uts'] }},
  yua: { name: 'Yucatec Maya', native: 'Maya t\'aan', lat: 20.97, lng: -89.62, // Mérida
    words: { water:['ja\'','haʔ'], fire:['k\'áak\'','kʼaːkʼ'], sun:['k\'iin','kʼiːn'], moon:['uj','uh'], mother:['na\'','naʔ'], father:['taata','taːta'], eat:['jaant','haːnt'], drink:['uk\'ul','ukʼul'], love:['yaakuntej','jaːkuntex'], heart:['puksi\'ik\'al','puksiʔikʼal'], tree:['che\'','tʃeʔ'], house:['naj','nax'], dog:['peek\'','peːkʼ'], cat:['miis','miːs'], hand:['k\'ab\'','kʼaɓ'], eye:['ich','itʃ'], hello:['ba\'ax ka wa\'alik','baʔaʃ ka waʔalik'], thanks:['dios bo\'otik','dios boʔotik'], one:['jun','hun'], good:['ma\'alob','maʔalob'] }},
  kek: { name: 'Q\'eqchi\'', native: 'Q\'eqchi\'', lat: 15.47, lng: -90.37, // Cobán
    words: { water:['ha\'','haʔ'], fire:['xam\'al','ʃamʼal'], sun:['saqe','saqe'], moon:['po','poʔ'], mother:['na\'','naʔ'], father:['yuwa\'','juwaʔ'], eat:['cua\'','kʼwaʔ'], drink:['uk\'a','ukʼa'], love:['rahok','ɾaːhok'], heart:['ch\'ool','tʃʼoːl'], tree:['che\'','tʃeʔ'], house:['ochoch','otʃotʃ'], dog:['tz\'i\'','tsʼiʔ'], cat:['mes','mes'], hand:['uq\'','uqʼ'], eye:['u','uː'], hello:['ma sa\' laa ch\'ool','ma saʔ laː tʃʼoːl'], thanks:['b\'antiox','ɓantjoʃ'], one:['jun','xun'], good:['chab\'il','tʃaɓil'] }},
  tzo: { name: 'Tzotzil', native: 'Bats\'i k\'op', lat: 16.74, lng: -92.64, // San Cristóbal
    words: { water:['vo\'','voʔ'], fire:['k\'ok\'','kʼokʼ'], sun:['k\'ak\'al','kʼakʼal'], moon:['u','u'], mother:['me\'','meʔ'], father:['tot','tot'], eat:['ve\'el','veʔel'], drink:['uch\'','utʃʼ'], love:['k\'anel','kʼanel'], heart:['o\'on','oʔon'], tree:['te\'','teʔ'], house:['na','na'], dog:['tz\'i\'','tsʼiʔ'], cat:['mis','mis'], hand:['k\'ob','kʼob'], eye:['sat','sat'], hello:['k\'usi avokoluk','kʼusi avokoluk'], thanks:['kolaval','kolaval'], one:['jun','xun'], good:['lek','lek'] }},
  // Oto-Manguean
  ...
  ce: { name: 'Chechen', native: 'Нохчийн мотт', lat: 43.32, lng: 45.69, // Grozny
    words: { water:['хи','xi'], fire:['цlе','tsʼe'], sun:['малх','malx'], moon:['бутт','butː'], mother:['нана','nana'], father:['да','da'], eat:['даа','daː'], drink:['мала','mala'], love:['безам','bezam'], heart:['дог','doɡ'], tree:['дитт','ditː'], house:['цlа','tsʼa'], dog:['жlала','ʒʼala'], cat:['цицик','tsitsiq'], hand:['куьг','kyɡ'], eye:['бlаьрг','bʼæɾɡ'], hello:['маршалла','maɾʃalːa'], thanks:['баркалла','baɾkalːa'], one:['цхьа','tsʔa'], good:['дика','dika'] }},
  inh: { name: 'Ingush', native: 'Гӏалгӏай мотт', lat: 43.16, lng: 44.81, // Magas
    words: { water:['хий','xij'], fire:['цlе','tsʼe'], sun:['малх','malx'], moon:['бутт','butː'], mother:['наьна','nænːa'], father:['да','da'], eat:['даа','daː'], drink:['мала','mala'], love:['безам','bezam'], heart:['дог','doɡ'], tree:['га','ɡa'], house:['цlа','tsʼa'], dog:['жlали','ʒʼali'], cat:['циск','tsisk'], hand:['куьг','kyɡ'], eye:['бlаьрг','bʼæɾɡ'], hello:['моаршал','moaɾʃal'], thanks:['баркал','baɾkal'], one:['цаь','tsæ'], good:['дика','dika'] }},
  av: { name: 'Avar', native: 'Авар мацӀ', lat: 42.98, lng: 47.50, // Makhachkala
    words: { water:['лъим','ɬim'], fire:['цlа','tsʼa'], sun:['бакъ','baq'], moon:['моцl','motsʼ'], mother:['эбел','ebel'], father:['эмен','emen'], eat:['кваназе','kʷanaze'], drink:['гьекlезе','ʕekʼeze'], love:['рокьи','roqʼi'], heart:['ракl','raqʼ'], tree:['гъветl','ʁʷetʼ'], house:['рукъ','ruq'], dog:['гьой','ʕoj'], cat:['кету','ketu'], hand:['квер','kʷer'], eye:['бер','ber'], hello:['ворчlами','voɾtʃʼami'], thanks:['баркала','baɾkala'], one:['цо','tso'], good:['лъикlаб','ɬikʼab'] }},
  lez: { name: 'Lezgian', native: 'Лезги чӏал', lat: 41.79, lng: 48.16, // Derbent area
    words: { water:['яд','jad'], fire:['цlай','tsʼaj'], sun:['рагъ','raʁ'], moon:['варз','varz'], mother:['диде','dide'], father:['буба','buba'], eat:['тlуьн','tʼyn'], drink:['хъун','qun'], love:['кlан хьун','kʼan χun'], heart:['рикl','rikʼ'], tree:['тар','tar'], house:['кlвал','kʼval'], dog:['кицl','kitsʼ'], cat:['кац','kats'], hand:['гъил','ʁil'], eye:['вил','vil'], hello:['салам','salam'], thanks:['чухсагъул','tʃuxsaʁul'], one:['сад','sad'], good:['хъсан','qsan'] }},
  dar: { name: 'Dargwa', native: 'Дарган мез', lat: 42.36, lng: 47.51, // Sergokala
    words: { water:['шин','ʃin'], fire:['цlа','tsʼa'], sun:['берхlи','beɾħi'], moon:['баз','baz'], mother:['нес','nes'], father:['атта','atːa'], eat:['букlан','bukʼan'], drink:['даркьес','daɾqʼes'], love:['дигай','diɡaj'], heart:['уркl','uɾkʼ'], tree:['галга','ɡalɡa'], house:['хъали','qali'], dog:['хя','xja'], cat:['гата','ɡata'], hand:['някl','ɲækʼ'], eye:['хlули','ħuli'], hello:['салам','salam'], thanks:['баркалла','baɾkalːa'], one:['ца','tsa'], good:['гlяхlил','ʕaħil'] }},
  lbe: { name: 'Lak', native: 'Лакку маз', lat: 42.10, lng: 47.13, // Kumukh
    words: { water:['щин','ʃin'], fire:['цlу','tsʼu'], sun:['бургъ','burʁ'], moon:['барз','barz'], mother:['нину','ninu'], father:['ппу','pːu'], eat:['ккаву','kːavu'], drink:['гьавхь','ʕavħ'], love:['ччан','tʃːan'], heart:['дакl','dakʼ'], tree:['мурхь','muɾħ'], house:['къатта','qatːa'], dog:['ккун','kːun'], cat:['ккац','kːats'], hand:['ка','ka'], eye:['я','ja'], hello:['салам','salam'], thanks:['барчаллагь','baɾtʃalːaʁ'], one:['ца','tsa'], good:['хъинсса','qinsːa'] }},
  tab: { name: 'Tabasaran', native: 'Табасаран чӀал', lat: 41.93, lng: 48.04, // Khiv
    words: { water:['штар','ʃtar'], fire:['цlа','tsʼa'], sun:['рагъ','raʁ'], moon:['варз','varz'], mother:['бай','baj'], father:['дад','dad'], eat:['ипlуб','ipʼub'], drink:['ужуб','uʒub'], love:['ккунивал','kːunival'], heart:['юкI','jukʼ'], tree:['гар','ɡar'], house:['хал','xal'], dog:['хю','xy'], cat:['кет','ket'], hand:['хил','xil'], eye:['ул','ul'], hello:['салам','salam'], thanks:['чухсагъул','tʃuxsaʁul'], one:['саб','sab'], good:['ужу','uʒu'] }},
  // Northwest Caucasian
  ady: { name: 'Adyghe', native: 'Адыгабзэ', lat: 44.61, lng: 40.10, // Maykop
    words: { water:['псы','psə'], fire:['машlо','maʃʼo'], sun:['тыгъэ','təʁa'], moon:['мазэ','maza'], mother:['ны','nə'], father:['ты','tə'], eat:['шхэн','ʃxan'], drink:['ефэн','jafan'], love:['шlу шlэгъу','ʃʼʷ ʃʼaʁʷ'], heart:['гу','ɡʷə'], tree:['чыгы','tʃəɡə'], house:['унэ','wəna'], dog:['хьэ','ħa'], cat:['чэтыу','tʃatəw'], hand:['lэ','ʔa'], eye:['нэ','na'], hello:['шlуфес','ʃʼwafes'], thanks:['тхьауегъэпсэу','tħawajaʁapsaw'], one:['зы','zə'], good:['дэгъу','daʁʷ'] }},
  kbd: { name: 'Kabardian', native: 'Адыгэбзэ', lat: 43.49, lng: 43.62, // Nalchik
    words: { water:['псы','psə'], fire:['маф1э','mafʼa'], sun:['дыгъэ','dəʁa'], moon:['мазэ','maza'], mother:['анэ','ana'], father:['адэ','ada'], eat:['шхэн','ʃxan'], drink:['ефэн','jafan'], love:['лъагъуныгъэ','ɬaːʁʷənəʁa'], heart:['гу','ɡʷə'], tree:['жыг','ʒəɡ'], house:['унэ','wəna'], dog:['хьэ','ħa'], cat:['джэду','dʒadu'], hand:['lэ','ʔa'], eye:['нэ','na'], hello:['фlэхъус','fʼaqʷəs'], thanks:['фlыщlэ','fʼɪʃʼa'], one:['зы','zə'], good:['фlы','fʼə'] }},
  ...
  bug: { name: 'Buginese', native: 'Basa Ugi', lat: -5.13, lng: 119.41, // Makassar
  ...
  sid: { name: 'Sidamo', native: 'Sidaamu Afoo', lat: 7.06, lng: 38.48, // Hawassa
    words: { water:['waho','waho'], fire:['gira','ɡira'], sun:['arrishshe','arːiʃːe'], moon:['agana','aɡana'], mother:['ama','ama'], father:['anna','anna'], eat:['ito','ito'], drink:['aga','aɡa'], love:['baxillu','baχillu'], heart:['woddana','woddana'], tree:['haqqicho','haqːitʃo'], house:['mine','mine'], dog:['kuusha','kuːʃa'], cat:['shimbiro','ʃimbiro'], hand:['anga','aŋɡa'], eye:['ille','ille'], hello:['marra','marːa'], thanks:['galatte','ɡalatːe'], one:['mitto','mitːo'], good:['dancha','dantʃa'] }},
  ...
  // Min branch
  mnp: { name: 'Min Bei (Northern Min)', native: '建甌話', lat: 27.04, lng: 118.30, // Jian'ou
    words: { water:['水','sui33'], fire:['火','xui33'], sun:['日頭','ni55tʰau22'], moon:['月光','ŋye44kɔŋ54'], mother:['媽','ma33'], father:['爹','tia54'], eat:['食','sie44'], drink:['啜','tʃʰœ44'], love:['愛','ai21'], heart:['心','siŋ54'], tree:['樹','tʃʰy21'], house:['厝','tsʰu21'], dog:['狗','kɛu33'], cat:['貓','miau54'], hand:['手','siu33'], eye:['目睭','mu44tʃiu54'], hello:['你好','ny33hau33'], thanks:['多謝','to54sia22'], one:['一','i44'], good:['好','hau33'] }},
  cpx: { name: 'Pu-Xian Min', native: '莆仙話', lat: 25.43, lng: 119.01, // Putian
    words: { water:['水','tsuy33'], fire:['火','xue33'], sun:['日頭','lit24tʰau24'], moon:['月','gɔ24'], mother:['母','bo33'], father:['爸','pa55'], eat:['食','liʔ24'], drink:['啜','tʃʰuʔ'], love:['愛','ai55'], heart:['心','siŋ33'], tree:['樹','tʃʰiu55'], house:['厝','tsʰu55'], dog:['狗','kau33'], cat:['貓','niau33'], hand:['手','tʃʰiu33'], eye:['目','baʔ24'], hello:['你好','lɛŋ33ho33'], thanks:['多謝','tosiɛ55'], one:['一','it24'], good:['好','ho33'] }},
  nan_te: { name: 'Teochew', native: '潮州話', lat: 23.35, lng: 116.68, // Shantou
    words: { water:['水','tsui53'], fire:['火','hue53'], sun:['日頭','ʒik5tʰau55'], moon:['月娘','gueʔ5niũ55'], mother:['媽','ma33'], father:['爸','pa55'], eat:['食','tsiaʔ5'], drink:['啉','lim33'], love:['愛','ai213'], heart:['心','sim33'], tree:['樹','tsʰiu11'], house:['厝','tsʰu213'], dog:['狗','kau53'], cat:['貓','niau33'], hand:['手','tsʰiu53'], eye:['目','mak5'], hello:['汝好','lɯ53ho53'], thanks:['感謝','kam53sia11'], one:['一','tsek2'], good:['好','ho53'] }},
  // Yue (Cantonese branch)
  yue_ts: { name: 'Taishanese', native: '台山話', lat: 22.25, lng: 112.79, // Taishan
    words: { water:['水','lui33'], fire:['火','fɔ33'], sun:['日頭','ɲit2hau33'], moon:['月光','ɲut3kwɔŋ22'], mother:['阿媽','a33ma'], father:['阿爸','a33pa'], eat:['食','ɬik3'], drink:['飲','ɲim33'], love:['愛','ɔi33'], heart:['心','ɬim22'], tree:['樹','ɬi32'], house:['屋','uk5'], dog:['狗','kau33'], cat:['貓','miau22'], hand:['手','ɬau33'], eye:['眼','ŋan33'], hello:['你好','nei33hau33'], thanks:['多謝','ɔ22ɬɛ32'], one:['一','it5'], good:['好','hau33'] }},
  // Wu branch (additional varieties)
  wuu_wz: { name: 'Wenzhounese', native: '溫州話', lat: 27.99, lng: 120.70, // Wenzhou
    words: { water:['水','sɿ31'], fire:['火','hu31'], sun:['日頭','ȵa32dei31'], moon:['月光','ɲy213kʰuɔ33'], mother:['阿媽','a33ma33'], father:['阿爸','a33pa33'], eat:['食','dziɛ213'], drink:['飲','iaŋ31'], love:['愛','ai42'], heart:['心','siaŋ33'], tree:['樹','dzu213'], house:['屋','oʔ23'], dog:['狗','kau31'], cat:['貓','mau31'], hand:['手','sɿu31'], eye:['眼睛','ŋa31tsiaŋ33'], hello:['你好','nəi31hau31'], thanks:['多謝','tau33jia213'], one:['一','iaʔ23'], good:['好','hau31'] }},
  wuu_sz: { name: 'Suzhou Wu', native: '蘇州話', lat: 31.30, lng: 120.59, // Suzhou
    words: { water:['水','sɿ52'], fire:['火','hu52'], sun:['太陽','tʰa44ɦiɑ̃23'], moon:['月亮','ɦyəʔ23liɑ̃23'], mother:['姆媽','m44ma'], father:['爹爹','tiɑ44tia'], eat:['吃','tɕʰiʔ55'], drink:['喝','hoʔ55'], love:['愛','e44'], heart:['心','sin55'], tree:['樹','zɿ23'], house:['屋裏','oʔ55li'], dog:['狗','kɤ52'], cat:['貓','mɔ44'], hand:['手','sɤ52'], eye:['眼睛','ŋɛ23tɕin'], hello:['儂好','noŋ44hɔ52'], thanks:['謝謝','ʑia23ʑia'], one:['一','iʔ55'], good:['好','hɔ52'] }},
  // Independent / regional Sinitic
  czh: { name: 'Hui Chinese', native: '徽州話', lat: 29.71, lng: 118.32, // Tunxi (Huangshan)
    words: { water:['水','ɕy44'], fire:['火','xu44'], sun:['日頭','ʐɨ24tʰəu/'], moon:['月亮','yo23lia/'], mother:['媽','ma33'], father:['爸','pa44'], eat:['吃','tʃʰi24'], drink:['喝','xa24'], love:['愛','ai44'], heart:['心','ɕin33'], tree:['樹','ɕy44'], house:['屋','uʔ24'], dog:['狗','kəu44'], cat:['貓','mau33'], hand:['手','səu44'], eye:['眼睛','ŋæ44tɕin/'], hello:['你好','n44hau44'], thanks:['謝謝','ɕie44ɕie'], one:['一','iʔ24'], good:['好','hau44'] }},
  cnp: { name: 'Pinghua', native: '平話', lat: 22.82, lng: 108.32, // Nanning
    words: { water:['水','ɬui42'], fire:['火','fu42'], sun:['日頭','ŋit2tʰɐu44'], moon:['月光','ŋyt3kwɔŋ44'], mother:['阿媽','a44ma44'], father:['阿爸','a44pa44'], eat:['食','sɐk2'], drink:['飲','ɐm42'], love:['愛','ɔi44'], heart:['心','sɐm44'], tree:['樹','sy44'], house:['屋','ɔk2'], dog:['狗','kɐu42'], cat:['貓','mau44'], hand:['手','sɐu42'], eye:['眼','ŋɐn42'], hello:['你好','nei42hou42'], thanks:['多謝','tɔ44tsɛ44'], one:['一','jɐt2'], good:['好','hou42'] }},
  // Mandarin sub-varieties
  zh_jh: { name: 'Jianghuai Mandarin', native: '江淮官話', lat: 32.06, lng: 118.80, // Nanjing
    words: { water:['水','suei214'], fire:['火','xuo214'], sun:['太陽','tʰɛ44jaŋ24'], moon:['月亮','yʔ liaŋ'], mother:['媽','ma33'], father:['爸','pa55'], eat:['吃','tʂʰʔ55'], drink:['喝','xəʔ55'], love:['愛','ɛ44'], heart:['心','ɕin33'], tree:['樹','sɿ44'], house:['房子','faŋ24tsɿ'], dog:['狗','kəu214'], cat:['貓','mɔ33'], hand:['手','səu214'], eye:['眼','jɛn214'], hello:['你好','ni214xau214'], thanks:['謝謝','ɕje44ɕje'], one:['一','iʔ55'], good:['好','hau214'] }},
  zh_tj: { name: 'Tianjin Mandarin', native: '天津話', lat: 39.13, lng: 117.20, // Tianjin
    words: { water:['水','ʂwei213'], fire:['火','xwo213'], sun:['太陽','tʰai51jaŋ24'], moon:['月亮','ɥɛ51ljaŋ'], mother:['媽','ma11'], father:['爸','pa51'], eat:['吃','tʂʰɨ11'], drink:['喝','xɤ11'], love:['愛','ai51'], heart:['心','ɕin11'], tree:['樹','ʂu51'], house:['房子','faŋ24tsɨ'], dog:['狗','koʊ213'], cat:['貓','mau11'], hand:['手','ʂoʊ213'], eye:['眼睛','jɛn213tɕiŋ'], hello:['你好','ni213xau213'], thanks:['謝謝','ɕjɛ51ɕjɛ'], one:['一','i11'], good:['好','xau213'] }},
  zh_lz: { name: 'Lanyin Mandarin', native: '蘭銀官話', lat: 36.06, lng: 103.83, // Lanzhou
    words: { water:['水','sui53'], fire:['火','xo53'], sun:['太陽','tʰɛ24jaŋ24'], moon:['月亮','yɛ44ljaŋ'], mother:['媽','ma33'], father:['爸','pa53'], eat:['吃','tʂʰɨ33'], drink:['喝','xɛ33'], love:['愛','ɛ24'], heart:['心','ɕin31'], tree:['樹','sɨ24'], house:['房子','faŋ24tsɨ'], dog:['狗','kəu53'], cat:['貓','mau33'], hand:['手','sou53'], eye:['眼睛','jɛn53tɕin'], hello:['你好','ni53xau53'], thanks:['謝謝','ɕjɛ24ɕjɛ'], one:['一','ji33'], good:['好','xau53'] }},
  ...
  chy: { name: 'Cheyenne', native: 'Tsêhésenêstsestôtse', lat: 45.62, lng: -106.66, // Lame Deer
    words: { water:['mahpe','mahpe'], fire:['ho\'ėstá','hoʔɛsta'], sun:['éše\'he','eˀʃeˀhe'], moon:['ame\'háo\'o','ameˀhaˀoʔo'], mother:['néhe\'e','néheʔe'], father:['néhyo','néhjo'], eat:['mésehe','méʔsehe'], drink:['mane','mane'], love:['méhotó\'o','meˀhotoʔo'], heart:['ohtsé','ohtse'], tree:['hohtsestse','hohtsestse'], house:['vee\'e','veːʔe'], dog:['oeškeso','oːʃkeso'], cat:['pó\'po','poʔpo'], hand:['ma\'kahko','maʔkahko'], eye:['vóome','voːme'], hello:['néá\'eše','néáʔeʃe'], thanks:['néá\'eše','néáʔeʃe'], one:['no\'ka','noʔka'], good:['pevohto','pevohto'] }},
  ...
  hbo: { name: 'Biblical Hebrew', native: 'עברית מקראית', lat: 31.78, lng: 35.21, // Jerusalem
    words: { water:['מים','majim'], fire:['אש','ʔeʃ'], sun:['שמש','ʃemeʃ'], moon:['ירח','jaːreːaħ'], mother:['אם','ʔeːm'], father:['אב','ʔaːv'], eat:['אכל','ʔaːkal'], drink:['שתה','ʃaːtaː'], love:['אהב','ʔaːhav'], heart:['לב','leːv'], tree:['עץ','ʕeːts'], house:['בית','bajit'], dog:['כלב','kelev'], cat:['*שונרא','ʃunraː'], hand:['יד','jaːd'], eye:['עין','ʕajin'], hello:['שלום','ʃaːloːm'], thanks:['תודה','toːðaː'], one:['אחד','ʔeħaːd'], good:['טוב','tˤoːv'] }},
  ...
  wbl: { name: 'Wakhi', native: 'x̌ikwor zik', lat: 36.95, lng: 73.52, // Wakhan
    words: { water:['яу','jau'], fire:['ракс','raks'], sun:['йир','jir'], moon:['зимак','zimak'], mother:['нан','nan'], father:['тат','tat'], eat:['йав-','jav'], drink:['пав-','pav'], love:['руб','rub'], heart:['дил','dil'], tree:['ведж','vedʒ'], house:['хун','xun'], dog:['шач','ʃatʃ'], cat:['mušuk','muʃuk'], hand:['дос','dos'], eye:['чашм','tʃaʃm'], hello:['салам','salam'], thanks:['ишкур','iʃkur'], one:['yiu','jiu'], good:['байт','bajt'] }},
  ...
  bej: { name: 'Beja', native: 'Bidhaawyeet', lat: 19.62, lng: 37.22, // Port Sudan
    words: { water:['yam','jam'], fire:['neʼaat','neʔaːt'], sun:['yint','jint'], moon:['tirig','tiɾiɡ'], mother:['indee','iːndeː'], father:['baab','baːb'], eat:['tame','tame'], drink:['gwaʼa','ɡʷaʕa'], love:['kima','kima'], heart:['ginʼa','ɡinʕa'], tree:['hindeb','hindeb'], house:['gaw','ɡaw'], dog:['yas','jas'], cat:['kabsoot','kabsoːt'], hand:['ay','aj'], eye:['liili','liːli'], hello:['malaika','malaika'], thanks:['baraʼoo','baɾaʕoː'], one:['gaal','ɡaːl'], good:['dabaab','dabaːb'] }},
...
const WM_UI = {
  ja: { native:'現地名', english:'English', size:'サイズ', word:'原文', ipa:'発音', name:'言語名', back:'← LangMap', family:'語族', speakers:'話者数', countries:'使用国', official:'公用語', script:'文字', url:'langmap.heuron.com/wordmap.html', modern:'現代言語', historical:'歴史言語' },
  ko: { native:'현지어', english:'English', size:'크기', word:'원문', ipa:'발음', name:'언어명', back:'← LangMap', family:'어족', speakers:'화자 수', countries:'사용 국가', official:'공용어', script:'문자', url:'langmap.heuron.com/wordmap.html', modern:'현대 언어', historical:'역사 언어' },
  zh: { native:'当地语', english:'English', size:'大小', word:'原文', ipa:'发音', name:'语言名', back:'← LangMap', family:'语族', speakers:'使用人数', countries:'使用国家', official:'官方语言', script:'文字', url:'langmap.heuron.com/wordmap.html', modern:'现代语言', historical:'历史语言' },
  yue: { native:'當地語', english:'English', size:'大細', word:'原文', ipa:'發音', name:'語言名', back:'← LangMap', family:'語族', speakers:'使用人數', countries:'使用國家', official:'官方語言', script:'文字', url:'langmap.heuron.com/wordmap.html', modern:'現代語言', historical:'歷史語言' },
  vi: { native:'Bản địa', english:'English', size:'Cỡ', word:'Từ', ipa:'Phiên âm', name:'Tên ngôn ngữ', back:'← LangMap', family:'Ngữ hệ', speakers:'Số người nói', countries:'Quốc gia', official:'Ngôn ngữ chính thức', script:'Chữ viết', url:'langmap.heuron.com/wordmap.html', modern:'Hiện đại', historical:'Ngôn ngữ lịch sử' },
  th: { native:'ท้องถิ่น', english:'English', size:'ขนาด', word:'คำ', ipa:'สัทอักษร', name:'ชื่อภาษา', back:'← LangMap', family:'ตระกูลภาษา', speakers:'ผู้พูด', countries:'ประเทศ', official:'ภาษาราชการ', script:'อักษร', url:'langmap.heuron.com/wordmap.html', modern:'สมัยใหม่', historical:'ภาษาประวัติศาสตร์' },
  id: { native:'Lokal', english:'English', size:'Ukuran', word:'Kata', ipa:'IPA', name:'Nama bahasa', back:'← LangMap', family:'Rumpun bahasa', speakers:'Penutur', countries:'Negara', official:'Bahasa resmi', script:'Aksara', url:'langmap.heuron.com/wordmap.html', modern:'Modern', historical:'Bahasa historis' },
  hi: { native:'स्थानीय', english:'English', size:'आकार', word:'शब्द', ipa:'उच्चारण', name:'भाषा नाम', back:'← LangMap', family:'भाषा परिवार', speakers:'वक्ता', countries:'देश', official:'राजभाषा', script:'लिपि', url:'langmap.heuron.com/wordmap.html', modern:'आधुनिक', historical:'ऐतिहासिक भाषा' },
  en: { native:'Native', english:'English', size:'Size', word:'Word', ipa:'IPA', name:'Name', back:'← LangMap', family:'Language family', speakers:'Speakers', countries:'Countries', official:'Official in', script:'Script', url:'langmap.heuron.com/wordmap.html', modern:'Modern', historical:'Historical' },
  de: { native:'Einheimisch', english:'English', size:'Größe', word:'Wort', ipa:'IPA', name:'Sprache', back:'← LangMap', family:'Sprachfamilie', speakers:'Sprecher', countries:'Länder', official:'Amtssprache', script:'Schrift', url:'langmap.heuron.com/wordmap.html', modern:'Modern', historical:'Historisch' },
  fr: { native:'Locale', english:'English', size:'Taille', word:'Mot', ipa:'API', name:'Nom', back:'← LangMap', family:'Famille', speakers:'Locuteurs', countries:'Pays', official:'Langue officielle', script:'Écriture', url:'langmap.heuron.com/wordmap.html', modern:'Moderne', historical:'Historique' },
  it: { native:'Locale', english:'English', size:'Dimensione', word:'Parola', ipa:'IPA', name:'Nome', back:'← LangMap', family:'Famiglia linguistica', speakers:'Parlanti', countries:'Paesi', official:'Lingua ufficiale', script:'Scrittura', url:'langmap.heuron.com/wordmap.html', modern:'Moderno', historical:'Storico' },
  es_eu: { native:'Local', english:'English', size:'Tamaño', word:'Palabra', ipa:'AFI', name:'Nombre', back:'← LangMap', family:'Familia lingüística', speakers:'Hablantes', countries:'Países', official:'Idioma oficial', script:'Escritura', url:'langmap.heuron.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  es_mx: { native:'Local', english:'English', size:'Tamaño', word:'Palabra', ipa:'AFI', name:'Nombre', back:'← LangMap', family:'Familia lingüística', speakers:'Hablantes', countries:'Países', official:'Idioma oficial', script:'Escritura', url:'langmap.heuron.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  pt_eu: { native:'Local', english:'English', size:'Tamanho', word:'Palavra', ipa:'AFI', name:'Nome', back:'← LangMap', family:'Família linguística', speakers:'Falantes', countries:'Países', official:'Língua oficial', script:'Escrita', url:'langmap.heuron.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  pt_br: { native:'Local', english:'English', size:'Tamanho', word:'Palavra', ipa:'AFI', name:'Nome', back:'← LangMap', family:'Família linguística', speakers:'Falantes', countries:'Países', official:'Língua oficial', script:'Escrita', url:'langmap.heuron.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  ru: { native:'Местный', english:'English', size:'Размер', word:'Слово', ipa:'МФА', name:'Название', back:'← LangMap', family:'Языковая семья', speakers:'Носители', countries:'Страны', official:'Официальный', script:'Письменность', url:'langmap.heuron.com/wordmap.html', modern:'Современные', historical:'Исторические' },
  uk: { native:'Місцева', english:'English', size:'Розмір', word:'Слово', ipa:'МФА', name:'Назва', back:'← LangMap', family:'Мовна сім\'я', speakers:'Носії', countries:'Країни', official:'Офіційна', script:'Писемність', url:'langmap.heuron.com/wordmap.html', modern:'Сучасні', historical:'Історичні' },
  ar: { native:'محلي', english:'English', size:'الحجم', word:'كلمة', ipa:'صوتي', name:'الاسم', back:'← LangMap', family:'عائلة اللغة', speakers:'المتحدثون', countries:'البلدان', official:'رسمية في', script:'الخط', url:'langmap.heuron.com/wordmap.html', modern:'حديثة', historical:'تاريخية' },
  he: { native:'מקומי', english:'English', size:'גודל', word:'מילה', ipa:'תעתיק', name:'שם', back:'← LangMap', family:'משפחת שפות', speakers:'דוברים', countries:'מדינות', official:'רשמית ב', script:'כתב', url:'langmap.heuron.com/wordmap.html', modern:'מודרניות', historical:'היסטוריות' },
  sw: { native:'Asili', english:'English', size:'Ukubwa', word:'Neno', ipa:'IPA', name:'Jina', back:'← LangMap', family:'Familia ya lugha', speakers:'Wasemaji', countries:'Nchi', official:'Rasmi katika', script:'Hati', url:'langmap.heuron.com/wordmap.html', modern:'Kisasa', historical:'Lugha za kihistoria' },
};
