...
const LANG_DATA = {
  ...
  ude: { name: 'Udege', native: 'удиэ кэйэвэни', lat: 45.95, lng: 137.04, // Krasnyy Yar (Bikin valley, Primorye — main Udege village)
    words: { water:['уй','uj'], fire:['тогбо','toɡbo'], sun:['даигаси','daiɡasi'], moon:['биа','bia'], mother:['энэ','ene'], father:['амэ','amə'], eat:['джевэ','d͡ʒevə'], drink:['омимэ','omimə'], love:['чисанай','t͡ʃisanaj'], heart:['миаван','miavan'], tree:['мо','mo'], house:['дзугди','d͡zuɡdi'], cat:['кошк','koʃk'], dog:['инай','inaj'], hand:['нала','nala'], eye:['писа','pisa'], hello:['бандиба','bandiba'], thanks:['нюхча','ɲuxt͡ʃa'], one:['омо','omo'], good:['ая','aja'] }},
  ...
  sel: { name: 'Selkup', native: 'Шöльӄумыт әты', lat: 65.40, lng: 80.50, // Krasnoselkup (Yamalo-Nenets, Taz River — northern Selkup)
    words: { water:['ӱт','yt'], fire:['тӱ','ty'], sun:['нэлмо','nelmo'], moon:['ариаа','ariaː'], mother:['эма','ema'], father:['ача','at͡ʃa'], eat:['амгу','amɡu'], drink:['ӱдыргу','ydɨrɡu'], love:['нанымба','nanɨmba'], heart:['сидя','sidʲa'], tree:['по','po'], house:['мат','mat'], dog:['канак','kanak'], cat:['кетча','ket͡ʃa'], hand:['ӱдо','ydo'], eye:['сай','saj'], hello:['тӱла','tyla'], thanks:['пасьпе','pasʲpe'], one:['уккур','ukːur'], good:['нот','not'] }},
  ...
  yux: { name: 'Kolyma Yukaghir', native: 'Odul aruu', lat: 65.74, lng: 152.33, // Nelemnoye, Verkhnekolymsky District, Sakha
    words: { water:['ɔӡ','od͡ʒ'], fire:['ло́чил','lóʧil'], sun:['пугэ','puɣe'], moon:['киӈэ','kiŋe'], mother:['эмэй','emej'], father:['эчиэ','et͡ʃiə'], eat:['чидиргэ-','t͡ʃidirɣe'], drink:['ӧгэйи-','øɡejii'], love:['чомолбэн','t͡ʃomolben'], heart:['чугэ','t͡ʃuɣe'], tree:['чалдьэ','t͡ʃald͡ʒe'], house:['нумэ','nume'], dog:['таҥжэ','taŋʒe'], cat:['кошка','koʂka'], hand:['нэмэ','neme'], eye:['ӈөбур','ŋøbur'], hello:['льуоркэн','lʲuorken'], thanks:['пасьпе','pasʲpe'], one:['иркэ','irke'], good:['амлур','amlur'] }},
  // Language isolate
  ...
  aiw: { name: 'Aari', native: 'Aramado', lat: 6.05, lng: 36.77, // Bako, Aari woreda, South Omo, Ethiopia
    words: { water:['waki','waki'], fire:['mola','mola'], sun:['saba','saba'], moon:['ama','ama'], mother:['inde','inde'], father:['baba','baba'], eat:['itte','itːe'], drink:['ushe','uʃe'], love:['gaya','ɡaja'], heart:['lubba','lubːa'], tree:['miza','miza'], house:['kara','kara'], dog:['kana','kana'], cat:['shanɡo','ʃaŋɡo'], hand:['kushum','kuʃum'], eye:['aafo','aːfo'], hello:['saro','saro'], thanks:['galatoma','ɡalatoma'], one:['kollo','kolːo'], good:['ɡoodi','ɡoːdi'] }},
  ...
  pnb: { name: 'Western Punjabi', native: 'پنجابی', lat: 31.55, lng: 74.34, // Lahore, Punjab, Pakistan
    words: { water:['پانی','pɑːɳiː'], fire:['اگ','əɡː'], sun:['سورج','suːɾədʒ'], moon:['چن','tʃən'], mother:['ماں','mɑ̃ː'], father:['ابا','əbbɑː'], eat:['کھانا','kʰɑːɳɑː'], drink:['پینا','piːɳɑː'], love:['عشق','ɪʃq'], heart:['دل','dɪl'], tree:['درخت','dəɾəxt'], house:['گھر','kʰəɾ'], dog:['کتا','kʊtːɑː'], cat:['بلی','bɪlːiː'], hand:['ہتھ','hətʰː'], eye:['اکھ','əkʰː'], hello:['اسلام علیکم','əsːəlɑːmu ʕəleːkʊm'], thanks:['شکریہ','ʃʊkɾɪjɑː'], one:['اک','ɪkː'], good:['چنگا','tʃəŋɡɑː'] }},
  ...
  sjo: { name: 'Xibe', native: 'ᠰᡞᠪᡝ ᡤᡞᠰᡠᠨ', lat: 43.93, lng: 81.32, // Qapqal Xibe AP, Yili, Xinjiang
    words: { water:['ᠮᡠᡴᡝ','muku'], fire:['ᡨᡠᠸᠠ','tuwa'], sun:['ᠰᡠᠨ','sun'], moon:['ᠪᡳᠶᠠ','bija'], mother:['ᡝᠨᡞᠶᡝ','ənije'], father:['ᠠᠮᠠ','ama'], eat:['ᠵᡝᠮᠪᡞ','d͡ʒəmbi'], drink:['ᠣᠮᡳᠪᡞ','omibi'], love:['ᠴᡳᠯᡨᡠᠮᠪᡳ','t͡ʃiltumbi'], heart:['ᠨᡳᠶᠠᠮᠠᠨ','nijaman'], tree:['ᠮᠣᠯᠣ','molo'], house:['ᠪᠣᠣ','boː'], dog:['ᠨᡳᠨᠳᠠᡥᡡᠨ','nindaxun'], cat:['ᡴᡝᠰᡳᡴᡝ','kəsikə'], hand:['ᡤᠠᠯᠠ','ɡala'], eye:['ᠶᠠᠰᠠ','jasa'], hello:['ᠨᡳᠩᡤᡝ ᠰᠠᡳᠨ','niŋɡe sain'], thanks:['ᠪᠠᠨᡳᡥᠠ','banixa'], one:['ᡝᠮᡠ','əmu'], good:['ᠰᠠᡳᠨ','sain'] }},
  ...
  ho: { name: 'Hiri Motu', native: 'Hiri Motu', lat: -8.78, lng: 148.45, // Popondetta, Oro Province (representative point distinct from hmo Port Moresby marker)
    words: { water:['ranu','ranu'], fire:['lahi','lahi'], sun:['dina','dina'], moon:['hua','hua'], mother:['sina','sina'], father:['tama','tama'], eat:['ania','ania'], drink:['inua','inua'], love:['lalokau','lalokaʊ'], heart:['kudouna','kudoʊna'], tree:['au','aʊ'], house:['ruma','ruma'], dog:['sisia','sisia'], cat:['pusi','pusi'], hand:['imana','imana'], eye:['matana','matana'], hello:['kekehe','kekehe'], thanks:['tanikiu','tanikiʊ'], one:['ta','ta'], good:['namo','namo'] }},
  ...
  ddn: { name: 'Donno So', native: 'Dogosò', lat: 14.35, lng: -3.61, // Bandiagara, Mali (Dogon cultural heart along the escarpment)
    words: { water:['di','di'], fire:['yɔ','jɔ'], sun:['naa','naː'], moon:['ele','ele'], mother:['na','na'], father:['ba','ba'], eat:['kɔɔ','kɔː'], drink:['nɔ','nɔ'], love:['suuli','suːli'], heart:['kɛɛla','kɛːla'], tree:['ti','ti'], house:['gina','ɡina'], dog:['gɛɛ','ɡɛː'], cat:['monyi','moɲi'], hand:['nu','nu'], eye:['gi','ɡi'], hello:['agandɛla','aɡandɛla'], thanks:['biguƞ','biɡũ'], one:['tum','tum'], good:['suuli','suːli'] }},
  ...
  csb: { name: 'Kashubian', native: 'Kaszëbsczi', lat: 54.35, lng: 18.65, // Gdańsk area
    words: { water:['woda','ˈvɔda'], fire:['ogniô','ˈɔɡɲɔ'], sun:['słuńce','ˈswuɲt͡sɛ'], moon:['ksãżëc','ˈksɔ̃ʐɨt͡s'], mother:['mëma','ˈmɨma'], father:['tatk','tatk'], eat:['jesc','jɛst͡s'], drink:['pic','pit͡s'], love:['lubota','luˈbɔta'], heart:['serce','ˈsɛrt͡sɛ'], tree:['drzewo','ˈd͡ʐɛvɔ'], house:['chëcz','xɨt͡ʃ'], dog:['pies','pjɛs'], cat:['kòt','kʷɔt'], hand:['rãka','ˈrɔ̃ka'], eye:['òkò','ʷɔkʷɔ'], hello:['witôj','ˈvitwɔj'], thanks:['dzãki','ˈd͡zɔ̃ki'], one:['jeden','ˈjɛdɛn'], good:['dobri','ˈdɔbri'] }},
  ...
  jia: { name: 'Jiamao', native: 'Jiamao', lat: 18.62, lng: 109.70, // Baoting, Hainan, China
    words: { water:['noːm','noːm'], fire:['hoːi','hoːi'], sun:['mau','mau'], moon:['naː','naː'], mother:['miə','miə'], father:['paː','paː'], eat:['kɛːn','kɛːn'], drink:['ɲom','ɲom'], love:['kʰaː','kʰaː'], heart:['kə','kə'], tree:['mai','mai'], house:['vɛn','vɛn'], dog:['mɛ','mɛ'], cat:['miau','miau'], hand:['baː','baː'], eye:['ta','ta'], hello:['niː','niː'], thanks:['χaːi','χaːi'], one:['tsuː','tsuː'], good:['pʰaː','pʰaː'] }},
  ...
  mui: { name: 'Musi', native: 'Baso Pelembang', lat: -2.99, lng: 104.76, // Palembang, South Sumatra (historical Srivijaya capital)
    words: { water:['ayek','ajek'], fire:['api','api'], sun:['matahari','matahari'], moon:['bulan','bulan'], mother:['mak','mak'], father:['bapak','bapak'], eat:['makan','makan'], drink:['minum','minum'], love:['sayang','sajaŋ'], heart:['hati','hati'], tree:['kayu','kaju'], house:['rumah','rumah'], dog:['anjing','andʒiŋ'], cat:['kucing','kutʃiŋ'], hand:['tangan','taŋan'], eye:['mato','mato'], hello:['halo','halo'], thanks:['terimo kasih','terimo kasih'], one:['siko','siko'], good:['bagus','baɡus'] }},
  ...
  bdq: { name: 'Bahnar', native: "Bahnar", lat: 13.98, lng: 108.00, // Pleiku, Gia Lai, Vietnam (Bahnar heartland)
    words: { water:['dak','dak'], fire:['unh','uɲ'], sun:['mat trơ','mat trə'], moon:['khe','kʰe'], mother:['mei','mei'], father:['bă','bə'], eat:['sa','sa'], drink:['ngoah','ŋoah'], love:['rơngư','rəŋɨ'], heart:['blei','blei'], tree:['lông','loŋ'], house:['hnam','hnam'], dog:['cho','tʃo'], cat:['miao','miao'], hand:['ti','ti'], eye:['mat','mat'], hello:['ô','o'], thanks:['kơbi','kəbi'], one:['minh','miɲ'], good:['ling','liŋ'] }},
