...
const WORD_LIST = [
  ...
  { id: 'sun', en: 'Sun', ja: '日', ko: '해', zh: '太阳', yue: '日頭', vi: 'Mặt trời', th: 'ดวงอาทิตย์', ind: 'Matahari', hi: 'सूरज', de: 'Sonne', fr: 'Soleil', it: 'Sole', es: 'Sol', pt: 'Sol', ru: 'Солнце', uk: 'Сонце', ar: 'شمس', he: 'שמש', sw: 'Jua' },
...
const LANG_DATA = {
  ...
  mnp: { name: 'Min Bei (Northern Min)', native: '建瓯话', lat: 27.04, lng: 118.30, // Jian'ou
    words: { water:['水','sui33'], fire:['火','xui33'], sun:['日头','ni55tʰau22'], moon:['月光','ŋye44kɔŋ54'], mother:['妈','ma33'], father:['爹','tia54'], eat:['食','sie44'], drink:['啜','tʃʰœ44'], love:['爱','ai21'], heart:['心','siŋ54'], tree:['树','tʃʰy21'], house:['厝','tsʰu21'], dog:['狗','kɛu33'], cat:['猫','miau54'], hand:['手','siu33'], eye:['目睭','mu44tʃiu54'], hello:['你好','ny33hau33'], thanks:['多谢','to54sia22'], one:['一','i44'], good:['好','hau33'] }},
  cpx: { name: 'Pu-Xian Min', native: '莆仙话', lat: 25.43, lng: 119.01, // Putian
    words: { water:['水','tsuy33'], fire:['火','xue33'], sun:['日头','lit24tʰau24'], moon:['月','gɔ24'], mother:['母','bo33'], father:['爸','pa55'], eat:['食','liʔ24'], drink:['啜','tʃʰuʔ'], love:['爱','ai55'], heart:['心','siŋ33'], tree:['树','tʃʰiu55'], house:['厝','tsʰu55'], dog:['狗','kau33'], cat:['猫','niau33'], hand:['手','tʃʰiu33'], eye:['目','baʔ24'], hello:['你好','lɛŋ33ho33'], thanks:['多谢','tosiɛ55'], one:['一','it24'], good:['好','ho33'] }},
  nan_te: { name: 'Teochew', native: '潮州话', lat: 23.35, lng: 116.68, // Shantou
    words: { water:['水','tsui53'], fire:['火','hue53'], sun:['日头','ʒik5tʰau55'], moon:['月娘','gueʔ5niũ55'], mother:['妈','ma33'], father:['爸','pa55'], eat:['食','tsiaʔ5'], drink:['啉','lim33'], love:['爱','ai213'], heart:['心','sim33'], tree:['树','tsʰiu11'], house:['厝','tsʰu213'], dog:['狗','kau53'], cat:['猫','niau33'], hand:['手','tsʰiu53'], eye:['目','mak5'], hello:['汝好','lɯ53ho53'], thanks:['感谢','kam53sia11'], one:['一','tsek2'], good:['好','ho53'] }},
  // Yue (Cantonese branch)
  yue_ts: { name: 'Taishanese', native: '台山话', lat: 22.25, lng: 112.79, // Taishan
    words: { water:['水','lui33'], fire:['火','fɔ33'], sun:['日头','ɲit2hau33'], moon:['月光','ɲut3kwɔŋ22'], mother:['阿妈','a33ma'], father:['阿爸','a33pa'], eat:['食','ɬik3'], drink:['饮','ɲim33'], love:['爱','ɔi33'], heart:['心','ɬim22'], tree:['树','ɬi32'], house:['屋','uk5'], dog:['狗','kau33'], cat:['猫','miau22'], hand:['手','ɬau33'], eye:['眼','ŋan33'], hello:['你好','nei33hau33'], thanks:['多谢','ɔ22ɬɛ32'], one:['一','it5'], good:['好','hau33'] }},
  // Wu branch (additional varieties)
  wuu_wz: { name: 'Wenzhounese', native: '温州话', lat: 27.99, lng: 120.70, // Wenzhou
    words: { water:['水','sɿ31'], fire:['火','hu31'], sun:['日头','ȵa32dei31'], moon:['月光','ɲy213kʰuɔ33'], mother:['阿妈','a33ma33'], father:['阿爸','a33pa33'], eat:['食','dziɛ213'], drink:['饮','iaŋ31'], love:['爱','ai42'], heart:['心','siaŋ33'], tree:['树','dzu213'], house:['屋','oʔ23'], dog:['狗','kau31'], cat:['猫','mau31'], hand:['手','sɿu31'], eye:['眼睛','ŋa31tsiaŋ33'], hello:['你好','nəi31hau31'], thanks:['多谢','tau33jia213'], one:['一','iaʔ23'], good:['好','hau31'] }},
  wuu_sz: { name: 'Suzhou Wu', native: '苏州话', lat: 31.30, lng: 120.59, // Suzhou
    words: { water:['水','sɿ52'], fire:['火','hu52'], sun:['日头','ɲiɪʔ23dɤ23'], moon:['月亮','ɦyəʔ23liɑ̃23'], mother:['姆妈','m44ma'], father:['爹爹','tiɑ44tia'], eat:['吃','tɕʰiʔ55'], drink:['喝','hoʔ55'], love:['爱','e44'], heart:['心','sin55'], tree:['树','zɿ23'], house:['屋里','oʔ55li'], dog:['狗','kɤ52'], cat:['猫','mɔ44'], hand:['手','sɤ52'], eye:['眼睛','ŋɛ23tɕin'], hello:['侬好','noŋ44hɔ52'], thanks:['谢谢','ʑia23ʑia'], one:['一','iʔ55'], good:['好','hɔ52'] }},
  // Independent / regional Sinitic
  czh: { name: 'Hui Chinese', native: '徽州话', lat: 29.71, lng: 118.32, // Tunxi (Huangshan)
    words: { water:['水','ɕy44'], fire:['火','xu44'], sun:['日头','ʐɨ24tʰəu/'], moon:['月光','yo23kuaŋ24'], mother:['妈','ma33'], father:['爸','pa44'], eat:['吃','tʃʰi24'], drink:['喝','xa24'], love:['爱','ai44'], heart:['心','ɕin33'], tree:['树','ɕy44'], house:['屋','uʔ24'], dog:['狗','kəu44'], cat:['猫','mau33'], hand:['手','səu44'], eye:['眼睛','ŋæ44tɕin/'], hello:['你好','n44hau44'], thanks:['谢谢','ɕie44ɕie'], one:['一','iʔ24'], good:['好','hau44'] }},
  cnp: { name: 'Pinghua', native: '平话', lat: 22.82, lng: 108.32, // Nanning
    words: { water:['水','ɬui42'], fire:['火','fu42'], sun:['日头','ŋit2tʰɐu44'], moon:['月光','ŋyt3kwɔŋ44'], mother:['阿妈','a44ma44'], father:['阿爸','a44pa44'], eat:['食','sɐk2'], drink:['饮','ɐm42'], love:['爱','ɔi44'], heart:['心','sɐm44'], tree:['树','sy44'], house:['屋','ɔk2'], dog:['狗','kɐu42'], cat:['猫','mau44'], hand:['手','sɐu42'], eye:['眼','ŋɐn42'], hello:['你好','nei42hou42'], thanks:['多谢','tɔ44tsɛ44'], one:['一','jɐt2'], good:['好','hou42'] }},
  // Mandarin sub-varieties
  zh_jh: { name: 'Jianghuai Mandarin', native: '江淮官话', lat: 32.06, lng: 118.80, // Nanjing
    words: { water:['水','suei214'], fire:['火','xuo214'], sun:['日头','ʐəʔ4tʰəu24'], moon:['月亮','yʔ liaŋ'], mother:['妈','ma33'], father:['爸','pa55'], eat:['吃','tʂʰʔ55'], drink:['喝','xəʔ55'], love:['爱','ɛ44'], heart:['心','ɕin33'], tree:['树','sɿ44'], house:['房子','faŋ24tsɿ'], dog:['狗','kəu214'], cat:['猫','mɔ33'], hand:['手','səu214'], eye:['眼','jɛn214'], hello:['你好','ni214xau214'], thanks:['谢谢','ɕje44ɕje'], one:['一','iʔ55'], good:['好','hau214'] }},
  zh_tj: { name: 'Tianjin Mandarin', native: '天津话', lat: 39.13, lng: 117.20, // Tianjin
    words: { water:['水','ʂwei213'], fire:['火','xwo213'], sun:['日头','ʐʅ51tʰoʊ24'], moon:['月亮','ɥɛ51ljaŋ'], mother:['妈','ma11'], father:['爸','pa51'], eat:['吃','tʂʰɨ11'], drink:['喝','xɤ11'], love:['爱','ai51'], heart:['心','ɕin11'], tree:['树','ʂu51'], house:['房子','faŋ24tsɨ'], dog:['狗','koʊ213'], cat:['猫','mau11'], hand:['手','ʂoʊ213'], eye:['眼睛','jɛn213tɕiŋ'], hello:['你好','ni213xau213'], thanks:['谢谢','ɕjɛ51ɕjɛ'], one:['一','i11'], good:['好','xau213'] }},
  zh_lz: { name: 'Lanyin Mandarin', native: '兰银官话', lat: 36.06, lng: 103.83, // Lanzhou
    words: { water:['水','sui53'], fire:['火','xo53'], sun:['日头','ʐɨ24tʰəu24'], moon:['月亮','yɛ44ljaŋ'], mother:['妈','ma33'], father:['爸','pa53'], eat:['吃','tʂʰɨ33'], drink:['喝','xɛ33'], love:['爱','ɛ24'], heart:['心','ɕin31'], tree:['树','sɨ24'], house:['房子','faŋ24tsɨ'], dog:['狗','kəu53'], cat:['猫','mau33'], hand:['手','sou53'], eye:['眼睛','jɛn53tɕin'], hello:['你好','ni53xau53'], thanks:['谢谢','ɕjɛ24ɕjɛ'], one:['一','ji33'], good:['好','xau53'] }},
  ...
  wuu_nb: { name: 'Ningbo Wu', native: '宁波话', lat: 29.87, lng: 121.55, // Ningbo
    words: { water:['水','sɿ214'], fire:['火','hu214'], sun:['日头','ɲiʔ12dɤu'], moon:['月亮','ɲyəʔ12liaŋ'], mother:['阿妈','aʔ44ma'], father:['阿爸','aʔ44pa'], eat:['吃','tɕʰiʔ12'], drink:['喝','hoʔ12'], love:['爱','ai53'], heart:['心','siN44'], tree:['树','zɿ23'], house:['屋里','oʔ55li'], dog:['狗','kəu214'], cat:['猫','mɔ44'], hand:['手','sɤu214'], eye:['眼睛','ŋɛ23tɕiN44'], hello:['侬好','noŋ44hɔ214'], thanks:['谢谢','ɕia23ɕia'], one:['一','iʔ12'], good:['好','hɔ214'] }},
  // Yue Chinese (Western Guangdong)
  yue_gz: { name: 'Gaozhou Yue', native: '高州话', lat: 21.92, lng: 110.85, // Gaozhou
    words: { water:['水','sɵi35'], fire:['火','fɔ35'], sun:['日头','jɐt5tʰɐu33'], moon:['月光','jyt5kwɔŋ55'], mother:['妈妈','maː55maː55'], father:['爸爸','paː21paː21'], eat:['食','sɪk22'], drink:['饮','jɐm35'], love:['爱','ɔi33'], heart:['心','sɐm55'], tree:['树','sy22'], house:['屋','ʊk5'], dog:['狗','kɐu35'], cat:['猫','maːu55'], hand:['手','sɐu35'], eye:['眼','ŋaːn35'], hello:['你好','nei35hɔu35'], thanks:['多谢','tɔ55tsɛ22'], one:['一','jɐt5'], good:['好','hɔu35'] }},
