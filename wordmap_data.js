...
const LANG_DATA = {
  ...
  ojp: { name: 'Old Japanese', native: '上代日本語', lat: 34.69, lng: 135.83,
    words: { water:['水','mintu'], fire:['火','pə'], sun:['日','pi'], moon:['月','tukï'], mother:['母','papa'], father:['父','titi'], eat:['食ぶ','tabu'], drink:['飲む','nəmu'], love:['愛し','kanasi'], heart:['心','kəkərə'], tree:['木','kə'], house:['家','ipey'], dog:['犬','inu'], cat:['—','—'], hand:['手','ta'], eye:['目','ma'], hello:['—','—'], thanks:['忝し','katadʑike₁nasi'], one:['一つ','pïtətu'], good:['良し','yo₁si'] }},
