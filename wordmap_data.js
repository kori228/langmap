...
const LANG_DATA = {
  ...
  wuu: { name: 'Wu Chinese (Shanghainese)', native: '上海话', lat: 31.23, lng: 121.47,
  ...
  cpx: { name: 'Pu-Xian Min', native: '莆仙话', lat: 25.43, lng: 119.01, // Putian
    words: { water:['水','tsuy˧˧'], fire:['火','xue˧˧'], sun:['日头','lit˨˦tʰau˨˦'], moon:['月','gɔ˨˦'], mother:['母','bo˧˧'], father:['爸','pa˥˥'], eat:['食','liʔ˨˦'], drink:['啜','tʃʰuʔ'], love:['爱','ai˥˥'], heart:['心','siŋ˧˧'], tree:['树','tʃʰiu˥˥'], house:['厝','tsʰu˥˥'], dog:['狗','kau˧˧'], cat:['猫','niau˧˧'], hand:['手','tʃʰiu˧˧'], eye:['目','baʔ˨˦'], hello:['你好','lɛŋ˧˧ho˧˧'], thanks:['多谢','tosiɛ˥˥'], one:['一','it˨˦'], good:['好','ho˧˧'] }},
  ...
  wuu_wz: { name: 'Wenzhounese', native: '温州话', lat: 27.99, lng: 120.70, // Wenzhou
    words: { water:['水','sɿ˧˩'], fire:['火','hu˧˩'], sun:['日头','ȵa˧˨dei˧˩'], moon:['月光','ɲy˨˩˧kʰuɔ˧˧'], mother:['阿妈','a˧˧ma˧˧'], father:['阿爸','a˧˧pa˧˧'], eat:['食','dziɛ˨˩˧'], drink:['饮','iaŋ˧˩'], love:['爱','ai˦˨'], heart:['心','siaŋ˧˧'], tree:['树','dzu˨˩˧'], house:['屋','oʔ˨˧'], dog:['狗','kau˧˩'], cat:['猫','mau˧˩'], hand:['手','sɿu˧˩'], eye:['眼睛','ŋa˧˩tsiaŋ˧˧'], hello:['你好','nəi˧˩hau˧˩'], thanks:['多谢','tau˧˧jia˨˩˧'], one:['一','iaʔ˨˧'], good:['好','hau˧˩'] }},
  wuu_sz: { name: 'Suzhou Wu', native: '苏州话', lat: 31.30, lng: 120.59, // Suzhou
    words: { water:['水','sɿ˥˨'], fire:['火','hu˥˨'], sun:['日头','ɲiɪʔ˨˧dɤ˨˧'], moon:['月亮','ɦyəʔ˨˧liɑ̃˨˧'], mother:['姆妈','m˦˦ma'], father:['爹爹','tiɑ˦˦tia'], eat:['吃','tɕʰiʔ˥˥'], drink:['喝','hoʔ˥˥'], love:['爱','e˦˦'], heart:['心','sin˥˥'], tree:['树','zɿ˨˧'], house:['屋里','oʔ˥˥li'], dog:['狗','kɤ˥˨'], cat:['猫','mɔ˦˦'], hand:['手','sɤ˥˨'], eye:['眼睛','ŋɛ˨˧tɕin'], hello:['侬好','noŋ˦˦hɔ˥˨'], thanks:['谢谢','ʑia˨˧ʑia'], one:['一','iʔ˥˥'], good:['好','hɔ˥˨'] }},
  ...
  zh_jh: { name: 'Jianghuai Mandarin', native: '江淮官话', lat: 32.06, lng: 118.80, // Nanjing
    words: { water:['水','suei˨˩˦'], fire:['火','xuo˨˩˦'], sun:['日头','ʐəʔ˦tʰəu˨˦'], moon:['月亮','yʔ liaŋ'], mother:['妈','ma˧˧'], father:['爸','pa˥˥'], eat:['吃','tʂʰʔ˥˥'], drink:['喝','xəʔ˥˥'], love:['爱','ɛ˦˦'], heart:['心','ɕin˧˧'], tree:['树','sɿ˦˦'], house:['房子','faŋ˨˦tsɿ'], dog:['狗','kəu˨˩˦'], cat:['猫','mɔ˧˧'], hand:['手','səu˨˩˦'], eye:['眼','jɛn˨˩˦'], hello:['你好','ni˨˩˦xau˨˩˦'], thanks:['谢谢','ɕje˦˦ɕje'], one:['一','iʔ˥˥'], good:['好','hau˨˩˦'] }},
  ...
  quc: { name: "K'iche'", native: "Qatzijob'al", lat: 14.84, lng: -91.52, // Quetzaltenango
    words: { water:["ja'",'haʔ'], fire:["q'aq'",'qʼaqʼ'], sun:["q'ij",'qʼih'], moon:["ik'",'ikʼ'], mother:['nan','nan'], father:['tat','tat'], eat:['tijow','tihow'], drink:["uk'ow",'ukʼow'], love:['logoxik','loɡoʃik'], heart:['anima','anima'], tree:["che'",'tʃeʔ'], house:['ja','ha'], dog:["tz'i'",'tsʼiʔ'], cat:['mes','mes'], hand:["q'ab'",'qʼɓ'], eye:['waqaj','waqah'], hello:['saqarik','saqarik'], thanks:['maltyox','maltjoʃ'], one:['jun','hun'], good:['utz','uts'] }},
  kek: { name: "Q'eqchi'", native: "Qʼeqchiʼ", lat: 15.47, lng: -90.37, // Cobán
    words: { water:["haʼ",'haʔ'], fire:["xamʼ",'ʃam'], sun:['saqʼe','saqʼe'], moon:['poo','poː'], mother:['naʼ','naʔ'], father:['yuwaʼ','juwaʔ'], eat:["taawaʼ",'tawaʔ'], drink:["tuʼ",'tuʔ'], love:['rahok','rahok'], heart:['chʼoolej','tʃʼoːlej'], tree:['cheʼ','tʃeʔ'], house:['ochoch','otʃotʃ'], dog:['tzʼiʼ','tsʼiʔ'], cat:['mes','mes'], hand:['ruqʼ','ruqʼ'], eye:['xnaqʼ ru','ʃnaqʼ ru'], hello:["ma sa' laach'ool",'ma sa laːtʃʼoːl'], thanks:["bantyox",'bantjoʃ'], one:['jun','hun'], good:["us",'us'] }},
  mam: { name: 'Mam', native: 'Qyool Mam', lat: 15.32, lng: -91.47, // Huehuetenango
    words: { water:["a'",'aʔ'], fire:["q'aq'",'qʼaqʼ'], sun:["q'ij",'qʼiχ'], moon:['xjaw','ʃhaw'], mother:['nan','nan'], father:['mam','mam'], eat:['waan','waːn'], drink:["k'aan",'kʼaːn'], love:['oqxan','oqʃan'], heart:['anma','anma'], tree:['tzeʼ','tseʔ'], house:['jaa','haː'], dog:["tx'yan",'tʼʃjan'], cat:['wiix','wiːʃ'], hand:["q'ob'",'qʼob'], eye:['witz','wits'], hello:['chjonte tey','tʃhonte tej'], thanks:['chjonte','tʃhonte'], one:['jun','hun'], good:['banix','baniʃ'] }},
  ...
  tji: { name: 'Tujia', native: 'Bizisa', lat: 29.31, lng: 109.49, // Zhangjiajie/Enshi
    words: { water:['zi','tsɨ˥˧'], fire:['mi','mi˥˧'], sun:['ni','ni˧˥'], moon:['nie','nie˧˥'], mother:['a-mie','a˧mie˧'], father:['a-pa','a˧pa˧'], eat:['za','tsa˨˩'], drink:['da','ta˧'], love:['ka','kʰa˨˩'], heart:['xin','ɕin˧'], tree:['si','sɨ˧˥'], house:['li','li˧˥'], dog:['kvʼ','kʰə˨˩'], cat:['mau','mau˧'], hand:['lo','lo˨˩'], eye:['mie','mie˨˩'], hello:['shu shu','ʃu˧ʃu˧'], thanks:['ka','kʰa˨˩'], one:['lao','lao˧˥'], good:['ngaq','ŋaʔ˧˥'] }},
