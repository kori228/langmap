...
const WORD_LIST = [
  { id: 'water', definition: { en: 'Drinkable water (H₂O); the basic substance, not a body of water.', ja: '飲用・生活用の水 (H₂O)。川・湖・海などの水域そのものではない。', ko: '마시거나 일상에 쓰는 물 (H₂O). 강·호수·바다 같은 수역 자체가 아니다.', zh: '可饮用或日常使用的水 (H₂O)；不是河流、湖泊、海洋等水域本身。' }, label: { en: 'Water', ja: '水', ko: '물', zh: '水', yue: '水', vi: 'Nước', th: 'น้ำ', id: 'Air', hi: 'पानी', de: 'Wasser', fr: 'Eau', it: 'Acqua', es: 'Agua', pt: 'Água', ru: 'Вода', uk: 'Вода', ar: 'ماء', he: 'מים', sw: 'Maji' } },
  { id: 'fire', definition: { en: 'Fire / flame as a phenomenon; not "match" or "campfire".', ja: '燃焼現象としての火・炎。「マッチ」や「焚き火」のような特定の対象ではない。', ko: '연소 현상으로서의 불·불꽃. "성냥"이나 "모닥불" 같은 구체적 대상이 아니다.', zh: '作为燃烧现象的火、火焰；不是"火柴"或"营火"等具体对象。' }, label: { en: 'Fire', ja: '火', ko: '불', zh: '火', yue: '火', vi: 'Lửa', th: 'ไฟ', id: 'Api', hi: 'आग', de: 'Feuer', fr: 'Feu', it: 'Fuoco', es: 'Fuego', pt: 'Fogo', ru: 'Огонь', uk: 'Вогонь', ar: 'نار', he: 'אש', sw: 'Moto' } },
  { id: 'sun', definition: { en: 'The star Sol seen from Earth; "the sun in the sky".', ja: '地球から見える恒星としての太陽。「空の太陽」。', ko: '지구에서 보이는 항성으로서의 해. "하늘의 해".', zh: '从地球上看到的太阳；"天上的太阳"。' }, label: { en: 'Sun', ja: '日', ko: '해', zh: '太阳', yue: '日頭', vi: 'Mặt trời', th: 'ดวงอาทิตย์', id: 'Matahari', hi: 'सूरज', de: 'Sonne', fr: 'Soleil', it: 'Sole', es: 'Sol', pt: 'Sol', ru: 'Солнце', uk: 'Сонце', ar: 'شمس', he: 'שמש', sw: 'Jua' } },
  { id: 'moon', definition: { en: "Earth's natural satellite; not the calendar month.", ja: '地球の衛星としての月。暦の「月」ではない。', ko: '지구의 위성으로서의 달. 달력의 "월"이 아니다.', zh: '地球的天然卫星；不是日历上的"月"。' }, label: { en: 'Moon', ja: '月', ko: '달', zh: '月亮', yue: '月亮', vi: 'Mặt trăng', th: 'ดวงจันทร์', id: 'Bulan', hi: 'चाँद', de: 'Mond', fr: 'Lune', it: 'Luna', es: 'Luna', pt: 'Lua', ru: 'Луна', uk: 'Місяць', ar: 'قمر', he: 'ירח', sw: 'Mwezi' } },
  { id: 'mother', definition: { en: 'Female parent — neutral/citation form. Register varies by language.', ja: '女親（母）の中立的・辞書形。フォーマル/カジュアルの区別は言語による。', ko: '여성 부모(어머니)의 중립적/사전형. 격식 차이는 언어마다 다르다.', zh: '女性家长（母亲）的中性/词典形式。语体级别因语言而异。' }, label: { en: 'Mother', ja: '母', ko: '어머니', zh: '母亲', yue: '母親', vi: 'Mẹ', th: 'แม่', id: 'Ibu', hi: 'माँ', de: 'Mutter', fr: 'Mère', it: 'Madre', es: 'Madre', pt: 'Mãe', ru: 'Мать', uk: 'Мати', ar: 'أم', he: 'אמא', sw: 'Mama' } },
  { id: 'father', definition: { en: 'Male parent — neutral/citation form. Same register convention as mother.', ja: '男親（父）の中立的・辞書形。母と同じ語法ポリシー。', ko: '남성 부모(아버지)의 중립적/사전형. 어머니와 동일한 어법 정책.', zh: '男性家长（父亲）的中性/词典形式。语体规范同"母亲"。' }, label: { en: 'Father', ja: '父', ko: '아버지', zh: '父亲', yue: '父親', vi: 'Bố', th: 'พ่อ', id: 'Ayah', hi: 'पिता', de: 'Vater', fr: 'Père', it: 'Padre', es: 'Padre', pt: 'Pai', ru: 'Отец', uk: 'Батько', ar: 'أب', he: 'אבא', sw: 'Baba' } },
  { id: 'eat', definition: { en: 'Verb "to eat" — use the language\'s normal dictionary/citation convention; document exceptions with wordEvidence.note.', ja: '動詞「食べる」。各言語の通常の辞書形・引用形を用いる。例外は wordEvidence.note で記録。', ko: '동사 "먹다". 각 언어의 통상적 사전형·인용형을 사용. 예외는 wordEvidence.note에 기록.', zh: '动词"吃"。使用各语言通常的词典/引用形式。例外通过 wordEvidence.note 记录。' }, label: { en: 'Eat', ja: '食べる', ko: '먹다', zh: '吃', yue: '食', vi: 'Ăn', th: 'กิน', id: 'Makan', hi: 'खाना', de: 'Essen', fr: 'Manger', it: 'Mangiare', es: 'Comer', pt: 'Comer', ru: 'Есть', uk: 'Їсти', ar: 'أكل', he: 'לאכול', sw: 'Kula' } },
  { id: 'drink', definition: { en: 'Verb "to drink" — same form policy as eat. May overlap with eat in Iranian/Old Thai (noted via wordEvidence).', ja: '動詞「飲む」。eat と同じ形態ポリシー。イラン語派・古タイ語では eat と語形が重なることあり (wordEvidence で記録)。', ko: '동사 "마시다". eat와 동일한 형태 정책. 이란어파·고타이어에서는 eat와 어형이 겹치기도 함 (wordEvidence에 기록).', zh: '动词"喝"。形式策略同"吃"。伊朗语支、古泰语中可能与"吃"同形（通过 wordEvidence 记录）。' }, label: { en: 'Drink', ja: '飲む', ko: '마시다', zh: '喝', yue: '飲', vi: 'Uống', th: 'ดื่ม', id: 'Minum', hi: 'पीना', de: 'Trinken', fr: 'Boire', it: 'Bere', es: 'Beber', pt: 'Beber', ru: 'Пить', uk: 'Пити', ar: 'شرب', he: 'לשתות', sw: 'Kunywa' } },
  { id: 'love', definition: { en: 'Basic word/root for love or affection — noun or verb citation form depending on language; not a greeting.', ja: '愛・愛情を表す基本語・語根。言語により名詞または動詞の辞書形。挨拶ではない。', ko: '사랑·애정을 나타내는 기본 단어/어근. 언어에 따라 명사 또는 동사 사전형. 인사가 아니다.', zh: '表示爱或感情的基础词/词根；视语言而定，名词或动词词典形式。不是问候语。' }, label: { en: 'Love', ja: '愛', ko: '사랑', zh: '爱', yue: '愛', vi: 'Yêu', th: 'รัก', id: 'Cinta', hi: 'प्रेम', de: 'Liebe', fr: 'Amour', it: 'Amore', es: 'Amor', pt: 'Amor', ru: 'Любовь', uk: 'Любов', ar: 'حب', he: 'אהבה', sw: 'Upendo' } },
  { id: 'heart', definition: { en: 'Default: the basic emotional/cognitive heart/mind term. Use anatomical heart only where it is the normal basic word; document the choice with wordEvidence.note.', ja: '既定: 感情・思考の中心としての「心」を表す基本語。解剖学的「心臓」は、それがその言語の基本語である場合のみ採用 (wordEvidence.note に記録)。', ko: '기본값: 감정·인지의 중심으로서의 "마음"을 나타내는 기본어. 해부학적 "심장"은 그것이 해당 언어의 기본 어휘인 경우에 한함 (wordEvidence.note에 기록).', zh: '默认：表示情感·认知中心的"心"的基本词。仅当解剖学"心脏"是该语言的基础词时使用，并在 wordEvidence.note 注明。' }, label: { en: 'Heart', ja: '心', ko: '마음', zh: '心', yue: '心', vi: 'Tim', th: 'ใจ', id: 'Hati', hi: 'दिल', de: 'Herz', fr: 'Cœur', it: 'Cuore', es: 'Corazón', pt: 'Coração', ru: 'Сердце', uk: 'Серце', ar: 'قلب', he: 'לב', sw: 'Moyo' } },
  { id: 'tree', definition: { en: 'Tree (woody plant); not specifically a tree species or "wood".', ja: '木（木本植物）。特定の樹種や「木材」ではない。', ko: '나무 (목본 식물). 특정 수종이나 "목재"가 아니다.', zh: '树（木本植物）；不特指树种或"木材"。' }, label: { en: 'Tree', ja: '木', ko: '나무', zh: '树', yue: '樹', vi: 'Cây', th: 'ต้นไม้', id: 'Pohon', hi: 'पेड़', de: 'Baum', fr: 'Arbre', it: 'Albero', es: 'Árbol', pt: 'Árvore', ru: 'Дерево', uk: 'Дерево', ar: 'شجرة', he: 'עץ', sw: 'Mti' } },
  { id: 'house', definition: { en: 'House / dwelling — generic residence; not "home" as abstract concept or "building".', ja: '家・住居。一般的な住居。抽象概念の「ホーム」や「建築物」ではない。', ko: '집/주거 — 일반적인 거주지. 추상 개념의 "홈"이나 "건물"이 아니다.', zh: '房屋/住所——一般居所；不是抽象的"家"或"建筑物"。' }, label: { en: 'House', ja: '家', ko: '집', zh: '房子', yue: '屋', vi: 'Nhà', th: 'บ้าน', id: 'Rumah', hi: 'घर', de: 'Haus', fr: 'Maison', it: 'Casa', es: 'Casa', pt: 'Casa', ru: 'Дом', uk: 'Дім', ar: 'بيت', he: 'בית', sw: 'Nyumba' } },
  { id: 'dog', definition: { en: 'Domestic dog (Canis familiaris); generic, not a breed or sex-specific.', ja: '家畜化されたイヌ (Canis familiaris)。一般語、犬種や性別を限定しない。', ko: '가축화된 개 (Canis familiaris). 일반어, 견종이나 성별을 한정하지 않음.', zh: '家犬 (Canis familiaris)；通称，不指特定品种或性别。' }, label: { en: 'Dog', ja: '犬', ko: '개', zh: '狗', yue: '狗', vi: 'Chó', th: 'หมา', id: 'Anjing', hi: 'कुत्ता', de: 'Hund', fr: 'Chien', it: 'Cane', es: 'Perro', pt: 'Cão', ru: 'Собака', uk: 'Собака', ar: 'كلب', he: 'כלב', sw: 'Mbwa' } },
  { id: 'cat', definition: { en: 'Generic domestic cat; use the normal generic/citation form for that language, and note gender if it matters.', ja: '一般的な家猫 (Felis catus)。各言語の通常の一般形・辞書形を用い、性別が重要な場合は wordEvidence.note に記録。', ko: '일반 집고양이 (Felis catus). 각 언어의 통상적 일반형/사전형을 사용하고, 성별이 중요하면 wordEvidence.note에 기록.', zh: '一般家猫 (Felis catus)；使用各语言的通常通用/词典形式，若性别有意义则在 wordEvidence.note 注明。' }, label: { en: 'Cat', ja: '猫', ko: '고양이', zh: '猫', yue: '貓', vi: 'Mèo', th: 'แมว', id: 'Kucing', hi: 'बिल्ली', de: 'Katze', fr: 'Chat', it: 'Gatto', es: 'Gato', pt: 'Gato', ru: 'Кошка', uk: 'Кішка', ar: 'قطة', he: 'חתול', sw: 'Paka' } },
  { id: 'hand', definition: { en: 'Hand (distal upper limb); not "arm". Some languages do not distinguish hand vs arm.', ja: '手（前腕の末端部）。「腕」ではない。手と腕を区別しない言語もある。', ko: '손 (팔의 말단부). "팔"이 아니다. 손과 팔을 구별하지 않는 언어도 있다.', zh: '手（上肢末端）；不是"手臂"。部分语言不区分手与手臂。' }, label: { en: 'Hand', ja: '手', ko: '손', zh: '手', yue: '手', vi: 'Tay', th: 'มือ', id: 'Tangan', hi: 'हाथ', de: 'Hand', fr: 'Main', it: 'Mano', es: 'Mano', pt: 'Mão', ru: 'Рука', uk: 'Рука', ar: 'يد', he: 'יד', sw: 'Mkono' } },
  { id: 'eye', definition: { en: 'Eye (organ of sight); singular form preferred.', ja: '目（視覚器官）。単数形を優先。', ko: '눈 (시각 기관). 단수형을 우선.', zh: '眼（视觉器官）；优先使用单数形式。' }, label: { en: 'Eye', ja: '目', ko: '눈', zh: '眼睛', yue: '眼', vi: 'Mắt', th: 'ตา', id: 'Mata', hi: 'आँख', de: 'Auge', fr: 'Œil', it: 'Occhio', es: 'Ojo', pt: 'Olho', ru: 'Глаз', uk: 'Око', ar: 'عين', he: 'עין', sw: 'Jicho' } },
  { id: 'hello', definition: { en: 'Neutral everyday greeting. Time-of-day forms (morning/evening) only if the language has no neutral form. Blessings (e.g. "peace") accepted only as the normal greeting.', ja: '中立的な日常挨拶。時刻別の挨拶 (おはよう・こんばんは) は中立形がない場合のみ。「平安」などの祝福語も、それが通常の挨拶である場合のみ。', ko: '중립적 일상 인사. 시간대별 인사 (아침/저녁)는 중립형이 없을 때만 사용. "평안" 등 축복어는 그것이 통상적 인사일 경우에만.', zh: '中性日常问候语。仅当语言无中性形式时才使用时段问候 (早安/晚安)。"平安"等祝福语仅在它本身就是日常问候时使用。' }, label: { en: 'Hello', ja: 'こんにちは', ko: '안녕', zh: '你好', yue: '你好', vi: 'Xin chào', th: 'สวัสดี', id: 'Halo', hi: 'नमस्ते', de: 'Hallo', fr: 'Bonjour', it: 'Ciao', es: 'Hola', pt: 'Olá', ru: 'Привет', uk: 'Привіт', ar: 'مرحبا', he: 'שלום', sw: 'Habari' } },
  { id: 'thanks', definition: { en: 'Spoken thank-you formula for modern languages. For historical languages, use — or a clearly noted liturgical/gratitude noun rather than inventing a formula.', ja: '現代語では話し言葉の感謝表現。歴史言語では「—」または明記された宗教/感謝名詞を用い、表現を捏造しない。', ko: '현대어에서는 구어 감사 표현. 역사 언어에서는 "—" 또는 명기된 종교/감사 명사를 사용하고 임의로 만들어내지 않음.', zh: '现代语言使用口语感谢表达。历史语言用 "—" 或明确标注的礼仪/感谢名词，而非杜撰表达。' }, label: { en: 'Thank you', ja: 'ありがとう', ko: '감사', zh: '谢谢', yue: '多謝', vi: 'Cảm ơn', th: 'ขอบคุณ', id: 'Terima kasih', hi: 'धन्यवाद', de: 'Danke', fr: 'Merci', it: 'Grazie', es: 'Gracias', pt: 'Obrigado', ru: 'Спасибо', uk: 'Дякую', ar: 'شكرا', he: 'תודה', sw: 'Asante' } },
  { id: 'one', definition: { en: 'Cardinal numeral 1; masculine/default citation form where languages distinguish gender (e.g. ar واحد, he אחד, fr un, es uno).', ja: '基数 1。性別区別がある言語では男性形・既定形 (例: ar واحد, he אחד, fr un, es uno)。', ko: '기수 1. 성을 구분하는 언어에서는 남성형/기본형 (예: ar واحد, he אחד, fr un, es uno).', zh: '基数 1。区分性别的语言中使用阳性/默认形式 (如 ar واحد, he אחד, fr un, es uno)。' }, label: { en: 'One', ja: '一', ko: '하나', zh: '一', yue: '一', vi: 'Một', th: 'หนึ่ง', id: 'Satu', hi: 'एक', de: 'Eins', fr: 'Un', it: 'Uno', es: 'Uno', pt: 'Um', ru: 'Один', uk: 'Один', ar: 'واحد', he: 'אחד', sw: 'Moja' } },
  { id: 'good', definition: { en: 'Basic adjective "good" (positive quality); attributive citation form preferred. Avoid adverb "well" (e.g. ru хорошо / uk добре) and greeting responses.', ja: '基本形容詞「良い」（肯定的属性）。連体辞書形を優先。副詞「うまく」(例: ru хорошо / uk добре) や挨拶返答は避ける。', ko: '기본 형용사 "좋다"(긍정적 속성). 관형 사전형을 우선. 부사 "잘"(예: ru хорошо / uk добре)과 인사 응답 형은 피한다.', zh: '基本形容词"好"（正面属性）；优先使用定语词典形式。避免副词"well"(如 ru хорошо / uk добре) 和问候应答形式。' }, label: { en: 'Good', ja: '良い', ko: '좋은', zh: '好', yue: '好', vi: 'Tốt', th: 'ดี', id: 'Baik', hi: 'अच्छा', de: 'Gut', fr: 'Bon', it: 'Buono', es: 'Bueno', pt: 'Bom', ru: 'Хороший', uk: 'Добрий', ar: 'جيد', he: 'טוב', sw: 'Nzuri' } },
];
