...
(function backfillNames() {
    ...
    // Hanmap: ko_zai_nk — Chongryon-aligned Zainichi Korean Sino-reading
    // (頭音法則 NOT applied, parallel to ko_zai which is Mindan-aligned).
    // Also re-label ko_zai itself to clarify Mindan affiliation, overriding
    // the original "在日韓国・朝鮮人漢字音"-style name in the main dict.
    const ZAI_RELABEL = {
        ko_zai: {
            en: 'Zainichi Korean (Mindan / South-aligned)',
            ja: '在日韓国・朝鮮人漢字音 (民団系)',
            ko: '재일한국인 한자음 (민단계)',
            zh: '在日韓國人漢字音(民團系)',
            yue: '在日韓國人漢字音(民團系)',
            vi: 'Âm Hán-Hàn Zainichi (Mindan / hệ Hàn Quốc)',
            th: 'อักษรจีน-เกาหลีไซนิจิ (มินดัน / ฝ่ายเกาหลีใต้)',
            id: 'Sino-Korea Zainichi (Mindan / berafiliasi Korsel)',
            hi: 'ज़ैनिची सिनो-कोरियाई (मिंदान / दक्षिण कोरिया अनुगामी)',
            de: 'Zainichi-Sino-Koreanisch (Mindan / südkoreanisch ausgerichtet)',
            fr: 'Sino-coréen zainichi (Mindan / aligné sur la Corée du Sud)',
            it: 'Sino-coreano zainichi (Mindan / di tendenza sudcoreana)',
            es_eu: 'Sino-coreano zainichi (Mindan / pro-Corea del Sur)',
            es_mx: 'Sino-coreano zainichi (Mindan / pro-Corea del Sur)',
            pt_eu: 'Sino-coreano zainichi (Mindan / alinhado com a Coreia do Sul)',
            pt_br: 'Sino-coreano zainichi (Mindan / alinhado com a Coreia do Sul)',
            ru: 'Сино-корейский зайнити (Миндан / южнокорейская ориентация)',
            uk: 'Сино-корейський зайніті (Міндан / південнокорейська орієнтація)',
            ar: 'سينو-كورية الزينيتشي (ميندان / موالٍ لكوريا الجنوبية)',
            he: 'סינו-קוריאנית זאיניצ\'י (מינדן / נוטה לדרום קוריאה)',
            sw: 'Sino-Kikorea cha Zainichi (Mindan / kuegemea Korea Kusini)',
        },
        ko_zai_nk: {
            en: 'Zainichi Korean (Chongryon / North-aligned)',
            ja: '在日韓国・朝鮮人漢字音 (総連系)',
            ko: '재일조선인 한자음 (총련계)',
            zh: '在日朝鮮人漢字音(總聯系)',
            yue: '在日朝鮮人漢字音(總聯系)',
            vi: 'Âm Hán-Hàn Zainichi (Chongryon / hệ Triều Tiên)',
            th: 'อักษรจีน-เกาหลีไซนิจิ (ชงรยอน / ฝ่ายเกาหลีเหนือ)',
            id: 'Sino-Korea Zainichi (Chongryon / berafiliasi Korut)',
            hi: 'ज़ैनिची सिनो-कोरियाई (चोंगरयोन / उत्तर कोरिया अनुगामी)',
            de: 'Zainichi-Sino-Koreanisch (Chongryon / nordkoreanisch ausgerichtet)',
            fr: 'Sino-coréen zainichi (Chongryon / aligné sur la Corée du Nord)',
            it: 'Sino-coreano zainichi (Chongryon / di tendenza nordcoreana)',
            es_eu: 'Sino-coreano zainichi (Chongryon / pro-Corea del Norte)',
            es_mx: 'Sino-coreano zainichi (Chongryon / pro-Corea del Norte)',
            pt_eu: 'Sino-coreano zainichi (Chongryon / alinhado com a Coreia do Norte)',
            pt_br: 'Sino-coreano zainichi (Chongryon / alinhado com a Coreia do Norte)',
            ru: 'Сино-корейский зайнити (Чхонрён / северокорейская ориентация)',
            uk: 'Сино-корейський зайніті (Чхонрьон / північнокорейська орієнтація)',
            ar: 'سينو-كورية الزينيتشي (تشونغريون / موالٍ لكوريا الشمالية)',
            he: 'סינו-קוריאנית זאיניצ\'י (צ\'ונגריון / נוטה לצפון קוריאה)',
            sw: 'Sino-Kikorea cha Zainichi (Chongryon / kuegemea Korea Kaskazini)',
        },
    };
    for (const code of Object.keys(ZAI_RELABEL)) {
        for (const ui of Object.keys(ZAI_RELABEL[code])) {
            if (LANG_NAMES[ui]) {
                // Override unconditionally — for ko_zai this replaces the
                // old "在日韓国・朝鮮人漢字音" label that pre-dated the
                // Mindan/Chongryon split; for ko_zai_nk this is the only
                // source of a localized name.
                LANG_NAMES[ui][code] = ZAI_RELABEL[code][ui];
            }
        }
    }
})();
