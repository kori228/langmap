...
(function backfillNames() {
    ...
    const ADDED39 = {
        ...
        zh_cq: { en: 'Chinese (Chongqing)', ja: '中国語(重慶話)', ko: '중국어(충칭말)', zh: '中文(重庆话)', yue: '中文(重慶話)', vi: 'Tiếng Trung (Trùng Khánh)', th: 'จีน (ฉงชิ่ง)', id: 'Tionghoa (Chongqing)', hi: 'चीनी (छोंगछिंग)', de: 'Chinesisch (Chongqing)', fr: 'Chinois (Chongqing)', it: 'Cinese (Chongqing)', es_eu: 'Chino (Chongqing)', es_mx: 'Chino (Chongqing)', pt_eu: 'Chinês (Chongqing)', pt_br: 'Chinês (Chongqing)', ru: 'Китайский (Чунцин)', uk: 'Китайська (Чунцін)', ar: 'الصينية (تشونغتشينغ)', he: 'סינית (צ׳ונגצ׳ינג)', sw: 'Kichina (Chongqing)' },
        zh_jn: { en: 'Chinese (Jinan)', ja: '中国語(済南話)', ko: '중국어(지난말)', zh: '中文(济南话)', yue: '中文(濟南話)', vi: 'Tiếng Trung (Tế Nam)', th: 'จีน (จี่หนาน)', id: 'Tionghoa (Jinan)', hi: 'चीनी (जिनान)', de: 'Chinesisch (Jinan)', fr: 'Chinois (Jinan)', it: 'Cinese (Jinan)', es_eu: 'Chino (Jinan)', es_mx: 'Chino (Jinan)', pt_eu: 'Chinês (Jinan)', pt_br: 'Chinês (Jinan)', ru: 'Китайский (Цзинань)', uk: 'Китайська (Цзінань)', ar: 'الصينية (جينان)', he: 'סינית (ג׳ינאן)', sw: 'Kichina (Jinan)' },
