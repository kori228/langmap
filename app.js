...
const RTL_LANGS = new Set(['ar', 'ar_eg', 'he', 'fa', 'ur']);
...
const GROUP_NAMES = {
    ja: { JPN:'日本語', KOR:'韓国語', CHN:'中国語', SEA:'東南アジア', SAS:'南・中央アジア', EUR:'ゲルマン', ROM:'ロマンス', SLV:'スラヴ・ウラル', SEM:'セム・アフリカ', CEL:'ケルト・バスク', AMR:'アメリカ先住民' },
    en: { JPN:'Japanese', KOR:'Korean', CHN:'Chinese', SEA:'SE Asian', SAS:'S & Central Asian', EUR:'Germanic', ROM:'Romance', SLV:'Slavic & Uralic', SEM:'Semitic & African', CEL:'Celtic & Basque', AMR:'Americas' },
};
