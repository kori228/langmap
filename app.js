...
const LANG_NAMES = {
    ja: { ja:'日本語(標準)', ja_osa:'大阪弁', ja_aom:'青森弁', ja_oki:'沖縄弁', ja_hak:'博多弁', ja_edo:'江戸時代語', ko:'韓国語(標準)', ko_kp:'北朝鮮語', ko_bus:'釜山弁', zh:'中国語(普通話)', yue:'広東語', nan:'台湾語', wuu:'上海語', zh_classical:'文言', vi:'ベトナム語', vi_nom:'チューノム', th:'タイ語', id:'インドネシア語', sa:'サンスクリット語', hi:'ヒンディー語', en:'英語', en_aave:'AAVE(黒人英語)', en_south:'英語(南部)', en_app:'英語(アパラチア)', en_ie:'英語(アイルランド)', en_sco:'英語(スコットランド)', en_yk:'英語(ヨークシャー)', en_ck:'英語(コックニー)', de:'ドイツ語', fr:'フランス語', it:'イタリア語', es_eu:'スペイン語(欧州)', es_mx:'スペイン語(メキシコ)', pt_eu:'ポルトガル語(欧州)', pt_br:'ポルトガル語(ブラジル)', la:'ラテン語', ru:'ロシア語', uk:'ウクライナ語', ar:'アラビア語(フスハー)', ar_eg:'アラビア語(エジプト方言)', he:'ヘブライ語', sw:'スワヒリ語', tr:'トルコ語', fa:'ペルシャ語', tl:'タガログ語', ga:'アイルランド語', eu:'バスク語', mn:'モンゴル語', my:'ミャンマー語', am:'アムハラ語', egy:'古代エジプト語', ta:'タミル語', hu:'ハンガリー語', nl:'オランダ語', pl:'ポーランド語', ms:'マレー語', mg:'マダガスカル語', cy:'ウェールズ語', fi:'フィンランド語', ain:'アイヌ語', bn:'ベンガル語', ur:'ウルドゥー語', te:'テルグ語', jv:'ジャワ語', ko_jeju:'済州語', ka:'グルジア語', el:'ギリシャ語', grc:'古代ギリシャ語', nv:'ナバホ語', qu:'ケチュア語', mi:'マオリ語', haw:'ハワイ語', km:'クメール語', lo:'ラオ語', yo:'ヨルバ語', zu:'ズールー語', bo:'チベット語', hy:'アルメニア語' , ja_kyo:'京都弁', ja_hir:'広島弁', ja_mvi:'宮古語', ja_rys:'八重山語', ar_lev:'アラビア語(レバント方言)', ar_ma:'アラビア語(モロッコ方言)', ar_gulf:'アラビア語(湾岸方言)', zh_sc:'四川話', zh_db:'東北話', nap:'ナポリ語', scn:'シチリア語', gsw:'スイスドイツ語', fr_qc:'ケベック・フランス語', sco:'スコットランド語', en_sg:'シングリッシュ', hwc:'ハワイ・クレオール', pcm:'ナイジェリア・ピジン', tpi:'トク・ピシン', ang:'古英語', sv:'スウェーデン語', no:'ノルウェー語', si:'シンハラ語'},
    en: { ja:'Japanese', ja_osa:'Osaka dialect', ja_aom:'Aomori dialect', ja_oki:'Okinawan', ja_hak:'Hakata dialect', ja_edo:'Edo-period Japanese', ko:'Korean', ko_kp:'North Korean', ko_bus:'Busan dialect', zh:'Chinese (Mandarin)', yue:'Cantonese', nan:'Taiwanese', wuu:'Shanghainese', zh_classical:'Classical Chinese', vi:'Vietnamese', vi_nom:'Chữ Nôm', th:'Thai', id:'Indonesian', sa:'Sanskrit', hi:'Hindi', en:'English', en_aave:'AAVE', en_south:'English (Southern US)', en_app:'English (Appalachian)', en_ie:'English (Irish)', en_sco:'English (Scottish)', en_yk:'English (Yorkshire)', en_ck:'English (Cockney)', de:'German', fr:'French', it:'Italian', es_eu:'Spanish (Europe)', es_mx:'Spanish (Mexico)', pt_eu:'Portuguese (Europe)', pt_br:'Portuguese (Brazil)', la:'Latin', ru:'Russian', uk:'Ukrainian', ar:'Arabic (MSA)', ar_eg:'Arabic (Egyptian)', he:'Hebrew', sw:'Swahili', tr:'Turkish', fa:'Persian', tl:'Tagalog', ga:'Irish', eu:'Basque', mn:'Mongolian', my:'Burmese', am:'Amharic', egy:'Ancient Egyptian', ta:'Tamil', hu:'Hungarian', nl:'Dutch', pl:'Polish', ms:'Malay', mg:'Malagasy', cy:'Welsh', fi:'Finnish', ain:'Ainu', bn:'Bengali', ur:'Urdu', te:'Telugu', jv:'Javanese', ko_jeju:'Jeju', ka:'Georgian', el:'Greek', grc:'Ancient Greek', nv:'Navajo', qu:'Quechua', mi:'Māori', haw:'Hawaiian', km:'Khmer', lo:'Lao', yo:'Yoruba', zu:'Zulu', bo:'Tibetan', hy:'Armenian' , ja_kyo:'Kyoto dialect', ja_hir:'Hiroshima dialect', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Arabic (Levantine)', ar_ma:'Arabic (Moroccan)', ar_gulf:'Arabic (Gulf)', zh_sc:'Sichuanese', zh_db:'Northeastern Chinese', nap:'Neapolitan', scn:'Sicilian', gsw:'Swiss German', fr_qc:'Québécois French', sco:'Scots', en_sg:'Singlish', hwc:'Hawaiian Creole', pcm:'Nigerian Pidgin', tpi:'Tok Pisin', ang:'Old English', sv:'Swedish', no:'Norwegian', si:'Sinhala'},
    ko: { ja:'일본어(표준)', ja_osa:'오사카 사투리', ja_aom:'아오모리 사투리', ja_oki:'오키나와 사투리', ja_hak:'하카타 사투리', ja_edo:'에도시대 일본어', ko:'한국어(표준)', ko_kp:'북한어', ko_bus:'부산 사투리', zh:'중국어(보통화)', yue:'광둥어', nan:'대만어', wuu:'상하이어', zh_classical:'문언(文言)', vi:'베트남어', vi_nom:'쯔놈', th:'태국어', id:'인도네시아어', sa:'산스크리트어', hi:'힌디어', en:'영어', en_aave:'AAVE(흑인영어)', en_south:'영어(남부)', en_app:'영어(애팔래치아)', en_ie:'영어(아일랜드)', en_sco:'영어(스코틀랜드)', en_yk:'영어(요크셔)', en_ck:'영어(코크니)', de:'독일어', fr:'프랑스어', it:'이탈리아어', es_eu:'스페인어(유럽)', es_mx:'스페인어(멕시코)', pt_eu:'포르투갈어(유럽)', pt_br:'포르투갈어(브라질)', la:'라틴어', ru:'러시아어', uk:'우크라이나어', ar:'아랍어(푸스하)', ar_eg:'아랍어(이집트 방언)', he:'히브리어', sw:'스와힐리어', tr:'터키어', fa:'페르시아어', tl:'타갈로그어', ga:'아일랜드어', eu:'바스크어', mn:'몽골어', my:'미얀마어', am:'암하라어', egy:'고대 이집트어', ta:'타밀어', hu:'헝가리어', nl:'네덜란드어', pl:'폴란드어', ms:'말레이어', mg:'말라가시어', cy:'웨일스어', fi:'핀란드어', ain:'아이누어', bn:'벵골어', ur:'우르두어', te:'텔루구어', jv:'자와어', ko_jeju:'제주어', ka:'조지아어', el:'그리스어', grc:'고대 그리스어', nv:'나바호어', qu:'케추아어', mi:'마오리어', haw:'하와이어', km:'크메르어', lo:'라오어', yo:'요루바어', zu:'줄루어', bo:'티베트어', hy:'아르메니아어' , ja_kyo:'교토 사투리', ja_hir:'히로시마 사투리', ja_mvi:'미야코어', ja_rys:'야에야마어', ar_lev:'아랍어(레반트 방언)', ar_ma:'아랍어(모로코 방언)', ar_gulf:'아랍어(걸프 방언)', zh_sc:'쓰촨화', zh_db:'동북화', nap:'나폴리어', scn:'시칠리아어', gsw:'스위스 독일어', fr_qc:'퀘벡 프랑스어', sco:'스코트어', en_sg:'싱글리시', hwc:'하와이 크레올', pcm:'나이지리아 피진', tpi:'토크 피신', ang:'고대 영어', sv:'스웨덴어', no:'노르웨이어', si:'싱할라어'},
    zh: { ja:'日语(标准)', ja_osa:'大阪方言', ja_aom:'青森方言', ja_oki:'冲绳方言', ja_hak:'博多方言', ja_edo:'江户时代日语', ko:'韩语(标准)', ko_kp:'朝鲜语', ko_bus:'釜山方言', zh:'中文(普通话)', yue:'粤语', nan:'台湾话', wuu:'上海话', zh_classical:'文言', vi:'越南语', vi_nom:'字喃', th:'泰语', id:'印尼语', sa:'梵语', hi:'印地语', en:'英语', en_aave:'AAVE(非裔美式英语)', en_south:'英语(美国南方)', en_app:'英语(阿巴拉契亚)', en_ie:'英语(爱尔兰)', en_sco:'英语(苏格兰)', en_yk:'英语(约克郡)', en_ck:'英语(伦敦东区)', de:'德语', fr:'法语', it:'意大利语', es_eu:'西班牙语(欧洲)', es_mx:'西班牙语(墨西哥)', pt_eu:'葡萄牙语(欧洲)', pt_br:'葡萄牙语(巴西)', la:'拉丁语', ru:'俄语', uk:'乌克兰语', ar:'阿拉伯语(标准)', ar_eg:'阿拉伯语(埃及方言)', he:'希伯来语', sw:'斯瓦希里语', tr:'土耳其语', fa:'波斯语', tl:'他加禄语', ga:'爱尔兰语', eu:'巴斯克语', mn:'蒙古语', my:'缅甸语', am:'阿姆哈拉语', egy:'古埃及语', ta:'泰米尔语', hu:'匈牙利语', nl:'荷兰语', pl:'波兰语', ms:'马来语', mg:'马达加斯加语', cy:'威尔士语', fi:'芬兰语', ain:'阿伊努语', bn:'孟加拉语', ur:'乌尔都语', te:'泰卢固语', jv:'爪哇语', ko_jeju:'济州语', ka:'格鲁吉亚语', el:'希腊语', grc:'古希腊语', nv:'纳瓦霍语', qu:'克丘亚语', mi:'毛利语', haw:'夏威夷语', km:'高棉语', lo:'老挝语', yo:'约鲁巴语', zu:'祖鲁语', bo:'藏语', hy:'亚美尼亚语' , ja_kyo:'京都方言', ja_hir:'广岛方言', ja_mvi:'宫古语', ja_rys:'八重山语', ar_lev:'阿拉伯语(黎凡特方言)', ar_ma:'阿拉伯语(摩洛哥方言)', ar_gulf:'阿拉伯语(海湾方言)', zh_sc:'四川话', zh_db:'东北话', nap:'那不勒斯语', scn:'西西里语', gsw:'瑞士德语', fr_qc:'魁北克法语', sco:'苏格兰语', en_sg:'新加坡式英语', hwc:'夏威夷克里奥尔', pcm:'尼日利亚皮钦语', tpi:'托克皮辛', ang:'古英语', sv:'瑞典语', no:'挪威语', si:'僧伽罗语'},
    fr: { ja:'Japonais', ja_osa:'Dialecte d\'Osaka', ja_aom:'Dialecte d\'Aomori', ja_oki:'Okinawaïen', ja_hak:'Dialecte de Hakata', ja_edo:'Japonais d\'Edo', ko:'Coréen', ko_kp:'Nord-coréen', ko_bus:'Dialecte de Busan', zh:'Chinois (mandarin)', yue:'Cantonais', nan:'Taïwanais', wuu:'Shanghaïen', zh_classical:'Chinois classique', vi:'Vietnamien', vi_nom:'Chữ Nôm', th:'Thaï', id:'Indonésien', sa:'Sanskrit', hi:'Hindi', en:'Anglais', en_aave:'AAVE', en_south:'Anglais (sud des É-U)', en_app:'Anglais (Appalachien)', en_ie:'Anglais (irlandais)', en_sco:'Anglais (écossais)', en_yk:'Anglais (Yorkshire)', en_ck:'Anglais (cockney)', de:'Allemand', fr:'Français', it:'Italien', es_eu:'Espagnol (Europe)', es_mx:'Espagnol (Mexique)', pt_eu:'Portugais (Europe)', pt_br:'Portugais (Brésil)', la:'Latin', ru:'Russe', uk:'Ukrainien', ar:'Arabe (standard)', ar_eg:'Arabe (égyptien)', he:'Hébreu', sw:'Swahili', tr:'Turc', fa:'Persan', tl:'Tagalog', ga:'Irlandais', eu:'Basque', mn:'Mongol', my:'Birman', am:'Amharique', egy:'Égyptien ancien', ta:'Tamoul', hu:'Hongrois', nl:'Néerlandais', pl:'Polonais', ms:'Malais', mg:'Malgache', cy:'Gallois', fi:'Finnois', ain:'Aïnou', bn:'Bengali', ur:'Ourdou', te:'Télougou', jv:'Javanais', ko_jeju:'Jeju', ka:'Géorgien', el:'Grec', grc:'Grec ancien', nv:'Navajo', qu:'Quechua', mi:'Māori', haw:'Hawaïen', km:'Khmer', lo:'Lao', yo:'Yoruba', zu:'Zoulou', bo:'Tibétain', hy:'Arménien' , ja_kyo:'Dialecte de Kyoto', ja_hir:'Dialecte d\'Hiroshima', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Arabe (levantin)', ar_ma:'Arabe (marocain)', ar_gulf:'Arabe (golfe)', zh_sc:'Sichuanais', zh_db:'Chinois du nord-est', nap:'Napolitain', scn:'Sicilien', gsw:'Suisse allemand', fr_qc:'Français québécois', sco:'Écossais', en_sg:'Singlish', hwc:'Créole hawaïen', pcm:'Pidgin nigérian', tpi:'Tok pisin', ang:'Vieil anglais', sv:'Suédois', no:'Norvégien', si:'Cinghalais'},
    de: { ja:'Japanisch', ja_osa:'Osaka-Dialekt', ja_aom:'Aomori-Dialekt', ja_oki:'Okinawanisch', ja_hak:'Hakata-Dialekt', ja_edo:'Edo-Japanisch', ko:'Koreanisch', ko_kp:'Nordkoreanisch', ko_bus:'Busan-Dialekt', zh:'Chinesisch (Mandarin)', yue:'Kantonesisch', nan:'Taiwanisch', wuu:'Shanghainesisch', zh_classical:'Klassisches Chinesisch', vi:'Vietnamesisch', vi_nom:'Chữ Nôm', th:'Thai', id:'Indonesisch', sa:'Sanskrit', hi:'Hindi', en:'Englisch', en_aave:'AAVE', en_south:'Englisch (US-Süd)', en_app:'Englisch (Appalachen)', en_ie:'Englisch (irisch)', en_sco:'Englisch (schottisch)', en_yk:'Englisch (Yorkshire)', en_ck:'Englisch (Cockney)', de:'Deutsch', fr:'Französisch', it:'Italienisch', es_eu:'Spanisch (Europa)', es_mx:'Spanisch (Mexiko)', pt_eu:'Portugiesisch (Europa)', pt_br:'Portugiesisch (Brasilien)', la:'Latein', ru:'Russisch', uk:'Ukrainisch', ar:'Arabisch (Standard)', ar_eg:'Arabisch (ägyptisch)', he:'Hebräisch', sw:'Swahili', tr:'Türkisch', fa:'Persisch', tl:'Tagalog', ga:'Irisch', eu:'Baskisch', mn:'Mongolisch', my:'Birmanisch', am:'Amharisch', egy:'Altägyptisch', ta:'Tamilisch', hu:'Ungarisch', nl:'Niederländisch', pl:'Polnisch', ms:'Malaiisch', mg:'Madagassisch', cy:'Walisisch', fi:'Finnisch', ain:'Ainu', bn:'Bengalisch', ur:'Urdu', te:'Telugu', jv:'Javanisch', ko_jeju:'Jeju', ka:'Georgisch', el:'Griechisch', grc:'Altgriechisch', nv:'Navajo', qu:'Quechua', mi:'Māori', haw:'Hawaiisch', km:'Khmer', lo:'Lao', yo:'Yoruba', zu:'Zulu', bo:'Tibetisch', hy:'Armenisch' , ja_kyo:'Kyoto-Dialekt', ja_hir:'Hiroshima-Dialekt', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Arabisch (Levantinisch)', ar_ma:'Arabisch (Marokkanisch)', ar_gulf:'Arabisch (Golf)', zh_sc:'Sichuanisch', zh_db:'Nordostchinesisch', nap:'Neapolitanisch', scn:'Sizilianisch', gsw:'Schweizerdeutsch', fr_qc:'Québec-Französisch', sco:'Scots', en_sg:'Singlish', hwc:'Hawaiianisches Kreol', pcm:'Nigerianisches Pidgin', tpi:'Tok Pisin', ang:'Altenglisch', sv:'Schwedisch', no:'Norwegisch', si:'Singhalesisch'},
    es_eu: { ja:'Japonés', ja_osa:'Dialecto de Osaka', ja_aom:'Dialecto de Aomori', ja_oki:'Okinawense', ja_hak:'Dialecto de Hakata', ja_edo:'Japonés de Edo', ko:'Coreano', ko_kp:'Norcoreano', ko_bus:'Dialecto de Busan', zh:'Chino (mandarín)', yue:'Cantonés', nan:'Taiwanés', wuu:'Shanghainés', zh_classical:'Chino clásico', vi:'Vietnamita', vi_nom:'Chữ Nôm', th:'Tailandés', id:'Indonesio', sa:'Sánscrito', hi:'Hindi', en:'Inglés', en_aave:'AAVE', en_south:'Inglés (sur de EE.UU.)', en_app:'Inglés (Apalaches)', en_ie:'Inglés (irlandés)', en_sco:'Inglés (escocés)', en_yk:'Inglés (Yorkshire)', en_ck:'Inglés (cockney)', de:'Alemán', fr:'Francés', it:'Italiano', es_eu:'Español (Europa)', es_mx:'Español (México)', pt_eu:'Portugués (Europa)', pt_br:'Portugués (Brasil)', la:'Latín', ru:'Ruso', uk:'Ucraniano', ar:'Árabe (estándar)', ar_eg:'Árabe (egipcio)', he:'Hebreo', sw:'Suajili', tr:'Turco', fa:'Persa', tl:'Tagalo', ga:'Irlandés', eu:'Vasco', mn:'Mongol', my:'Birmano', am:'Amárico', egy:'Egipcio antiguo', ta:'Tamil', hu:'Húngaro', nl:'Neerlandés', pl:'Polaco', ms:'Malayo', mg:'Malgache', cy:'Galés', fi:'Finlandés', ain:'Ainu', bn:'Bengalí', ur:'Urdu', te:'Telugu', jv:'Javanés', ko_jeju:'Jeju', ka:'Georgiano', el:'Griego', grc:'Griego antiguo', nv:'Navajo', qu:'Quechua', mi:'Maorí', haw:'Hawaiano', km:'Jemer', lo:'Lao', yo:'Yoruba', zu:'Zulú', bo:'Tibetano', hy:'Armenio' , ja_kyo:'Dialecto de Kioto', ja_hir:'Dialecto de Hiroshima', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Árabe (levantino)', ar_ma:'Árabe (marroquí)', ar_gulf:'Árabe (golfo)', zh_sc:'Sichuanés', zh_db:'Chino del noreste', nap:'Napolitano', scn:'Siciliano', gsw:'Alemán suizo', fr_qc:'Francés quebequense', sco:'Escocés', en_sg:'Singlish', hwc:'Criollo hawaiano', pcm:'Pidgin nigeriano', tpi:'Tok pisin', ang:'Inglés antiguo', sv:'Sueco', no:'Noruego', si:'Cingalés'},
    ru: { ja:'Японский', ja_osa:'Осакский диалект', ja_aom:'Аомори диалект', ja_oki:'Окинавский', ja_hak:'Хакатский диалект', ja_edo:'Японский эпохи Эдо', ko:'Корейский', ko_kp:'Северокорейский', ko_bus:'Пусанский диалект', zh:'Китайский (путунхуа)', yue:'Кантонский', nan:'Тайваньский', wuu:'Шанхайский', zh_classical:'Вэньянь', vi:'Вьетнамский', vi_nom:'Тьы-ном', th:'Тайский', id:'Индонезийский', sa:'Санскрит', hi:'Хинди', en:'Английский', en_aave:'AAVE', en_south:'Английский (южный)', en_app:'Английский (Аппалачи)', en_ie:'Английский (ирландский)', en_sco:'Английский (шотландский)', en_yk:'Английский (Йоркшир)', en_ck:'Английский (кокни)', de:'Немецкий', fr:'Французский', it:'Итальянский', es_eu:'Испанский (Европа)', es_mx:'Испанский (Мексика)', pt_eu:'Португальский (Европа)', pt_br:'Португальский (Бразилия)', la:'Латинский', ru:'Русский', uk:'Украинский', ar:'Арабский (стандарт)', ar_eg:'Арабский (египетский)', he:'Иврит', sw:'Суахили', tr:'Турецкий', fa:'Персидский', tl:'Тагальский', ga:'Ирландский', eu:'Баскский', mn:'Монгольский', my:'Бирманский', am:'Амхарский', egy:'Древнеегипетский', ta:'Тамильский', hu:'Венгерский', nl:'Нидерландский', pl:'Польский', ms:'Малайский', mg:'Малагасийский', cy:'Валлийский', fi:'Финский', ain:'Айнский', bn:'Бенгальский', ur:'Урду', te:'Телугу', jv:'Яванский', ko_jeju:'Чеджу', ka:'Грузинский', el:'Греческий', grc:'Древнегреческий', nv:'Навахо', qu:'Кечуа', mi:'Маори', haw:'Гавайский', km:'Кхмерский', lo:'Лаосский', yo:'Йоруба', zu:'Зулу', bo:'Тибетский', hy:'Армянский' , ja_kyo:'Киотский диалект', ja_hir:'Хиросимский диалект', ja_mvi:'Мияко', ja_rys:'Яэяма', ar_lev:'Арабский (левантийский)', ar_ma:'Арабский (марокканский)', ar_gulf:'Арабский (заливный)', zh_sc:'Сычуаньский', zh_db:'Северо-восточный китайский', nap:'Неаполитанский', scn:'Сицилийский', gsw:'Швейцарский немецкий', fr_qc:'Квебекский французский', sco:'Шотландский', en_sg:'Синглиш', hwc:'Гавайский креольский', pcm:'Нигерийский пиджин', tpi:'Ток-писин', ang:'Древнеанглийский', sv:'Шведский', no:'Норвежский', si:'Сингальский'},
    ar: { ja:'يابانية', ja_osa:'لهجة أوساكا', ja_aom:'لهجة أوموري', ja_oki:'أوكيناوية', ja_hak:'لهجة هاكاتا', ja_edo:'يابانية عصر إيدو', ko:'كورية', ko_kp:'كورية شمالية', ko_bus:'لهجة بوسان', zh:'صينية (ماندرين)', yue:'كانتونية', nan:'تايوانية', wuu:'شنغهاية', zh_classical:'الصينية الكلاسيكية', vi:'فيتنامية', vi_nom:'تشو نوم', th:'تايلاندية', id:'إندونيسية', sa:'سنسكريتية', hi:'هندية', en:'إنجليزية', en_aave:'AAVE', en_south:'إنجليزية (جنوب أمريكا)', en_app:'إنجليزية (أبالاتشيا)', en_ie:'إنجليزية (أيرلندية)', en_sco:'إنجليزية (اسكتلندية)', en_yk:'إنجليزية (يوركشاير)', en_ck:'إنجليزية (كوكني)', de:'ألمانية', fr:'فرنسية', it:'إيطالية', es_eu:'إسبانية (أوروبا)', es_mx:'إسبانية (المكسيك)', pt_eu:'برتغالية (أوروبا)', pt_br:'برتغالية (البرازيل)', la:'لاتينية', ru:'روسية', uk:'أوكرانية', ar:'عربية (فصحى)', ar_eg:'عربية (مصرية)', he:'عبرية', sw:'سواحيلية', tr:'تركية', fa:'فارسية', tl:'تاغالوغية', ga:'أيرلندية', eu:'باسكية', mn:'منغولية', my:'بورمية', am:'أمهرية', egy:'مصرية قديمة', ta:'تاميلية', hu:'مجرية', nl:'هولندية', pl:'بولندية', ms:'ملايوية', mg:'ملغاشية', cy:'ويلزية', fi:'فنلندية', ain:'أينوية', bn:'بنغالية', ur:'أردية', te:'تيلوغوية', jv:'جاوية', ko_jeju:'جيجوية', ka:'جورجية', el:'يونانية', grc:'يونانية قديمة', nv:'نافاهو', qu:'كتشوية', mi:'ماورية', haw:'هاوايية', km:'خميرية', lo:'لاوية', yo:'يوروبية', zu:'زولوية', bo:'تبتية', hy:'أرمنية' , ja_kyo:'لهجة كيوتو', ja_hir:'لهجة هيروشيما', ja_mvi:'ميياكو', ja_rys:'يايياما', ar_lev:'عربية (شامية)', ar_ma:'عربية (مغربية)', ar_gulf:'عربية (خليجية)', zh_sc:'صينية سيتشوانية', zh_db:'صينية شمالية شرقية', nap:'نابولية', scn:'صقلية', gsw:'ألمانية سويسرية', fr_qc:'فرنسية كيبيكية', sco:'اسكتلندية', en_sg:'سينغليش', hwc:'كريول هاوايي', pcm:'بيدجن نيجيري', tpi:'توك بيسين', ang:'إنجليزية قديمة', sv:'سويدية', no:'نرويجية', si:'سنهالية'},
    he: { ja:'יפנית', ja_osa:'ניב אוסקה', ja_aom:'ניב אאומורי', ja_oki:'אוקינאווית', ja_hak:'ניב הקאטה', ja_edo:'יפנית תקופת אדו', ko:'קוריאנית', ko_kp:'צפון קוריאנית', ko_bus:'ניב בוסאן', zh:'סינית (מנדרינית)', yue:'קנטונזית', nan:'טייוואנית', wuu:'שנגחאית', zh_classical:'סינית קלאסית', vi:'וייטנאמית', vi_nom:"צ'ו נום", th:'תאית', id:'אינדונזית', sa:'סנסקריט', hi:'הינדי', en:'אנגלית', en_aave:'AAVE', en_south:'אנגלית (דרום ארה"ב)', en_app:'אנגלית (אפלצ\'יה)', en_ie:'אנגלית (אירית)', en_sco:'אנגלית (סקוטית)', en_yk:'אנגלית (יורקשייר)', en_ck:'אנגלית (קוקני)', de:'גרמנית', fr:'צרפתית', it:'איטלקית', es_eu:'ספרדית (אירופה)', es_mx:'ספרדית (מקסיקו)', pt_eu:'פורטוגזית (אירופה)', pt_br:'פורטוגזית (ברזיל)', la:'לטינית', ru:'רוסית', uk:'אוקראינית', ar:'ערבית (ספרותית)', ar_eg:'ערבית (מצרית)', he:'עברית', sw:'סווהילי', tr:'טורקית', fa:'פרסית', tl:'טגלוג', ga:'אירית', eu:'בסקית', mn:'מונגולית', my:'בורמזית', am:'אמהרית', egy:'מצרית עתיקה', ta:'טמילית', hu:'הונגרית', nl:'הולנדית', pl:'פולנית', ms:'מלאית', mg:'מלגשית', cy:'וולשית', fi:'פינית', ain:'אינו', bn:'בנגלית', ur:'אורדו', te:'טלוגו', jv:'ג׳אוונית', ko_jeju:'ג׳ג׳ואית', ka:'גאורגית', el:'יוונית', grc:'יוונית עתיקה', nv:'נאוואחו', qu:'קצ׳ואה', mi:'מאורית', haw:'הוואית', km:'חמרית', lo:'לאוסית', yo:'יורובה', zu:'זולו', bo:'טיבטית', hy:'ארמנית' , ja_kyo:'ניב קיוטו', ja_hir:'ניב הירושימה', ja_mvi:'מיאקו', ja_rys:'יאאיאמה', ar_lev:'ערבית (לבנטינית)', ar_ma:'ערבית (מרוקאית)', ar_gulf:'ערבית (מפרצית)', zh_sc:'סצ\'ואנית', zh_db:'צפון-מזרח סינית', nap:'נאפוליטנית', scn:'סיציליאנית', gsw:'גרמנית שוויצרית', fr_qc:'צרפתית קוויבקית', sco:'סקוטית', en_sg:'סינגליש', hwc:'קריאולית הוואית', pcm:'פידג\'ין ניגרי', tpi:'טוק פיסין', ang:'אנגלית עתיקה', sv:'שוודית', no:'נורווגית', si:'סינהלית'},
    sw: { ja:'Kijapani', ja_osa:'Lahaja ya Osaka', ja_aom:'Lahaja ya Aomori', ja_oki:'Kiokinawa', ja_hak:'Lahaja ya Hakata', ja_edo:'Kijapani cha Edo', ko:'Kikorea', ko_kp:'Kikorea Kaskazini', ko_bus:'Lahaja ya Busan', zh:'Kichina (Mandarin)', yue:'Kikantoni', nan:'Kitaiwani', wuu:'Kishanghai', zh_classical:'Kichina cha kale', vi:'Kivietinamu', vi_nom:'Chữ Nôm', th:'Kithai', id:'Kiindonesia', sa:'Kisanskriti', hi:'Kihindi', en:'Kiingereza', en_aave:'AAVE', en_south:'Kiingereza (Kusini mwa Marekani)', en_app:'Kiingereza (Appalachia)', en_ie:'Kiingereza (Kiayalandi)', en_sco:'Kiingereza (Uskoti)', en_yk:'Kiingereza (Yorkshire)', en_ck:'Kiingereza (Cockney)', de:'Kijerumani', fr:'Kifaransa', it:'Kiitaliano', es_eu:'Kihispania (Ulaya)', es_mx:'Kihispania (Meksiko)', pt_eu:'Kireno (Ulaya)', pt_br:'Kireno (Brazili)', la:'Kilatini', ru:'Kirusi', uk:'Kiukraini', ar:'Kiarabu (sanifu)', ar_eg:'Kiarabu (Misri)', he:'Kiebrania', sw:'Kiswahili', tr:'Kituruki', fa:'Kiajemi', tl:'Kitagalog', ga:'Kiayalandi', eu:'Kibasque', mn:'Kimongolia', my:'Kiburma', am:'Kiamhari', egy:'Kimisri cha kale', ta:'Kitamil', hu:'Kihungari', nl:'Kiholanzi', pl:'Kipolandi', ms:'Kimalei', mg:'Kimalagasi', cy:'Kiwelshi', fi:'Kifinlandi', ain:'Kiainu', bn:'Kibengali', ur:'Kiurdu', te:'Kitelugu', jv:'Kijava', ko_jeju:'Kijeju', ka:'Kijojia', el:'Kigiriki', grc:'Kigiriki cha kale', nv:'Kinavaho', qu:'Kikechua', mi:'Kimaori', haw:'Kihawai', km:'Kikhmeri', lo:'Kilao', yo:'Kiyoruba', zu:'Kizulu', bo:'Kitibeti', hy:'Kiarmenia' , ja_kyo:'Lahaja ya Kyoto', ja_hir:'Lahaja ya Hiroshima', ja_mvi:'Kimiyako', ja_rys:'Kiyaeyama', ar_lev:'Kiarabu (Levanti)', ar_ma:'Kiarabu (Moroko)', ar_gulf:'Kiarabu (Ghuba)', zh_sc:'Kisichuan', zh_db:'Kichina Kaskazini-Mashariki', nap:'Kinapoli', scn:'Kisisilia', gsw:'Kijerumani cha Uswisi', fr_qc:'Kifaransa cha Quebec', sco:'Kiskoti', en_sg:'Singlish', hwc:'Krioli ya Hawaii', pcm:'Pidgin ya Nigeria', tpi:'Tok Pisin', ang:'Kiingereza cha Kale', sv:'Kiswidi', no:'Kinorwe', si:'Kisinhala'},
    yue: { ja:'日本語(標準)', ja_osa:'大阪話', ja_aom:'青森話', ja_oki:'沖繩話', ja_hak:'博多話', ja_edo:'江戶時代話', ko:'韓文(標準)', ko_kp:'北韓話', ko_bus:'釜山話', zh:'普通話', yue:'廣東話', nan:'台灣話', wuu:'上海話', zh_classical:'文言', vi:'越南話', vi_nom:'字喃', th:'泰文', id:'印尼話', sa:'梵文', hi:'印地話', en:'英文', en_aave:'AAVE(黑人英語)', en_south:'英文(美國南方)', en_app:'英文(阿巴拉契亞)', en_ie:'英文(愛爾蘭)', en_sco:'英文(蘇格蘭)', en_yk:'英文(約克郡)', en_ck:'英文(倫敦東區)', de:'德文', fr:'法文', it:'意大利文', es_eu:'西班牙文(歐洲)', es_mx:'西班牙文(墨西哥)', pt_eu:'葡萄牙文(歐洲)', pt_br:'葡萄牙文(巴西)', la:'拉丁文', ru:'俄文', uk:'烏克蘭文', ar:'阿拉伯文(標準)', ar_eg:'阿拉伯文(埃及方言)', he:'希伯來文', sw:'斯瓦希里文', tr:'土耳其文', fa:'波斯文', tl:'他加祿文', ga:'愛爾蘭文', eu:'巴斯克文', mn:'蒙古文', my:'緬甸文', am:'阿姆哈拉文', egy:'古埃及文', ta:'泰米爾文', hu:'匈牙利文', nl:'荷蘭文', pl:'波蘭文', ms:'馬來文', mg:'馬達加斯加語', cy:'威爾斯語', fi:'芬蘭語', ain:'阿伊努語', bn:'孟加拉語', ur:'烏爾都語', te:'泰盧固語', jv:'爪哇語', ko_jeju:'濟州語', ka:'格魯吉亞語', el:'希臘語', grc:'古希臘語', nv:'納瓦霍語', qu:'克丘亞語', mi:'毛利語', haw:'夏威夷語', km:'高棉語', lo:'老撾語', yo:'約魯巴語', zu:'祖魯語', bo:'藏語', hy:'亞美尼亞語' , ja_kyo:'京都話', ja_hir:'廣島話', ja_mvi:'宮古語', ja_rys:'八重山語', ar_lev:'阿拉伯文(黎凡特方言)', ar_ma:'阿拉伯文(摩洛哥方言)', ar_gulf:'阿拉伯文(海灣方言)', zh_sc:'四川話', zh_db:'東北話', nap:'那不勒斯語', scn:'西西里語', gsw:'瑞士德語', fr_qc:'魁北克法語', sco:'蘇格蘭語', en_sg:'新加坡式英語', hwc:'夏威夷克里奧爾', pcm:'尼日利亞皮欽語', tpi:'托克皮辛', ang:'古英語', sv:'瑞典語', no:'挪威語', si:'僧伽羅語'},
    vi: { ja:'Tiếng Nhật', ja_osa:'Phương ngữ Osaka', ja_aom:'Phương ngữ Aomori', ja_oki:'Tiếng Okinawa', ja_hak:'Phương ngữ Hakata', ja_edo:'Tiếng Nhật thời Edo', ko:'Tiếng Hàn', ko_kp:'Tiếng Triều Tiên', ko_bus:'Phương ngữ Busan', zh:'Tiếng Trung (Phổ thông)', yue:'Tiếng Quảng Đông', nan:'Tiếng Đài Loan', wuu:'Tiếng Thượng Hải', zh_classical:'Văn ngôn', vi:'Tiếng Việt', vi_nom:'Chữ Nôm', th:'Tiếng Thái', id:'Tiếng Indonesia', sa:'Tiếng Phạn', hi:'Tiếng Hindi', en:'Tiếng Anh', en_aave:'AAVE', en_south:'Tiếng Anh (miền Nam Mỹ)', en_app:'Tiếng Anh (Appalachia)', en_ie:'Tiếng Anh (Ireland)', en_sco:'Tiếng Anh (Scotland)', en_yk:'Tiếng Anh (Yorkshire)', en_ck:'Tiếng Anh (Cockney)', de:'Tiếng Đức', fr:'Tiếng Pháp', it:'Tiếng Ý', es_eu:'Tiếng Tây Ban Nha (châu Âu)', es_mx:'Tiếng Tây Ban Nha (Mexico)', pt_eu:'Tiếng Bồ Đào Nha (châu Âu)', pt_br:'Tiếng Bồ Đào Nha (Brazil)', la:'Tiếng Latin', ru:'Tiếng Nga', uk:'Tiếng Ukraina', ar:'Tiếng Ả Rập (chuẩn)', ar_eg:'Tiếng Ả Rập (Ai Cập)', he:'Tiếng Do Thái', sw:'Tiếng Swahili', tr:'Tiếng Thổ Nhĩ Kỳ', fa:'Tiếng Ba Tư', tl:'Tiếng Tagalog', ga:'Tiếng Ireland', eu:'Tiếng Basque', mn:'Tiếng Mông Cổ', my:'Tiếng Miến Điện', am:'Tiếng Amhara', egy:'Tiếng Ai Cập cổ đại', ta:'Tiếng Tamil', hu:'Tiếng Hungary', nl:'Tiếng Hà Lan', pl:'Tiếng Ba Lan', ms:'Tiếng Mã Lai', mg:'Tiếng Malagasy', cy:'Tiếng Wales', fi:'Tiếng Phần Lan', ain:'Tiếng Ainu', bn:'Tiếng Bengal', ur:'Tiếng Urdu', te:'Tiếng Telugu', jv:'Tiếng Java', ko_jeju:'Tiếng Jeju', ka:'Tiếng Gruzia', el:'Tiếng Hy Lạp', grc:'Tiếng Hy Lạp cổ đại', nv:'Tiếng Navajo', qu:'Tiếng Quechua', mi:'Tiếng Māori', haw:'Tiếng Hawaii', km:'Tiếng Khmer', lo:'Tiếng Lào', yo:'Tiếng Yoruba', zu:'Tiếng Zulu', bo:'Tiếng Tây Tạng', hy:'Tiếng Armenia' , ja_kyo:'Phương ngữ Kyoto', ja_hir:'Phương ngữ Hiroshima', ja_mvi:'Tiếng Miyako', ja_rys:'Tiếng Yaeyama', ar_lev:'Tiếng Ả Rập (Levant)', ar_ma:'Tiếng Ả Rập (Maroc)', ar_gulf:'Tiếng Ả Rập (Vùng Vịnh)', zh_sc:'Tiếng Tứ Xuyên', zh_db:'Tiếng Đông Bắc Trung Quốc', nap:'Tiếng Napoli', scn:'Tiếng Sicilia', gsw:'Tiếng Đức Thụy Sĩ', fr_qc:'Tiếng Pháp Québec', sco:'Tiếng Scotland', en_sg:'Singlish', hwc:'Creole Hawaii', pcm:'Pidgin Nigeria', tpi:'Tok Pisin', ang:'Tiếng Anh cổ', sv:'Tiếng Thụy Điển', no:'Tiếng Na Uy', si:'Tiếng Sinhala'},
    th: { ja:'ภาษาญี่ปุ่น', ja_osa:'สำเนียงโอซากะ', ja_aom:'สำเนียงอาโอโมริ', ja_oki:'ภาษาโอกินาวา', ja_hak:'สำเนียงฮากาตะ', ja_edo:'ภาษาญี่ปุ่นสมัยเอโดะ', ko:'ภาษาเกาหลี', ko_kp:'ภาษาเกาหลีเหนือ', ko_bus:'สำเนียงปูซาน', zh:'ภาษาจีน (กลาง)', yue:'ภาษากวางตุ้ง', nan:'ภาษาไต้หวัน', wuu:'ภาษาเซี่ยงไฮ้', zh_classical:'ภาษาจีนคลาสสิก', vi:'ภาษาเวียดนาม', vi_nom:'จื๋อโนม', th:'ภาษาไทย', id:'ภาษาอินโดนีเซีย', sa:'ภาษาสันสกฤต', hi:'ภาษาฮินดี', en:'ภาษาอังกฤษ', en_aave:'AAVE', en_south:'ภาษาอังกฤษ(ภาคใต้สหรัฐ)', en_app:'ภาษาอังกฤษ(แอปพาเลเชีย)', en_ie:'ภาษาอังกฤษ(ไอร์แลนด์)', en_sco:'ภาษาอังกฤษ(สกอตแลนด์)', en_yk:'ภาษาอังกฤษ(ยอร์กเชียร์)', en_ck:'ภาษาอังกฤษ(ค็อกนีย์)', de:'ภาษาเยอรมัน', fr:'ภาษาฝรั่งเศส', it:'ภาษาอิตาลี', es_eu:'ภาษาสเปน (ยุโรป)', es_mx:'ภาษาสเปน (เม็กซิโก)', pt_eu:'ภาษาโปรตุเกส (ยุโรป)', pt_br:'ภาษาโปรตุเกส (บราซิล)', la:'ภาษาละติน', ru:'ภาษารัสเซีย', uk:'ภาษายูเครน', ar:'ภาษาอาหรับ (มาตรฐาน)', ar_eg:'ภาษาอาหรับ(อียิปต์)', he:'ภาษาฮีบรู', sw:'ภาษาสวาฮีลี', tr:'ภาษาตุรกี', fa:'ภาษาเปอร์เซีย', tl:'ภาษาตากาล็อก', ga:'ภาษาไอริช', eu:'ภาษาบาสก์', mn:'ภาษามองโกล', my:'ภาษาพม่า', am:'ภาษาอัมฮาริก', egy:'ภาษาอียิปต์โบราณ', ta:'ภาษาทมิฬ', hu:'ภาษาฮังการี', nl:'ภาษาดัตช์', pl:'ภาษาโปแลนด์', ms:'ภาษามลายู', mg:'ภาษามาลากาซี', cy:'ภาษาเวลส์', fi:'ภาษาฟินแลนด์', ain:'ภาษาไอนุ', bn:'ภาษาเบงกาลี', ur:'ภาษาอูรดู', te:'ภาษาเตลูกู', jv:'ภาษาชวา', ko_jeju:'ภาษาเชจู', ka:'ภาษาจอร์เจีย', el:'ภาษากรีก', grc:'ภาษากรีกโบราณ', nv:'ภาษานาวาโฮ', qu:'ภาษาเกชัว', mi:'ภาษาเมารี', haw:'ภาษาฮาวาย', km:'ภาษาเขมร', lo:'ภาษาลาว', yo:'ภาษาโยรูบา', zu:'ภาษาซูลู', bo:'ภาษาทิเบต', hy:'ภาษาอาร์เมเนีย' , ja_kyo:'สำเนียงเกียวโต', ja_hir:'สำเนียงฮิโรชิมะ', ja_mvi:'ภาษามิยาโกะ', ja_rys:'ภาษายาเอยามะ', ar_lev:'ภาษาอาหรับ(เลแวนต์)', ar_ma:'ภาษาอาหรับ(โมร็อกโก)', ar_gulf:'ภาษาอาหรับ(อ่าวเปอร์เซีย)', zh_sc:'ภาษาจีนเสฉวน', zh_db:'ภาษาจีนตะวันออกเฉียงเหนือ', nap:'ภาษาเนเปิลส์', scn:'ภาษาซิซิลี', gsw:'ภาษาเยอรมันสวิส', fr_qc:'ภาษาฝรั่งเศสเควเบก', sco:'ภาษาสกอต', en_sg:'ซิงกลิช', hwc:'ครีโอลฮาวาย', pcm:'พิดจินไนจีเรีย', tpi:'ต็อกพิซิน', ang:'ภาษาอังกฤษโบราณ', sv:'ภาษาสวีเดน', no:'ภาษานอร์เวย์', si:'ภาษาสิงหล'},
    id: { ja:'Bahasa Jepang', ja_osa:'Dialek Osaka', ja_aom:'Dialek Aomori', ja_oki:'Bahasa Okinawa', ja_hak:'Dialek Hakata', ja_edo:'Bahasa Jepang Edo', ko:'Bahasa Korea', ko_kp:'Bahasa Korea Utara', ko_bus:'Dialek Busan', zh:'Bahasa Mandarin', yue:'Bahasa Kanton', nan:'Bahasa Taiwan', wuu:'Bahasa Shanghai', zh_classical:'Bahasa Tionghoa Klasik', vi:'Bahasa Vietnam', vi_nom:'Chữ Nôm', th:'Bahasa Thai', id:'Bahasa Indonesia', sa:'Bahasa Sanskerta', hi:'Bahasa Hindi', en:'Bahasa Inggris', en_aave:'AAVE', en_south:'Bahasa Inggris (AS Selatan)', en_app:'Bahasa Inggris (Appalachia)', en_ie:'Bahasa Inggris (Irlandia)', en_sco:'Bahasa Inggris (Skotlandia)', en_yk:'Bahasa Inggris (Yorkshire)', en_ck:'Bahasa Inggris (Cockney)', de:'Bahasa Jerman', fr:'Bahasa Prancis', it:'Bahasa Italia', es_eu:'Bahasa Spanyol (Eropa)', es_mx:'Bahasa Spanyol (Meksiko)', pt_eu:'Bahasa Portugis (Eropa)', pt_br:'Bahasa Portugis (Brasil)', la:'Bahasa Latin', ru:'Bahasa Rusia', uk:'Bahasa Ukraina', ar:'Bahasa Arab (standar)', ar_eg:'Bahasa Arab (Mesir)', he:'Bahasa Ibrani', sw:'Bahasa Swahili', tr:'Bahasa Turki', fa:'Bahasa Persia', tl:'Bahasa Tagalog', ga:'Bahasa Irlandia', eu:'Bahasa Basque', mn:'Bahasa Mongolia', my:'Bahasa Myanmar', am:'Bahasa Amhara', egy:'Bahasa Mesir Kuno', ta:'Bahasa Tamil', hu:'Bahasa Hungaria', nl:'Bahasa Belanda', pl:'Bahasa Polandia', ms:'Bahasa Melayu', mg:'Bahasa Malagasi', cy:'Bahasa Wales', fi:'Bahasa Finlandia', ain:'Bahasa Ainu', bn:'Bahasa Bengali', ur:'Bahasa Urdu', te:'Bahasa Telugu', jv:'Bahasa Jawa', ko_jeju:'Bahasa Jeju', ka:'Bahasa Georgia', el:'Bahasa Yunani', grc:'Bahasa Yunani Kuno', nv:'Bahasa Navajo', qu:'Bahasa Quechua', mi:'Bahasa Māori', haw:'Bahasa Hawaii', km:'Bahasa Khmer', lo:'Bahasa Lao', yo:'Bahasa Yoruba', zu:'Bahasa Zulu', bo:'Bahasa Tibet', hy:'Bahasa Armenia' , ja_kyo:'Dialek Kyoto', ja_hir:'Dialek Hiroshima', ja_mvi:'Bahasa Miyako', ja_rys:'Bahasa Yaeyama', ar_lev:'Bahasa Arab (Levant)', ar_ma:'Bahasa Arab (Maroko)', ar_gulf:'Bahasa Arab (Teluk)', zh_sc:'Bahasa Sichuan', zh_db:'Bahasa Mandarin Timur Laut', nap:'Bahasa Napoli', scn:'Bahasa Sisilia', gsw:'Bahasa Jerman Swiss', fr_qc:'Bahasa Prancis Québec', sco:'Bahasa Skotlandia', en_sg:'Singlish', hwc:'Kreol Hawaii', pcm:'Pidgin Nigeria', tpi:'Tok Pisin', ang:'Bahasa Inggris Kuno', sv:'Bahasa Swedia', no:'Bahasa Norwegia', si:'Bahasa Sinhala'},
    hi: { ja:'जापानी', ja_osa:'ओसाका बोली', ja_aom:'आओमोरी बोली', ja_oki:'ओकिनावा बोली', ja_hak:'हकाता बोली', ja_edo:'एदो काल जापानी', ko:'कोरियाई', ko_kp:'उत्तर कोरियाई', ko_bus:'बुसान बोली', zh:'चीनी (मंदारिन)', yue:'कैंटोनीज़', nan:'ताइवानी', wuu:'शंघाई भाषा', zh_classical:'शास्त्रीय चीनी', vi:'वियतनामी', vi_nom:'चू नोम', th:'थाई', id:'इंडोनेशियाई', sa:'संस्कृत', hi:'हिन्दी', en:'अंग्रेज़ी', en_aave:'AAVE', en_south:'अंग्रेज़ी (दक्षिणी अमेरिका)', en_app:'अंग्रेज़ी (ऐपलेशिया)', en_ie:'अंग्रेज़ी (आयरिश)', en_sco:'अंग्रेज़ी (स्कॉटिश)', en_yk:'अंग्रेज़ी (यॉर्कशायर)', en_ck:'अंग्रेज़ी (कॉकनी)', de:'जर्मन', fr:'फ़्रेंच', it:'इतालवी', es_eu:'स्पेनिश (यूरोप)', es_mx:'स्पेनिश (मेक्सिको)', pt_eu:'पुर्तगाली (यूरोप)', pt_br:'पुर्तगाली (ब्राज़ील)', la:'लैटिन', ru:'रूसी', uk:'यूक्रेनी', ar:'अरबी (मानक)', ar_eg:'अरबी (मिस्री)', he:'हिब्रू', sw:'स्वाहिली', tr:'तुर्की', fa:'फ़ारसी', tl:'तागालोग', ga:'आयरिश', eu:'बास्क', mn:'मंगोलियाई', my:'बर्मी', am:'अम्हारी', egy:'प्राचीन मिस्री', ta:'तमिल', hu:'हंगेरियन', nl:'डच', pl:'पोलिश', ms:'मलय', mg:'मालागासी', cy:'वेल्श', fi:'फ़िनिश', ain:'ऐनु', bn:'बांग्ला', ur:'उर्दू', te:'तेलुगु', jv:'जावानी', ko_jeju:'जेजू', ka:'जॉर्जियाई', el:'यूनानी', grc:'प्राचीन यूनानी', nv:'नवाहो', qu:'क्वेचुआ', mi:'माओरी', haw:'हवाईयन', km:'ख्मेर', lo:'लाओ', yo:'योरूबा', zu:'ज़ुलू', bo:'तिब्बती', hy:'आर्मेनियाई' , ja_kyo:'क्योतो बोली', ja_hir:'हिरोशिमा बोली', ja_mvi:'मियाको', ja_rys:'याएयामा', ar_lev:'अरबी (लेवेंटाइन)', ar_ma:'अरबी (मोरक्को)', ar_gulf:'अरबी (खाड़ी)', zh_sc:'सिचुआनी', zh_db:'उत्तर-पूर्वी चीनी', nap:'नेपोलिटन', scn:'सिसिलियन', gsw:'स्विस जर्मन', fr_qc:'क्वेबेक फ़्रेंच', sco:'स्कॉट्स', en_sg:'सिंग्लिश', hwc:'हवाईयन क्रियोल', pcm:'नाइजीरियन पिजिन', tpi:'टोक पिसिन', ang:'पुरानी अंग्रेज़ी', sv:'स्वीडिश', no:'नॉर्वेजियन', si:'सिंहली'},
    it: { ja:'Giapponese', ja_osa:'Dialetto di Osaka', ja_aom:'Dialetto di Aomori', ja_oki:'Okinawano', ja_hak:'Dialetto di Hakata', ja_edo:'Giapponese di Edo', ko:'Coreano', ko_kp:'Nordcoreano', ko_bus:'Dialetto di Busan', zh:'Cinese (mandarino)', yue:'Cantonese', nan:'Taiwanese', wuu:'Shangaiese', zh_classical:'Cinese classico', vi:'Vietnamita', vi_nom:'Chữ Nôm', th:'Tailandese', id:'Indonesiano', sa:'Sanscrito', hi:'Hindi', en:'Inglese', en_aave:'AAVE', en_south:'Inglese (sud USA)', en_app:'Inglese (Appalachia)', en_ie:'Inglese (irlandese)', en_sco:'Inglese (scozzese)', en_yk:'Inglese (Yorkshire)', en_ck:'Inglese (cockney)', de:'Tedesco', fr:'Francese', it:'Italiano', es_eu:'Spagnolo (Europa)', es_mx:'Spagnolo (Messico)', pt_eu:'Portoghese (Europa)', pt_br:'Portoghese (Brasile)', la:'Latino', ru:'Russo', uk:'Ucraino', ar:'Arabo (standard)', ar_eg:'Arabo (egiziano)', he:'Ebraico', sw:'Swahili', tr:'Turco', fa:'Persiano', tl:'Tagalog', ga:'Irlandese', eu:'Basco', mn:'Mongolo', my:'Birmano', am:'Amarico', egy:'Egizio antico', ta:'Tamil', hu:'Ungherese', nl:'Olandese', pl:'Polacco', ms:'Malese', mg:'Malgascio', cy:'Gallese', fi:'Finlandese', ain:'Ainu', bn:'Bengalese', ur:'Urdu', te:'Telugu', jv:'Giavanese', ko_jeju:'Jeju', ka:'Georgiano', el:'Greco', grc:'Greco antico', nv:'Navajo', qu:'Quechua', mi:'Māori', haw:'Hawaiano', km:'Khmer', lo:'Lao', yo:'Yoruba', zu:'Zulu', bo:'Tibetano', hy:'Armeno' , ja_kyo:'Dialetto di Kyoto', ja_hir:'Dialetto di Hiroshima', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Arabo (levantino)', ar_ma:'Arabo (marocchino)', ar_gulf:'Arabo (del Golfo)', zh_sc:'Sichuanese', zh_db:'Cinese nordorientale', nap:'Napoletano', scn:'Siciliano', gsw:'Tedesco svizzero', fr_qc:'Francese quebecchese', sco:'Scots', en_sg:'Singlish', hwc:'Creolo hawaiano', pcm:'Pidgin nigeriano', tpi:'Tok Pisin', ang:'Inglese antico', sv:'Svedese', no:'Norvegese', si:'Singalese'},
    es_mx: { ja:'Japonés', ja_osa:'Dialecto de Osaka', ja_aom:'Dialecto de Aomori', ja_oki:'Okinawense', ja_hak:'Dialecto de Hakata', ja_edo:'Japonés de Edo', ko:'Coreano', ko_kp:'Norcoreano', ko_bus:'Dialecto de Busan', zh:'Chino (mandarín)', yue:'Cantonés', nan:'Taiwanés', wuu:'Shanghainés', zh_classical:'Chino clásico', vi:'Vietnamita', vi_nom:'Chữ Nôm', th:'Tailandés', id:'Indonesio', sa:'Sánscrito', hi:'Hindi', en:'Inglés', en_aave:'AAVE', en_south:'Inglés (sur de EE.UU.)', en_app:'Inglés (Apalaches)', en_ie:'Inglés (irlandés)', en_sco:'Inglés (escocés)', en_yk:'Inglés (Yorkshire)', en_ck:'Inglés (cockney)', de:'Alemán', fr:'Francés', it:'Italiano', es_eu:'Español (Europa)', es_mx:'Español (México)', pt_eu:'Portugués (Europa)', pt_br:'Portugués (Brasil)', la:'Latín', ru:'Ruso', uk:'Ucraniano', ar:'Árabe (estándar)', ar_eg:'Árabe (egipcio)', he:'Hebreo', sw:'Suajili', tr:'Turco', fa:'Persa', tl:'Tagalo', ga:'Irlandés', eu:'Vasco', mn:'Mongol', my:'Birmano', am:'Amárico', egy:'Egipcio antiguo', ta:'Tamil', hu:'Húngaro', nl:'Neerlandés', pl:'Polaco', ms:'Malayo', mg:'Malgache', cy:'Galés', fi:'Finlandés', ain:'Ainu', bn:'Bengalí', ur:'Urdu', te:'Telugu', jv:'Javanés', ko_jeju:'Jeju', ka:'Georgiano', el:'Griego', grc:'Griego antiguo', nv:'Navajo', qu:'Quechua', mi:'Maorí', haw:'Hawaiano', km:'Jemer', lo:'Lao', yo:'Yoruba', zu:'Zulú', bo:'Tibetano', hy:'Armenio' , ja_kyo:'Dialecto de Kioto', ja_hir:'Dialecto de Hiroshima', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Árabe (levantino)', ar_ma:'Árabe (marroquí)', ar_gulf:'Árabe (golfo)', zh_sc:'Sichuanés', zh_db:'Chino del noreste', nap:'Napolitano', scn:'Siciliano', gsw:'Alemán suizo', fr_qc:'Francés quebequense', sco:'Escocés', en_sg:'Singlish', hwc:'Criollo hawaiano', pcm:'Pidgin nigeriano', tpi:'Tok pisin', ang:'Inglés antiguo', sv:'Sueco', no:'Noruego', si:'Cingalés'},
    pt_eu: { ja:'Japonês', ja_osa:'Dialecto de Osaka', ja_aom:'Dialecto de Aomori', ja_oki:'Okinawano', ja_hak:'Dialeto de Hakata', ja_edo:'Japonês de Edo', ko:'Coreano', ko_kp:'Norte-coreano', ko_bus:'Dialecto de Busan', zh:'Chinês (mandarim)', yue:'Cantonês', nan:'Taiwanês', wuu:'Xangaiês', zh_classical:'Chinês clássico', vi:'Vietnamita', vi_nom:'Chữ Nôm', th:'Tailandês', id:'Indonésio', sa:'Sânscrito', hi:'Hindi', en:'Inglês', en_aave:'AAVE', en_south:'Inglês (sul dos EUA)', en_app:'Inglês (Apalaches)', en_ie:'Inglês (irlandês)', en_sco:'Inglês (escocês)', en_yk:'Inglês (Yorkshire)', en_ck:'Inglês (cockney)', de:'Alemão', fr:'Francês', it:'Italiano', es_eu:'Espanhol (Europa)', es_mx:'Espanhol (México)', pt_eu:'Português (Europa)', pt_br:'Português (Brasil)', la:'Latim', ru:'Russo', uk:'Ucraniano', ar:'Árabe (padrão)', ar_eg:'Árabe (egípcio)', he:'Hebraico', sw:'Suaíli', tr:'Turco', fa:'Persa', tl:'Tagalo', ga:'Irlandês', eu:'Basco', mn:'Mongol', my:'Birmanês', am:'Amárico', egy:'Egípcio antigo', ta:'Tâmil', hu:'Húngaro', nl:'Neerlandês', pl:'Polaco', ms:'Malaio', mg:'Malgaxe', cy:'Galês', fi:'Finlandês', ain:'Ainu', bn:'Bengali', ur:'Urdu', te:'Telugu', jv:'Javanês', ko_jeju:'Jeju', ka:'Georgiano', el:'Grego', grc:'Grego antigo', nv:'Navajo', qu:'Quíchua', mi:'Māori', haw:'Havaiano', km:'Khmer', lo:'Lao', yo:'Iorubá', zu:'Zulu', bo:'Tibetano', hy:'Arménio' , ja_kyo:'Dialecto de Quioto', ja_hir:'Dialecto de Hiroshima', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Árabe (levantino)', ar_ma:'Árabe (marroquino)', ar_gulf:'Árabe (do Golfo)', zh_sc:'Sichuanês', zh_db:'Chinês do nordeste', nap:'Napolitano', scn:'Siciliano', gsw:'Alemão suíço', fr_qc:'Francês quebequense', sco:'Escocês', en_sg:'Singlish', hwc:'Crioulo havaiano', pcm:'Pidgin nigeriano', tpi:'Tok Pisin', ang:'Inglês antigo', sv:'Sueco', no:'Norueguês', si:'Cingalês'},
    pt_br: { ja:'Japonês', ja_osa:'Dialeto de Osaka', ja_aom:'Dialeto de Aomori', ja_oki:'Okinawano', ja_hak:'Dialeto de Hakata', ja_edo:'Japonês de Edo', ko:'Coreano', ko_kp:'Norte-coreano', ko_bus:'Dialeto de Busan', zh:'Chinês (mandarim)', yue:'Cantonês', nan:'Taiwanês', wuu:'Xangainês', zh_classical:'Chinês clássico', vi:'Vietnamita', vi_nom:'Chữ Nôm', th:'Tailandês', id:'Indonésio', sa:'Sânscrito', hi:'Hindi', en:'Inglês', en_aave:'AAVE', en_south:'Inglês (sul dos EUA)', en_app:'Inglês (Apalaches)', en_ie:'Inglês (irlandês)', en_sco:'Inglês (escocês)', en_yk:'Inglês (Yorkshire)', en_ck:'Inglês (cockney)', de:'Alemão', fr:'Francês', it:'Italiano', es_eu:'Espanhol (Europa)', es_mx:'Espanhol (México)', pt_eu:'Português (Europa)', pt_br:'Português (Brasil)', la:'Latim', ru:'Russo', uk:'Ucraniano', ar:'Árabe (padrão)', ar_eg:'Árabe (egípcio)', he:'Hebraico', sw:'Suaíli', tr:'Turco', fa:'Persa', tl:'Tagalo', ga:'Irlandês', eu:'Basco', mn:'Mongol', my:'Birmanês', am:'Amárico', egy:'Egípcio antigo', ta:'Tâmil', hu:'Húngaro', nl:'Neerlandês', pl:'Polonês', ms:'Malaio', mg:'Malgaxe', cy:'Galês', fi:'Finlandês', ain:'Ainu', bn:'Bengali', ur:'Urdu', te:'Telugu', jv:'Javanês', ko_jeju:'Jeju', ka:'Georgiano', el:'Grego', grc:'Grego antigo', nv:'Navajo', qu:'Quíchua', mi:'Māori', haw:'Havaiano', km:'Khmer', lo:'Lao', yo:'Iorubá', zu:'Zulu', bo:'Tibetano', hy:'Arménio' , ja_kyo:'Dialeto de Quioto', ja_hir:'Dialeto de Hiroshima', ja_mvi:'Miyako', ja_rys:'Yaeyama', ar_lev:'Árabe (levantino)', ar_ma:'Árabe (marroquino)', ar_gulf:'Árabe (do Golfo)', zh_sc:'Sichuanês', zh_db:'Chinês do nordeste', nap:'Napolitano', scn:'Siciliano', gsw:'Alemão suíço', fr_qc:'Francês quebequense', sco:'Escocês', en_sg:'Singlish', hwc:'Crioulo havaiano', pcm:'Pidgin nigeriano', tpi:'Tok Pisin', ang:'Inglês antigo', sv:'Sueco', no:'Norueguês', si:'Cingalês'},
    uk: { ja:'Японська', ja_osa:'Осакський діалект', ja_aom:'Аоморійський діалект', ja_oki:'Окінавська', ja_hak:'Хакатський діалект', ja_edo:'Японська доби Едо', ko:'Корейська', ko_kp:'Північнокорейська', ko_bus:'Пусанський діалект', zh:'Китайська (путунхуа)', yue:'Кантонська', nan:'Тайванська', wuu:'Шанхайська', zh_classical:'Веньянь', vi:'В\'єтнамська', vi_nom:'Тьи-ном', th:'Тайська', id:'Індонезійська', sa:'Санскрит', hi:'Гінді', en:'Англійська', en_aave:'AAVE', en_south:'Англійська (південь США)', en_app:'Англійська (Аппалачі)', en_ie:'Англійська (ірландська)', en_sco:'Англійська (шотландська)', en_yk:'Англійська (Йоркшир)', en_ck:'Англійська (кокні)', de:'Німецька', fr:'Французька', it:'Італійська', es_eu:'Іспанська (Європа)', es_mx:'Іспанська (Мексика)', pt_eu:'Португальська (Європа)', pt_br:'Португальська (Бразилія)', la:'Латинська', ru:'Російська', uk:'Українська', ar:'Арабська (стандарт)', ar_eg:'Арабська (єгипетська)', he:'Іврит', sw:'Суахілі', tr:'Турецька', fa:'Перська', tl:'Тагальська', ga:'Ірландська', eu:'Баскська', mn:'Монгольська', my:'Бірманська', am:'Амхарська', egy:'Давньоєгипетська', ta:'Тамільська', hu:'Угорська', nl:'Нідерландська', pl:'Польська', ms:'Малайська', mg:'Малагасійська', cy:'Валлійська', fi:'Фінська', ain:'Айнська', bn:'Бенгальська', ur:'Урду', te:'Телугу', jv:'Яванська', ko_jeju:'Чеджу', ka:'Грузинська', el:'Грецька', grc:'Давньогрецька', nv:'Навахо', qu:'Кечуа', mi:'Маорі', haw:'Гавайська', km:'Кхмерська', lo:'Лаоська', yo:'Йоруба', zu:'Зулу', bo:'Тибетська', hy:'Вірменська' , ja_kyo:'Кіотський діалект', ja_hir:'Хіросімський діалект', ja_mvi:'Мійяко', ja_rys:'Яеяма', ar_lev:'Арабська (левантійська)', ar_ma:'Арабська (марокканська)', ar_gulf:'Арабська (затоцька)', zh_sc:'Сичуаньська', zh_db:'Північно-східна китайська', nap:'Неаполітанська', scn:'Сицилійська', gsw:'Швейцарська німецька', fr_qc:'Квебекська французька', sco:'Шотландська', en_sg:'Сінгліш', hwc:'Гавайська креольська', pcm:'Нігерійський піджин', tpi:'Ток-пісін', ang:'Давньоанглійська', sv:'Шведська', no:'Норвезька', si:'Сингальська'},
};
...
const LANGUAGES = [
    // Japanese: Standard → Kansai → Western → Northern → Historical → Ryukyuan → Ainu
    { code: 'ja', name: '日本語(標準)', group: 'JPN' },
    { code: 'ja_kyo', name: '京都弁', group: 'JPN', experimental: true },
    { code: 'ja_osa', name: '大阪弁', group: 'JPN', experimental: true },
    { code: 'ja_hak', name: '博多弁', group: 'JPN', experimental: true },
    { code: 'ja_hir', name: '広島弁', group: 'JPN', experimental: true },
    { code: 'ja_aom', name: '青森弁', group: 'JPN', experimental: true },
    { code: 'ja_edo', name: '江戸時代語', group: 'JPN', experimental: true, historical: true },
    { code: 'ja_oki', name: '沖縄弁', group: 'JPN', experimental: true },
    ...
    // Korean: Standard → North → Regional
    { code: 'ko', name: '韓国語(標準)', group: 'KOR' },
    { code: 'ko_kp', name: '北朝鮮語', group: 'KOR', experimental: true },
    { code: 'ko_bus', name: '釜山弁', group: 'KOR', experimental: true },
    { code: 'ko_jeju', name: '済州語', group: 'KOR', experimental: true },
    // Chinese: Mandarin varieties → Southern varieties → Classical → Tibetan
    { code: 'zh', name: '中国語(普通話)', group: 'CHN' },
    { code: 'zh_db', name: '東北話', group: 'CHN', experimental: true },
    { code: 'zh_sc', name: '四川話', group: 'CHN', experimental: true },
    ...
    // SE Asian: Mon-Khmer → Tai-Kadai → Tibeto-Burman → Austronesian (Malay→Philippine→Oceanic)
    ...
    // South & Central Asian: Indo-Aryan → Dravidian → Iranian → Turkic-Mongolic → Kartvelian
    ...
    { code: 'ka', name: 'グルジア語', group: 'SAS' },
    // Semitic & African: Arabic varieties → Hebrew → Ethiopic → Bantu → W.African
    ...
    { code: 'zu', name: 'ズールー語', group: 'SEM' },
    { code: 'yo', name: 'ヨルバ語', group: 'SEM' },
    // Germanic: English varieties → Scots → Dutch-German → North Germanic
    { code: 'en', name: '英語', group: 'EUR' },
    { code: 'ang', name: '古英語', group: 'EUR', experimental: true, historical: true },
    ...
    { code: 'sco', name: 'スコットランド語', group: 'EUR', experimental: true },
    { code: 'nl', name: 'オランダ語', group: 'EUR' },
    { code: 'de', name: 'ドイツ語', group: 'EUR' },
    { code: 'gsw', name: 'スイスドイツ語', group: 'EUR', experimental: true },
    { code: 'sv', name: 'スウェーデン語', group: 'EUR' },
    { code: 'no', name: 'ノルウェー語', group: 'EUR' },
    // Celtic & Basque
    ...
    { code: 'fr_qc', name: 'ケベック・フランス語', group: 'ROM', experimental: true },
    ...
    // Slavic, Uralic & other European: Slavic → Hellenic → Armenian → Uralic
    { code: 'ru', name: 'ロシア語', group: 'SLV' },
    { code: 'uk', name: 'ウクライナ語', group: 'SLV' },
    { code: 'pl', name: 'ポーランド語', group: 'SLV' },
    { code: 'el', name: 'ギリシャ語', group: 'SLV' },
    { code: 'grc', name: '古代ギリシャ語', group: 'SLV', experimental: true, historical: true },
    { code: 'hy', name: 'アルメニア語', group: 'SLV' },
    ...
    // Creoles & Pidgins
    { code: 'en_sg', name: 'シングリッシュ', group: 'CRL', experimental: true },
...
const GROUP_NAMES = {
    ja: { JPN:'日本語', KOR:'韓国語', CHN:'中国語', SEA:'東南アジア', SAS:'南・中央アジア', EUR:'ゲルマン', ROM:'ロマンス', SLV:'スラヴ・ウラル', SEM:'セム・アフリカ', CEL:'ケルト・バスク', AMR:'アメリカ先住民', CRL:'クレオール' },
    en: { JPN:'Japanese', KOR:'Korean', CHN:'Chinese', SEA:'SE Asian', SAS:'S & Central Asian', EUR:'Germanic', ROM:'Romance', SLV:'Slavic & Uralic', SEM:'Semitic & African', CEL:'Celtic & Basque', AMR:'Americas', CRL:'Creoles' },
};
