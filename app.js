...
const LANGUAGES = [
    // Japonic: Standard → Kansai → Western → Northern → Historical → Ryukyuan
    ...
    // Ainu (isolate, geographically adjacent)
    ...
    // Austronesian: Malay → Philippine → Malagasy → Oceanic
    ...
    // Semitic: Arabic → Hebrew → Aramaic → Ethiopic → Maltese
    ...
    // Ancient Near East (non-Semitic)
    { code: 'egy', name: '古代エジプト語', group: 'SEM', experimental: true, historical: true },
    { code: 'cop', name: 'コプト語', group: 'SEM', experimental: true, historical: true },
    { code: 'sux', name: 'シュメール語', group: 'SEM', experimental: true, historical: true },
...
const GROUP_NAMES = {
    ja: { JPN:'日本語', KOR:'韓国語', CHN:'中国語・チベット', SEA:'東南アジア', SAS:'南アジア', TRK:'テュルク・コーカサス', SEM:'セム語', AFR:'アフリカ', GER:'ゲルマン語', CEL:'ケルト語', ROM:'ロマンス語', SLV:'スラヴ語', OEU:'ギリシャ・ウラル他', AMR:'アメリカ先住民', CRL:'クレオール', en_au:'英語(オーストラリア)', en_in:'英語(インド)', es_ar:'スペイン語(アルゼンチン)', ar_iq:'アラビア語(イラク方言)', hak_cn:'客家語', sux:'シュメール語', akk:'アッカド語', hit:'ヒッタイト語', nci:'古典ナワトル語', myn:'古典マヤ語', ine:'印欧祖語' },
    en: { JPN:'Japanese', KOR:'Korean', CHN:'Sino-Tibetan', SEA:'SE Asian', SAS:'South Asian', TRK:'Turkic & Caucasus', SEM:'Semitic', AFR:'African', GER:'Germanic', CEL:'Celtic', ROM:'Romance', SLV:'Slavic', OEU:'Greek, Uralic & more', AMR:'Americas', CRL:'Creoles', en_au:'English (Australian)', en_in:'English (Indian)', es_ar:'Spanish (Argentina)', ar_iq:'Arabic (Iraqi)', hak_cn:'Hakka Chinese', sux:'Sumerian', akk:'Akkadian', hit:'Hittite', nci:'Classical Nahuatl', myn:'Classical Maya', ine:'Proto-Indo-European' },
};
