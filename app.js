...
const LANGUAGES = [
    ...
    { code: 'eo', name: 'エスペラント', group: 'OEU' },
    { code: 'tok', name: 'トキポナ', group: 'OEU' },
    // Americas (Indigenous)
