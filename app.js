...
const NO_SPACE_LANGS = new Set(['ja', 'ja_osa', 'ja_aom', 'ja_oki', 'ja_hak', 'ja_edo', 'ja_heian', 'ja_kyo', 'ja_hir', 'ja_mvi', 'ja_rys', 'zh', 'yue', 'nan', 'wuu', 'zh_classical', 'zh_sc', 'zh_db', 'th', 'vi_nom']);
