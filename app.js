...
const LANGUAGES = [
    ...
    { code: 'fj', name: 'フィジー語', group: 'SEA', experimental: true },
    { code: 'sm', name: 'サモア語', group: 'SEA', experimental: true },
    ...
    { code: 'ti', name: 'ティグリニャ語', group: 'AFR', experimental: true },
    ...
    // Romani
    { code: 'rom', name: 'ロマニ語', group: 'OEU', experimental: true },
    // Americas (Indigenous)
    ...
    { code: 'cop', name: 'コプト語', group: 'CRL', experimental: true, historical: true },
