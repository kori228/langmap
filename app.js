...
const LANGUAGES = [
    ...
    { code: 'mvi', name: '宮古語', group: 'JPN', experimental: true },
    { code: 'rys', name: '八重山語', group: 'JPN', experimental: true },
    ...
    { code: 'jeju', name: '済州語', group: 'KOR', experimental: true },
...
const NO_SPACE_LANGS = new Set(['ja', 'osa', 'aom', 'oki', 'hak', 'ja_edo', 'ja_kyo', 'ja_hir', 'mvi', 'rys', 'zh', 'yue', 'nan', 'wuu', 'zh_classical', 'zh_sc', 'zh_db', 'th', 'vi_nom']);
